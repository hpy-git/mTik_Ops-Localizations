<?php
////////////////////////////////////////////////////////////////////////
// Italian language translations for mTik_Ops
// Author: HPY™
...
return [
    ...
    'search.results_header' => 'Risultati di ricerca per "{query}"',
    'search.placeholder' => 'Digita per cercare...',
    'search.no_results' => 'Nessun risultato trovato',
    'search.results' => 'Risultati',
    'search.button' => 'Cerca',
    'search.hint' => 'Digita per vedere suggerimenti istantanei.',
    ...
    'auth.logging_out' => "Disconnessione in corso",
    ...
    'about.title' => "Progettato per MikroTik",
    'about.desc' => "mTikOps è una piattaforma web per gestire router e hotspot MikroTik. Include accesso remoto, gestione hotspot con stampa voucher, PPPoE e altro. Tutto in un unico sistema veloce.",
    'about.about_us_button' => "Chi siamo",
    'about.our_team_button' => "Il nostro team",

    // Index Page - Features Section
    'features.remote.title' => "Gestione remota della rete",
    'features.remote.desc' => "Monitora e gestisci router remoti, visualizza lo stato delle interfacce, esegui riavvii e applica modifiche di configurazione in modo sicuro da una console centralizzata.",
    'features.hotspot.title' => "Gestione Hotspot",
    'features.hotspot.desc' => "Crea e gestisci server hotspot e profili utente, emetti voucher, monitora utenti attivi e sessioni e genera report.",
    'features.troubleshoot.title' => "Diagnostica e configurazione",
    'features.troubleshoot.desc' => "Applica e verifica modifiche di configurazione, esegui diagnostica, consulta i log e risolvi problemi di connettività con strumenti integrati.",

    // Index Page - Signup Section
    'signup.title' => "Inizia con mTikOps",
    'signup.desc' => "Crea un account per gestire router, hotspot ed eseguire diagnostica sulla tua rete da un unico pannello di controllo.",
    ...
    'footer.powered' => "Sviluppato da HPY™",
    ...
    // Login Page
    'login.title' => "Accesso a mTik_Ops",
    'login.desc' => "Accedi al tuo account mTik_Ops per gestire router e hotspot MikroTik da un pannello centrale.",
    ...
    'login.form.connection_type_yes'=> "Sì (API sicura)",
    'login.form.connection_type_no'=> "No (API standard)",
    ...
    'about-us.desc' => "Scopri mTik_Ops, la nostra missione e il team dietro la piattaforma.",
    ...
    'about-us.overview.desc'=> "Una rapida introduzione a mTikOps e alle sue principali funzionalità.",
    'about-us.vision.desc'=> "Scopri la nostra missione e gli obiettivi a lungo termine del progetto.",
    'about-us.features.desc'=> "Esamina le funzionalità principali di mTikOps.",
    'about-us.tutorials.desc'=> "Guide passo-passo e casi d'uso.",
    'about-us.faqs.desc'=> "Domande frequenti e relative risposte.",
    'about-us.requirements.desc'=> "Prerequisiti e requisiti di RouterOS per l'utilizzo di mTikOps.",
    ...
    'about-us.vision-page.desc'=> "Vogliamo semplificare le operazioni di rete per gli utenti MikroTik con un'interfaccia intuitiva e strumenti di automazione.",
    ...
    // our-team.php
    // Our Team Page
    'our-team.title'=> "Il nostro team",
    'our-team.desc'=> "Incontra le persone dietro mTikOps — sviluppatori, contributori e manutentori.",
    ...
    'our-team.contact'=> "Contatti",

    // Our Team Page Descriptions
    'our-team.leadership.desc'=> "I manutentori principali e i responsabili del progetto che guidano mTikOps.",
    'our-team.developers.desc'=> "Ingegneri e contributori che sviluppano funzionalità e correggono bug.",
    'our-team.contributors.desc'=> "Contributori della community che aiutano con documentazione, test e codice.",
    'our-team.advisors.desc'=> "Consulenti ed esperti che supportano il progetto.",
    'our-team.careers.desc'=> "Posizioni aperte e modi per unirsi al team.",
    'our-team.contact.desc'=> "Contatta il team per domande o collaborazioni.",

    // Our Team Page Buttons
    'our-team.open.leadership'=> "Visualizza leadership",
    ...
    'our-team.leadership-page.desc'=> "Incontra i manutentori principali e i responsabili del progetto di mTikOps.",
    ...
    'our-team.contributors-page.desc'=> "Riconoscimento dei contributori della community e come partecipare.",
    ...
    'our-team.join-us-page.title'=> "Unisciti a noi",
    'our-team.join-us-page.desc'=> "Scopri le posizioni aperte e come contribuire a mTikOps.",  

    // Our Team - Contact Page
    'our-team.contact-page.title'=> "Contatti",
    'our-team.contact-page.desc'=> "Modalità per contattare il team mTikOps per collaborazione o supporto.",

    // Dashboard Page
    'dashboard.title'=> "Cruscotto",
    'dashboard.desc'=> "Suite per monitoraggio delle operazioni di rete e logging",

    // Dashboard Buttons
    'dashboard.show'=> "Mostra cruscotto",
    'dashboard.button.refresh'=> "Aggiorna",
    'dashboard.button.prev'=> "Precedente",
    'dashboard.button.next'=> "Successivo",

    // Dashboard Network Monitoring
    'dashboard.monitoring.title'=> "Monitoraggio rete",
    'dashboard.monitoring.desc'=> "Monitoraggio in tempo reale delle prestazioni, della disponibilità e dello stato dei dispositivi nella tua infrastruttura MikroTik.",
    ...
    'dashboard.monitoring'=> "Monitoraggio",
    'dashboard.select_interface'=> "Seleziona un'interfaccia per avviare il monitoraggio in tempo reale.",
    ...
    'dashboard.hotspot.as.title'=> "Sessioni Hotspot attive",
    'dashboard.ppp.as.title'=> "Sessioni PPPoE attive",

    // hotspot.php
    // Hotspot Page
    'hotspot.title'=> "Gestione Hotspot",
    'hotspot.desc'=> "Gestisci utenti hotspot, profili, sessioni attive e host.",
    'hotspot.users'=> "Utenti",
    'hotspot.profiles'=> "Profili",
    'hotspot.active'=> "Attive",
    'hotspot.hosts'=> "Host",

    // Hotspot Page Descriptions
    'hotspot.users.desc'=> "Crea, modifica e gestisci account utente hotspot.",
    ...
    'hotspot.hosts.desc'=> "Controlla e gestisci i dispositivi connessi all'hotspot.",

    // Hotspot Page Buttons
    'hotspot.open.users'=> "Apri utenti",
    'hotspot.open.profiles'=> "Apri profili",
    'hotspot.open.active'=> "Apri attive",
    ...
    'hotspot.button.prev'=> "Precedente",
    'hotspot.button.next'=> "Successivo",
    ...
    'hotspot.table.th.to-address'=> "A indirizzo",
    'hotspot.table.th.last-seen'=> "Ultima connessione",
    ...
    'hotspot.modal.queueing.tab'=> "Code",
    ...
    'hotspot.modal.form.optional-comment'=> "Commento opzionale",
    'hotspot.modal.form.mac-address'=>  "Indirizzo MAC",
    'hotspot.modal.form.time-limit'=>  "Limite temporale",
    ...
    'hotspot.modal.form.characters-lower'=> "abcd (minuscole)",
    'hotspot.modal.form.characters-upper'=> "ABCD (MAIUSCOLE)",
    'hotspot.modal.form.characters-mixed'=> "AbCd (Misto)",
    'hotspot.modal.form.characters-num'=> "1234 (Numeri)",
    'hotspot.modal.form.characters-lower-num'=> "a1b2 (minuscole & numeri)",
    'hotspot.modal.form.characters-upper-num'=> "A1B2 (MAIUSCOLE & numeri)",
    'hotspot.modal.form.characters-mixed-num'=> "aA1bB2 (Misto & numeri)",

    // Hotspot Modal Form Stats - Stats Tab
    'hotspot.modal.form.stats.uptime'=> "Tempo attivo",
    'hotspot.modal.form.stats.bytes_in'=> "Byte ricevuti",
    'hotspot.modal.form.stats.bytes_out'=> "Byte inviati",
    'hotspot.modal.form.stats.limit-uptime'=> "Limite tempo attivo",
    'hotspot.modal.form.stats.limit-bytes_total'=> "Limite totale byte",
    ...
    'hotspot.modal.form.button.clear-cached-batch'=> "Pulisci batch memorizzati",
    ...
    'hotspot.user.profiles.desc'=> "Gestisci larghezza di banda, sessioni e profili di rate-limit per gli utenti.",
    ...
    'hotspot.user.profiles.form.rate-limit-rx'=> "Limite velocità (RX)",
    'hotspot.user.profiles.form.rate-limit-tx'=> "Limite velocità (TX)",
    ...
    'hotspot.user.profiles.form.lock-device'=> "Blocca al dispositivo",
    'hotspot.user.profiles.form.lock-server'=> "Blocca al server",
    ...
    'hotspot.user.profiles.form.on-login-script_placeholder'=> "Script opzionale da eseguire all'accesso",
    'hotspot.user.profiles.form.on-logout-script'=> "Script alla disconnessione",
    'hotspot.user.profiles.form.on-logout-script_placeholder'=> "Script opzionale da eseguire alla disconnessione",
    ...
    'hotspot.user.profiles.remove-select'=> "Seleziona il profilo da rimuovere",
    ...
    'hotspot.export.user.column-desc'=> "Seleziona un campo e usa Su/Giù per modificare l'ordine delle colonne.",
    ...
    'settings.desc'=> "Configura l'identità del dispositivo, i servizi di sistema e le azioni di manutenzione.",
    ...
    'settings.open.scheduler'=> "Apri schedulatore",
    ...
    'settings.buttons.prev'=> 'Precedente',
    'settings.buttons.next'=> 'Successivo',
    ...
    'settings.identity.desc'=> "Visualizza e modifica l'identità del dispositivo e le informazioni di base di sistema.",
    'settings.ntp.desc'=> "Configura NTP (Network Time Protocol) per mantenere l'orologio di sistema preciso.",
    'settings.files.desc'=> "Gestisci file e script caricati sul dispositivo.",
    'settings.users.desc'=> "Gestisci gli utenti di sistema e i loro diritti di accesso.",
    'settings.scheduler.desc'=> "Crea attività pianificate per manutenzione e automazione.",
    'settings.scripts.desc'=> "Gestisci ed esegui script personalizzati sul dispositivo.",
    'settings.reset.desc'=> "Ripristina la configurazione ai valori predefiniti. Usare con cautela.",
    'settings.reboot.desc'=> "Riavvia il dispositivo da remoto. Assicurati di salvare le modifiche prima di riavviare.",
    'settings.shutdown.desc'=> "Spegni il dispositivo da remoto in modo sicuro. Usare con cautela.",

   
    // Settings Page - Identity
    'settings.identity.placeholder'=> "Inserisci identità di sistema",
    'settings.identity.caption'=> "Questo è il nome mostrato nei log e nell'identificazione di rete.",
    ...
    'settings.ntp.freq.drift'=> "Deriva frequenza",
    'settings.ntp.synced.server'=> "Server sincronizzato",
    'settings.ntp.synced.stratum'=> "Stratum sincronizzato",
    'settings.ntp.system.offset'=> "Offset sistema",

    // Settings Page - Reset
    // Reset Modal
    'settings.reset.type'=> "Tipo di ripristino",
    'settings.reset.config'=> "Ripristina configurazione (conserva file utente)",
    'settings.reset.all'=> "Reset di fabbrica (cancella tutto, ripristina default)",
    'settings.reset.delay'=> "Ritardo (secondi)",
    'settings.reset.delay.desc'=> "Imposta 0 per eseguire immediatamente con il pulsante Pianifica, oppure clicca \"Ripristina ora\" per eseguirlo subito.",

    //Reset Buttons
    'settings.reset.button.schedule'=> "Pianifica ripristino",
    'settings.reset.button.reset-now'=> "Ripristina ora",

    // Settings Page - Reboot
    // Reboot Modal
    'settings.reboot.delay'=> "Ritardo (secondi)",
    'settings.reboot.delay.desc'=> "Imposta 0 per riavviare immediatamente con il pulsante Pianifica, oppure clicca \"Riavvia ora\" per forzare il riavvio immediato.",
    ...
    'settings.shutdown.delay.desc'=> "Imposta 0 per spegnere immediatamente con il pulsante Pianifica, oppure clicca \"Spegni ora\" per forzare lo spegnimento immediato.",
    ...
    'queues.desc'=> "Gestisci simple queues, queue tree e tipi di coda.",

    'queues.simple'=> "Semplice",
    'queues.tree'=> "Albero",
    'queues.types'=> "Tipi",
    'queues.simple-queue'=> "Simple queues",
    'queues.queue-tree'=> "Queue tree",
    'queues.queue-types'=> "Tipi di coda",

    // Queues Page Descriptions
    'queues.simple.desc'=> "Crea e gestisci simple queues per host/target.",
    'queues.tree.desc'=> "Gestisci queue tree gerarchici per shaping avanzato del traffico.",
    'queues.types.desc'=> "Definisci e gestisci tipi di coda e classificatori di pacchetto.",
    ...
    'queues.button.prev'=> "Precedente",
    'queues.button.next'=> "Successivo",
    ...
    'queues.table.th.download-avg-rate'=> "Velocità media download",
    ...
    'queues.modal.form.parent-queue'=> "Coda padre",
    ...
    'queues.modal.form.clear-parent'=> "Rimuovi parent (rimuovi relazione parent)",
    ...
    'queues.tree.action.desc'=> "Esegui azioni sulle voci selezionate dell'albero code.",

    // Queue Tree Modal Form - Tabs
    'queues.tree.create.title'=> "Crea voce Queue Tree",
    ...
    'ppp.secrets.desc'=> "Gestisci i segreti PPPoE (credenziali utenti).",
    'ppp.profiles.desc'=> "Crea e gestisci profili PPPoE.",
    ...
    'ppp.sort'=> "Ordina",
    'ppp.select.all'=> "",
    'ppp.buttons.prev'=> "Precedente",
    'ppp.buttons.next'=> "Successivo",
    'ppp.buttons.clear'=> "Pulisci",
    ...
    'ppp.table.th.service-name'=> "Nome servizio",
    ...
    'ppp.table.th.last-disc-reason'=> "Motivo disconnessione",
    ...
    'ppp.modal.form.accept-untagged'=> "Accetta non taggati",
    ...
    'ppp.modal.form.max-mtu'=> "MTU massimo",
    'ppp.modal.form.max-mru'=> "MRU massimo",
    'ppp.modal.form.mrru'=> "MRRU",
    'ppp.modal.form.keepalive-timeout'=> "Timeout keepalive",
    'ppp.modal.form.profile'=> "Profilo",
    ...
    'ppp.modal.form.profile.use-enc'=> "Usa crittografia",
    ...
    'ppp.modal.form.profile.script-onup'=> "All'avvio",
    'ppp.modal.form.profile.script-ondown'=> "Alla chiusura",
    'ppp.modal.form.profile.script-placeholder'=> "Lo script verrà eseguito quando l'evento si verifica",
    'ppp.modal.form.migration.confirm'=> "Conferma migrazione profilo",
    'ppp.modal.form.migration.caption'=> "Cancellare la coda padre o il tipo di coda per questo profilo potrebbe richiedere di ricreare il profilo e riassegnare i segreti PPP associati. Questa operazione può essere disruptiva. Vuoi procedere?",

    // ip.php
    // IP Page
    'ip.title'=> "Gestione IP",
    'ip.desc'=> "Gestisci ARP, indirizzi, DHCP, DNS, pool e servizi IP correlati.",
    ...
    'ip.cloud.desc'=> "Impostazioni Cloud/DDNS. I valori vengono letti dal router.",
    'ip.dhcp.client.desc'=> "Visualizza e gestisci i client DHCP.",
    'ip.dhcp.server.desc'=> "Configura server DHCP e lease.",
    'ip.dns.desc'=> "Gestisci impostazioni DNS e voci statiche.",
    'ip.pool.desc'=> "Gestisci i pool di indirizzi per DHCP e altri servizi.",
    'ip.services.desc'=> "Abilita o disabilita servizi relativi a IP.",
    ...
    'ip.open.dhcp.client'=> "Apri client DHCP",
    'ip.open.dhcp.server'=> "Apri server DHCP",
    ...
    'ip.buttons.prev'=> "Precedente",
    'ip.buttons.next'=> "Successivo",
    ...
    'ip.upnp.allow-disable-external-iface'=> "Consenti disabilitazione interfaccia esterna",
    ...
    'ip.cloud.update.time'=> "Ora aggiornamento",
    ...
    // dhcp-client.php
    // IP DHCP Client Page
    'ip.dhcp.client.options'=> "Opzioni client DHCP",
    ...
    'ip.dns.form.doh.max.server.conn'=> "Connessioni massime server DoH",
    'ip.dns.form.doh.max.concurrent.queries'=> "Query concorrenti DoH massime",
    ...
    'ip.dns.form.cache.max-ttl'=> "Cache Max TTL (secondi)",
    'ip.dns.form.cache.min-ttl'=> "Cache Min TTL (secondi)",
    'ip.dns.form.max.concurrent.queries'=> "Query concorrenti massime",
    'ip.dns.form.max.concurrent.tcp'=> "Connessioni TCP concorrenti massime",
    ...
    'ip.dns.static.desc'=> "Gestisci voci DNS statiche che sovrascrivono la risoluzione dinamica.",
    ...
    'ip.pool.table.th.total-addresses'=> "Indirizzi totali",
    ...
    'ip.pool.modal.form.next-address'=> "Indirizzo successivo",
    'ip.pool.modal.form.total-addresses'=> "Indirizzi totali",
    ...
    'ip.services.table.th.max-sessions'=> "Sessioni massime",
    ...
    'ip.services.modal.form.max-sessions'=> "Sessioni massime",
    ...
    'ip.settings.modal.form.ip-max-neighbors'=> "Vicini massimi",
    'ip.settings.modal.form.ip-icmp-rate-limit'=> "Limite rate ICMP",
