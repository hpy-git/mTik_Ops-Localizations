...
return [
    ...
    'footer.copyright' => 'Droits d\'auteur &copy; mTikOps {year}',
    ...
    'login.form.connection_type_yes'=> 'API sécurisée',
    'login.form.connection_type_no'=> 'API standard',
    'login.form.connection_type_help'=> 'Utilisez 8728 dans la plupart des cas, sauf si vous avez une raison spécifique d\'utiliser 8729 (par exemple si un certificat SSL a été installé sur le routeur).',
    ...
    // Login Page Messages
    'login.error.invalid_submission'=> 'Envoi du formulaire invalide. Veuillez réessayer.',
    'login.error.missing_fields'=> 'Hôte, nom d\'utilisateur et mot de passe sont requis.',
    'login.error.unable_connect'=> 'Impossible de se connecter ! — Vérifiez vos identifiants et réessayez.',
    'login.success.connected'=> 'Connecté au routeur avec succès.',
    'login.success.remembered'=> 'Détails de connexion enregistrés pour les connexions futures.',
    'login.info.session_expired'=> 'Votre session a expiré. Veuillez vous reconnecter.',
    'login.info.logged_out'=> 'Vous avez été déconnecté avec succès.',
    'login.info.please_login'=> 'Veuillez vous connecter pour continuer.',
    'login.button.forgot_password'=> 'Mot de passe oublié ?',
    'login.try_again'=> 'Réessayer ?',
    ...
    'about-us.requirements-page.desc'=> 'Exigences minimales et notes de compatibilité.',
    ...
    'our-team.contributors-page.title'=> 'Contributeurs',
    'our-team.contributors-page.desc'=> 'Reconnaître les contributeurs de la communauté et comment s\'impliquer.',

    // Our Team - Advisors Page
    'our-team.advisors-page.title'=> 'Conseillers',
    'our-team.advisors-page.desc'=> 'Conseillers et experts qui guident le projet.',

    // Our Team - Join Us Page
    'our-team.join-us-page.title'=> 'Rejoignez-nous',
    'our-team.join-us-page.desc'=> 'Découvrez les rôles ouverts et comment contribuer à mTikOps.',  

    // Our Team - Contact Page
    'our-team.contact-page.title'=> 'Contact',
    'our-team.contact-page.desc'=> 'Moyens de contacter l\'équipe mTikOps pour collaboration ou support.',
    ...
    'firewall.desc' => 'Gérez les règles de pare-feu, le NAT, le Mangle et les outils d inspection du trafic.',
    'firewall.filter' => 'Règles de filtrage',
    'firewall.nat' => 'NAT',
    'firewall.mangle' => 'Mangle',
    'firewall.raw' => 'Raw',
    'firewall.connections' => 'Connexions',
    'firewall.address' => 'Listes d\'adresses',
    'firewall.layer7' => 'Protocoles Layer7',
    'firewall.filter.desc' => 'Créez et organisez des règles de filtrage de paquets pour le contrôle du trafic.',
    'firewall.filter.actions' => 'Actions',
    'firewall.filter.new' => 'Nouveau',
    'firewall.filter.edit' => 'Modifier',
    'firewall.filter.enable' => 'Activer',
    'firewall.filter.disable' => 'Désactiver',
    'firewall.filter.remove' => 'Supprimer',
    'firewall.filter.sort.by' => 'Trier par',
    'firewall.filter.sort' => 'Trier',
    'firewall.filter.prev' => 'Préc.',
    'firewall.filter.next' => 'Suiv.',
    'firewall.filter.loading' => 'Chargement...',
    'firewall.filter.none' => 'Aucune entrée trouvée',
    'firewall.filter.failed_to_load' => 'Échec du chargement',
    'firewall.filter.confirm_remove' => 'Supprimer les éléments sélectionnés ?',
    'firewall.filter.confirm_title' => 'Confirmer',
    'firewall.filter.enable_success' => 'Activé',
    'firewall.filter.disable_success' => 'Désactivé',
    'firewall.filter.remove_success' => 'Supprimé',
    'firewall.filter.action_failed' => 'Action échouée : %s',
    'firewall.filter.action_failed_short' => 'Action échouée',
    'firewall.filter.not_implemented' => 'Pas encore implémenté',
    'firewall.filter.badge_disabled' => 'Désactivé',
    'firewall.filter.badge_dynamic' => 'Dynamique',
    'firewall.filter.badge_invalid' => 'Invalide',
    'firewall.filter.table.select' => 'Sélectionner',
    'firewall.filter.table.number' => '#',
    'firewall.filter.table.flag' => 'Drapeau',
    'firewall.filter.table.action' => 'Action',
    'firewall.filter.table.chain' => 'Chaîne',
    'firewall.filter.table.src_address' => 'Adresse source',
    'firewall.filter.table.dst_address' => 'Adresse destination',
    'firewall.filter.table.protocol' => 'Protocole',
    'firewall.filter.table.src_port' => 'Port source',
    'firewall.filter.table.dst_port' => 'Port destination',
    'firewall.filter.table.in_interface' => 'Interface d\'entrée',
    'firewall.filter.table.out_interface' => 'Interface de sortie',
    'firewall.filter.table.src_address_list' => 'Liste d\'adresses source',
    'firewall.filter.table.dst_address_list' => 'Liste d\'adresses destination',
    'firewall.filter.table.bytes' => 'Octets',
    'firewall.filter.table.packets' => 'Paquets',
    'firewall.nat.desc' => 'Configurez les politiques NAT source et destination pour votre réseau.',
    'firewall.nat.actions' => 'Actions',
    'firewall.nat.new' => 'Nouveau',
    'firewall.nat.edit' => 'Modifier',
    'firewall.nat.enable' => 'Activer',
    'firewall.nat.disable' => 'Désactiver',
    'firewall.nat.remove' => 'Supprimer',
    'firewall.nat.sort.by' => 'Trier par',
    'firewall.nat.sort' => 'Trier',
    'firewall.nat.prev' => 'Préc.',
    'firewall.nat.next' => 'Suiv.',
    'firewall.nat.loading' => 'Chargement...',
    'firewall.nat.none' => 'Aucune entrée trouvée',
    'firewall.nat.failed_to_load' => 'Échec du chargement',
    'firewall.nat.confirm_remove' => 'Supprimer les éléments sélectionnés ?',
    'firewall.nat.confirm_title' => 'Confirmer',
    'firewall.nat.enable_success' => 'Activé',
    'firewall.nat.disable_success' => 'Désactivé',
    'firewall.nat.remove_success' => 'Supprimé',
    'firewall.nat.action_failed' => 'Action échouée : %s',
    'firewall.nat.action_failed_short' => 'Action échouée',
    'firewall.nat.not_implemented' => 'Pas encore implémenté',
    'firewall.nat.badge_disabled' => 'Désactivé',
    'firewall.nat.badge_dynamic' => 'Dynamique',
    'firewall.nat.badge_invalid' => 'Invalide',
    'firewall.nat.table.select' => 'Sélectionner',
    'firewall.nat.table.number' => '#',
    'firewall.nat.table.flag' => 'Drapeau',
    'firewall.nat.table.action' => 'Action',
    'firewall.nat.table.chain' => 'Chaîne',
    'firewall.nat.table.src_address' => 'Adr. source',
    'firewall.nat.table.dst_address' => 'Adr. destination',
    'firewall.nat.table.protocol' => 'Protocole',
    'firewall.nat.table.src_port' => 'Port source',
    'firewall.nat.table.dst_port' => 'Port destination',
    'firewall.nat.table.in_interface' => 'Interface d\'entrée',
    'firewall.nat.table.out_interface' => 'Interface de sortie',
    'firewall.nat.table.bytes' => 'Octets',
    'firewall.nat.table.packets' => 'Paquets',
    'firewall.mangle.desc' => 'Marquez les paquets et connexions pour le routage avancé et la QoS.',
    'firewall.mangle.actions' => 'Actions',
    'firewall.mangle.new' => 'Nouveau',
    'firewall.mangle.edit' => 'Modifier',
    'firewall.mangle.enable' => 'Activer',
    'firewall.mangle.disable' => 'Désactiver',
    'firewall.mangle.remove' => 'Supprimer',
    'firewall.mangle.sort.by' => 'Trier par',
    'firewall.mangle.sort' => 'Trier',
    'firewall.mangle.prev' => 'Préc.',
    'firewall.mangle.next' => 'Suiv.',
    'firewall.mangle.loading' => 'Chargement...',
    'firewall.mangle.none' => 'Aucune entrée trouvée',
    'firewall.mangle.failed_to_load' => 'Échec du chargement',
    'firewall.mangle.confirm_remove' => 'Supprimer les éléments sélectionnés ?',
    'firewall.mangle.confirm_title' => 'Confirmer',
    'firewall.mangle.enable_success' => 'Activé',
    'firewall.mangle.disable_success' => 'Désactivé',
    'firewall.mangle.remove_success' => 'Supprimé',
    'firewall.mangle.action_failed' => 'Action échouée : %s',
    'firewall.mangle.action_failed_short' => 'Action échouée',
    'firewall.mangle.not_implemented' => 'Pas encore implémenté',
    'firewall.mangle.badge_disabled' => 'Désactivé',
    'firewall.mangle.badge_dynamic' => 'Dynamique',
    'firewall.mangle.badge_invalid' => 'Invalide',
    'firewall.mangle.table.select' => 'Sélectionner',
    'firewall.mangle.table.number' => '#',
    'firewall.mangle.table.flag' => 'Drapeau',
    'firewall.mangle.table.action' => 'Action',
    'firewall.mangle.table.chain' => 'Chaîne',
    'firewall.mangle.table.bytes' => 'Octets',
    'firewall.mangle.table.packets' => 'Paquets',
    'firewall.mangle.table.src_address' => 'Adresse source',
    'firewall.mangle.table.dst_address' => 'Adresse destination',
    'firewall.mangle.table.src_address_list' => 'Liste d\'adresses source',
    'firewall.mangle.table.dst_address_list' => 'Liste d\'adresses destination',
    'firewall.mangle.table.protocol' => 'Protocole',
    'firewall.mangle.table.src_port' => 'Port source',
    'firewall.mangle.table.dst_port' => 'Port destination',
    'firewall.mangle.table.in_interface' => 'Interface d\'entrée',
    'firewall.mangle.table.out_interface' => 'Interface de sortie',
    'firewall.raw.desc' => 'Appliquez des filtres raw de pré-routage avant le suivi des connexions.',
    'firewall.raw.actions' => 'Actions',
    'firewall.raw.new' => 'Nouveau',
    'firewall.raw.edit' => 'Modifier',
    'firewall.raw.enable' => 'Activer',
    'firewall.raw.disable' => 'Désactiver',
    'firewall.raw.remove' => 'Supprimer',
    'firewall.raw.sort.by' => 'Trier par',
    'firewall.raw.sort' => 'Trier',
    'firewall.raw.prev' => 'Préc.',
    'firewall.raw.next' => 'Suiv.',
    'firewall.raw.loading' => 'Chargement...',
    'firewall.raw.none' => 'Aucune entrée trouvée',
    'firewall.raw.failed_to_load' => 'Échec du chargement',
    'firewall.raw.confirm_remove' => 'Supprimer les éléments sélectionnés ?',
    'firewall.raw.confirm_title' => 'Confirmer',
    'firewall.raw.enable_success' => 'Activé',
    'firewall.raw.disable_success' => 'Désactivé',
    'firewall.raw.remove_success' => 'Supprimé',
    'firewall.raw.action_failed' => 'Action échouée : %s',
    'firewall.raw.action_failed_short' => 'Action échouée',
    'firewall.raw.not_implemented' => 'Pas encore implémenté',
    'firewall.raw.badge_disabled' => 'Désactivé',
    'firewall.raw.badge_dynamic' => 'Dynamique',
    'firewall.raw.badge_invalid' => 'Invalide',
    'firewall.raw.table.select' => 'Sélectionner',
    'firewall.raw.table.flag' => 'Drapeau',
    'firewall.raw.table.action' => 'Action',
    'firewall.raw.table.chain' => 'Chaîne',
    'firewall.raw.table.src_address' => 'Adresse source',
    'firewall.raw.table.dst_address' => 'Adresse destination',
    'firewall.raw.table.src_address_list' => 'Liste d\'adresses source',
    'firewall.raw.table.dst_address_list' => 'Liste d\'adresses destination',
    'firewall.raw.table.protocol' => 'Protocole',
    'firewall.connections.desc' => 'Inspectez les entrées actuelles de suivi des connexions du pare-feu.',
    'firewall.address.desc' => 'Maintenez des listes d\'adresses réutilisables pour la correspondance des règles.',
    'firewall.address.actions' => 'Actions',
    'firewall.address.new' => 'Nouveau',
    'firewall.address.enable' => 'Activer',
    'firewall.address.disable' => 'Désactiver',
    'firewall.address.remove' => 'Supprimer',
    'firewall.address.refresh' => 'Actualiser',
    'firewall.address.sort.by' => 'Trier par',
    'firewall.address.sort' => 'Trier',
    'firewall.address.prev' => 'Préc.',
    'firewall.address.next' => 'Suiv.',
    'firewall.address.loading' => 'Chargement...',
    'firewall.address.none' => 'Aucune entrée trouvée',
    'firewall.address.failed_to_load' => 'Échec du chargement',
    'firewall.address.confirm_remove' => 'Supprimer les éléments sélectionnés ?',
    'firewall.address.confirm_title' => 'Confirmer',
    'firewall.address.enable_success' => 'Activé',
    'firewall.address.disable_success' => 'Désactivé',
    'firewall.address.remove_success' => 'Supprimé',
    'firewall.address.action_failed' => 'Action échouée : %s',
    'firewall.address.action_failed_short' => 'Action échouée',
    'firewall.address.not_implemented' => 'Pas encore implémenté',
    'firewall.address.table.select' => 'Sélectionner',
    'firewall.address.table.list' => 'Liste',
    'firewall.address.table.address' => 'Adresse',
    'firewall.address.table.time' => 'Heure',
    'firewall.address.table.creation' => 'Création',
    'firewall.address.edit' => 'Modifier',
    'firewall.address.modal.title_new' => 'Ajouter une liste d\'adresses',
    'firewall.address.modal.title_edit' => 'Modifier la liste d\'adresses',
    'firewall.address.modal.enabled' => 'Activé',
    'firewall.address.modal.list' => 'Liste',
    'firewall.address.modal.list_placeholder' => 'Saisir le nom de la liste',
    'firewall.address.modal.list_select_placeholder' => 'Sélectionner une liste d\'adresses existante',
    'firewall.address.modal.address' => 'Adresse',
    'firewall.address.modal.timeout' => 'Délai d\'attente',
    'firewall.address.modal.creation' => 'Heure de création',
    'firewall.address.modal.comment' => 'Commentaire',
    'firewall.address.modal.cancel' => 'Annuler',
    'firewall.address.modal.create' => 'Créer',
    'firewall.address.modal.update' => 'Mettre à jour',
    'firewall.address.modal.list_required' => 'La liste est obligatoire',
    'firewall.address.modal.address_required' => 'L\'adresse est obligatoire',
    'firewall.address.modal.add_success' => 'Liste d\'adresses créée',
    'firewall.address.modal.update_success' => 'Liste d\'adresses mise à jour',
    'firewall.address.modal.save_failed' => 'Échec de l\'enregistrement : %s',
    'firewall.address.modal.request_failed' => 'Échec de la requête',
    'firewall.address.modal.creation_auto' => 'Sera défini automatiquement',
    'firewall.layer7.desc' => 'Gérez les modèles de protocole Layer7 pour l\'inspection approfondie des paquets.',
    'firewall.layer7.actions' => 'Actions',
    'firewall.layer7.new' => 'Nouveau',
    'firewall.layer7.edit' => 'Modifier',
    'firewall.layer7.remove' => 'Supprimer',
    'firewall.layer7.sort.by' => 'Trier par',
    'firewall.layer7.sort' => 'Trier',
    'firewall.layer7.prev' => 'Préc.',
    'firewall.layer7.next' => 'Suiv.',
    'firewall.layer7.loading' => 'Chargement...',
    'firewall.layer7.none' => 'Aucune entrée trouvée',
    'firewall.layer7.failed_to_load' => 'Échec du chargement',
    'firewall.layer7.confirm_remove' => 'Supprimer les éléments sélectionnés ?',
    'firewall.layer7.confirm_title' => 'Confirmer',
    'firewall.layer7.remove_success' => 'Supprimé',
    'firewall.layer7.remove_failed' => 'Suppression échouée : %s',
    'firewall.layer7.remove_failed_short' => 'Suppression échouée',
    'firewall.layer7.not_implemented' => 'Pas encore implémenté',
    'firewall.layer7.table.select' => 'Sélectionner',
    'firewall.layer7.table.name' => 'Nom',
    'firewall.layer7.table.regexp' => 'Regexp',
    'firewall.layer7.modal.title_new' => 'Ajouter un protocole Layer7',
    'firewall.layer7.modal.title_edit' => 'Modifier le protocole Layer7',
    'firewall.layer7.modal.name' => 'Nom',
    'firewall.layer7.modal.regexp' => 'Regexp',
    'firewall.layer7.modal.comment' => 'Commentaire',
    'firewall.layer7.modal.cancel' => 'Annuler',
    'firewall.layer7.modal.create' => 'Créer',
    'firewall.layer7.modal.update' => 'Mettre à jour',
    'firewall.layer7.modal.name_required' => 'Le nom est obligatoire',
    'firewall.layer7.modal.regexp_required' => 'L\'expression régulière est obligatoire',
    'firewall.layer7.modal.add_success' => 'Protocole Layer7 créé',
    'firewall.layer7.modal.update_success' => 'Protocole Layer7 mis à jour',
    'firewall.layer7.modal.save_failed' => 'Échec de l\'enregistrement : %s',
    'firewall.layer7.modal.request_failed' => 'Échec de la requête',
    'firewall.open.filter' => 'Ouvrir les règles de filtrage',
    'firewall.open.nat' => 'Ouvrir le NAT',
    'firewall.open.mangle' => 'Ouvrir le Mangle',
    'firewall.open.raw' => 'Ouvrir le Raw',
    'firewall.open.connections' => 'Ouvrir les connexions',
    'firewall.open.address' => 'Ouvrir les listes d\'adresses',
    'firewall.open.layer7' => 'Ouvrir les protocoles Layer7',
    'firewall.back-to-firewall' => 'Retour au pare-feu',
    'firewall.connections.actions' => 'Actions',
    'firewall.connections.remove' => 'Supprimer',
    'firewall.connections.refresh' => 'Actualiser',
    'firewall.connections.sort.by' => 'Trier par',
    'firewall.connections.sort' => 'Trier',
    'firewall.connections.prev' => 'Préc.',
    'firewall.connections.next' => 'Suiv.',
    'firewall.connections.loading' => 'Chargement des connexions...',
    'firewall.connections.none' => 'Aucune connexion trouvée',
    'firewall.connections.failed_to_load' => 'Échec du chargement',
    'firewall.connections.confirm_remove' => 'Supprimer les connexions sélectionnées ?',
    'firewall.connections.confirm_title' => 'Confirmer',
    'firewall.connections.remove_success' => 'Connexions supprimées',
    'firewall.connections.remove_failed' => 'Suppression échouée : %s',
    'firewall.connections.remove_failed_short' => 'Suppression échouée',
    'firewall.connections.table.select' => 'Sélectionner',
    'firewall.connections.table.flags' => 'Drapeaux',
    'firewall.connections.table.protocol' => 'Protocole',
    'firewall.connections.table.src_address' => 'Adresse source',
    'firewall.connections.table.src_port' => 'Port source',
    'firewall.connections.table.dst_address' => 'Adresse destination',
    'firewall.connections.table.dst_port' => 'Port destination',
    'firewall.connections.table.conn_mark' => 'Marque de connexion',
    'firewall.connections.table.state' => 'État',
    ...
    'maintenance.update_toast' => 'Mode de mise à jour du système' . '<br/><br/>' . 'Des mises à jour système sont en cours. Certaines fonctionnalités peuvent être indisponibles.',
    ...
    'hotspot.users.badge_disabled' => 'Désactivé',
    ...
    'hotspot.modal.form.qty.help'=> 'Nombre de vouchers / codes token qui seront créés.',
    ...
    'hotspot.modal.form.user-type.help'=> 'Nom d\'utilisateur & Mot de passe - Crée un nom d\'utilisateur aléatoire et un mot de passe différent (autorise la connexion utilisateur standard).<br/>Nom d\'utilisateur = Mot de passe - Crée un nom d\'utilisateur aléatoire dont le mot de passe est identique (pour l\'utilisation de vouchers).',
    ...
    'hotspot.modal.form.time-limit.help'=> 'Formats acceptés:<br/>m - Minutes<br/>h - Heures<br/>d - Jours<br/><br/>L’utilisateur est désactivé lorsque la limite de temps est atteinte.<br/><br/>Remarques :<br/>1. Si la limite de temps et la limite de données sont définies, l’utilisateur sera désactivé lorsque l’une ou l’autre limite sera atteinte.<br/>2. Si aucune limite n’est définie, l’utilisateur restera actif jusqu’à ce qu’il soit désactivé ou supprimé manuellement.<br/>3. La limite de temps et la limite de données peuvent être utilisées ensemble pour mieux contrôler les sessions utilisateur.<br/>4. Vérifiez que le format est correct pour éviter les erreurs lors de la création de l’utilisateur.<br/>5. Exemples : 30m (30 minutes), 2h (2 heures), 1d (1 jour).',
    'hotspot.modal.form.data-limit'=>  'Limite de données',
    'hotspot.modal.form.data-limit.help'=> 'Formats acceptés:<br/>M - Mégabits<br/>G - Gigabits<br/><br/>L’utilisateur est désactivé lorsque la limite de données est atteinte.<br/><br/>Remarques :<br/>1. Si la limite de temps et la limite de données sont définies, l’utilisateur sera désactivé lorsque l’une ou l’autre limite sera atteinte.<br/>2. Si aucune limite n’est définie, l’utilisateur restera actif jusqu’à ce qu’il soit désactivé ou supprimé manuellement.<br/>3. La limite de temps et la limite de données peuvent être utilisées ensemble pour mieux contrôler les sessions utilisateur.<br/>4. Vérifiez que le format est correct pour éviter les erreurs lors de la création de l’utilisateur.<br/>5. Exemples : 500M (500 Mégabits), 2G (2 Gigabits).',
    ...
    'hotspot.user.profiles.form.expiry-mode_help'=> 'Sélectionnez comment gérer l\'expiration des utilisateurs pour ce profil.<br/><br/>Options:<br/>Aucune - Pas d\'expiration.<br/>Supprimer - Supprimer automatiquement l\'utilisateur à l\'expiration.<br/>Avis - Notifier l\'utilisateur à l\'expiration mais ne pas supprimer.<br/>Supprimer et enregistrer - Supprimer l\'utilisateur et enregistrer l\'événement.<br/>Supprimer et avertir - Avertir l\'utilisateur puis supprimer à l\'expiration.',
    ...
    'hotspot.export.user.button-move-up'=> 'Déplacer vers le haut',
    'hotspot.export.user.button-move-down'=> 'Déplacer vers le bas',
    'hotspot.export.user.column-order-desc'=> 'Sélectionnez un champ et utilisez les boutons Déplacer vers le haut/vers le bas pour modifier l\'ordre des colonnes.',
    ...
    //'settings.open.reset'=> 'Réinitialiser',
    //'settings.open.reboot'=> 'Redémarrer',
    //'settings.open.shutdown'=> 'Arrêter',
    ...
    'ppp.modal.form.profile.script-onup'=> 'Au démarrage',
    'ppp.modal.form.profile.script-ondown'=> 'À l\'arrêt',
    ...
    // IP DNS - Static DNS
    'ip.dns.static'=> 'DNS statique',
    'ip.dns.static.desc'=> 'Gérer les entrées DNS statiques qui remplacent la résolution DNS dynamique.',

    // IP DNS - Cache Settings
    'ip.dns.cache'=> 'Paramètres du cache DNS',
