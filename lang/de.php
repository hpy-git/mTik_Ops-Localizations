...
return [
    ...
    'nav.quick_login' => 'Schnellanmeldung',
    ...
    'footer.copyright' => 'Urheberrecht &copy; mTikOps {year}',
    ...
    'login.form.connection_type_yes'=> 'Sichere API',
    'login.form.connection_type_no'=> 'Standard-API',
    'login.form.connection_type_help'=> 'Verwenden Sie in den meisten Fällen 8728, es sei denn, Sie haben einen speziellen Grund, 8729 zu verwenden (z. B. wenn für den Router ein SSL-Zertifikat installiert wurde).',
 ...
 // Login Page Messages
    ...
    'about-us.vision-page.title'=> 'Leitbild',
    ...
    'our-team.leadership-page.title'=> 'Führung',
    ...
    'our-team.developers-page.title'=> 'Entwickler',
    ...
    'our-team.contributors-page.title'=> 'Mitwirkende',
    ...
    'our-team.advisors-page.title'=> 'Berater',
    ...
    'firewall.desc' => 'Firewall-Regeln, NAT, Mangle und Werkzeuge zur Verkehrsprüfung verwalten.',
    'firewall.filter' => 'Filterregeln',
    'firewall.nat' => 'NAT',
    'firewall.mangle' => 'Mangle',
    'firewall.raw' => 'Raw',
    'firewall.connections' => 'Verbindungen',
    'firewall.address' => 'Adresslisten',
    'firewall.layer7' => 'Layer7-Protokolle',
    'firewall.filter.desc' => 'Paketfilter-Regeln für die Verkehrskontrolle erstellen und organisieren.',
    'firewall.filter.actions' => 'Aktionen',
    'firewall.filter.new' => 'Neu',
    'firewall.filter.edit' => 'Bearbeiten',
    'firewall.filter.enable' => 'Aktivieren',
    'firewall.filter.disable' => 'Deaktivieren',
    'firewall.filter.remove' => 'Entfernen',
    'firewall.filter.sort.by' => 'Sortieren nach',
    'firewall.filter.sort' => 'Sortieren',
    'firewall.filter.prev' => 'Zurück',
    'firewall.filter.next' => 'Weiter',
    'firewall.filter.loading' => 'Wird geladen...',
    'firewall.filter.none' => 'Keine Einträge gefunden',
    'firewall.filter.failed_to_load' => 'Laden fehlgeschlagen',
    'firewall.filter.confirm_remove' => 'Ausgewählte Einträge entfernen?',
    'firewall.filter.confirm_title' => 'Bestätigen',
    'firewall.filter.enable_success' => 'Aktiviert',
    'firewall.filter.disable_success' => 'Deaktiviert',
    'firewall.filter.remove_success' => 'Entfernt',
    'firewall.filter.action_failed' => 'Aktion fehlgeschlagen: %s',
    'firewall.filter.action_failed_short' => 'Aktion fehlgeschlagen',
    'firewall.filter.not_implemented' => 'Noch nicht implementiert',
    'firewall.filter.badge_disabled' => 'Deaktiviert',
    'firewall.filter.badge_dynamic' => 'Dynamisch',
    'firewall.filter.badge_invalid' => 'Ungültig',
    'firewall.filter.table.select' => 'Auswählen',
    'firewall.filter.table.number' => '#',
    'firewall.filter.table.flag' => 'Flagge',
    'firewall.filter.table.action' => 'Aktion',
    'firewall.filter.table.chain' => 'Kette',
    'firewall.filter.table.src_address' => 'Quelladresse',
    'firewall.filter.table.dst_address' => 'Zieladresse',
    'firewall.filter.table.protocol' => 'Protokoll',
    'firewall.filter.table.src_port' => 'Quellport',
    'firewall.filter.table.dst_port' => 'Zielport',
    'firewall.filter.table.in_interface' => 'Eingangs-Interface',
    'firewall.filter.table.out_interface' => 'Ausgangs-Interface',
    'firewall.filter.table.src_address_list' => 'Quell-Adressliste',
    'firewall.filter.table.dst_address_list' => 'Ziel-Adressliste',
    'firewall.filter.table.bytes' => 'Bytes',
    'firewall.filter.table.packets' => 'Pakete',
    'firewall.nat.desc' => 'Quell- und Ziel-NAT-Richtlinien für Ihr Netzwerk konfigurieren.',
    'firewall.nat.actions' => 'Aktionen',
    'firewall.nat.new' => 'Neu',
    'firewall.nat.edit' => 'Bearbeiten',
    'firewall.nat.enable' => 'Aktivieren',
    'firewall.nat.disable' => 'Deaktivieren',
    'firewall.nat.remove' => 'Entfernen',
    'firewall.nat.sort.by' => 'Sortieren nach',
    'firewall.nat.sort' => 'Sortieren',
    'firewall.nat.prev' => 'Zurück',
    'firewall.nat.next' => 'Weiter',
    'firewall.nat.loading' => 'Wird geladen...',
    'firewall.nat.none' => 'Keine Einträge gefunden',
    'firewall.nat.failed_to_load' => 'Laden fehlgeschlagen',
    'firewall.nat.confirm_remove' => 'Ausgewählte Einträge entfernen?',
    'firewall.nat.confirm_title' => 'Bestätigen',
    'firewall.nat.enable_success' => 'Aktiviert',
    'firewall.nat.disable_success' => 'Deaktiviert',
    'firewall.nat.remove_success' => 'Entfernt',
    'firewall.nat.action_failed' => 'Aktion fehlgeschlagen: %s',
    'firewall.nat.action_failed_short' => 'Aktion fehlgeschlagen',
    'firewall.nat.not_implemented' => 'Noch nicht implementiert',
    'firewall.nat.badge_disabled' => 'Deaktiviert',
    'firewall.nat.badge_dynamic' => 'Dynamisch',
    'firewall.nat.badge_invalid' => 'Ungültig',
    'firewall.nat.table.select' => 'Auswählen',
    'firewall.nat.table.number' => '#',
    'firewall.nat.table.flag' => 'Flagge',
    'firewall.nat.table.action' => 'Aktion',
    'firewall.nat.table.chain' => 'Kette',
    'firewall.nat.table.src_address' => 'Quelladresse',
    'firewall.nat.table.dst_address' => 'Zieladresse',
    'firewall.nat.table.protocol' => 'Protokoll',
    'firewall.nat.table.src_port' => 'Quellport',
    'firewall.nat.table.dst_port' => 'Zielport',
    'firewall.nat.table.in_interface' => 'Eingangs-Interface',
    'firewall.nat.table.out_interface' => 'Ausgangs-Interface',
    'firewall.nat.table.bytes' => 'Bytes',
    'firewall.nat.table.packets' => 'Pakete',
    'firewall.mangle.desc' => 'Pakete und Verbindungen für erweitertes Routing und QoS markieren.',
    'firewall.mangle.actions' => 'Aktionen',
    'firewall.mangle.new' => 'Neu',
    'firewall.mangle.edit' => 'Bearbeiten',
    'firewall.mangle.enable' => 'Aktivieren',
    'firewall.mangle.disable' => 'Deaktivieren',
    'firewall.mangle.remove' => 'Entfernen',
    'firewall.mangle.sort.by' => 'Sortieren nach',
    'firewall.mangle.sort' => 'Sortieren',
    'firewall.mangle.prev' => 'Zurück',
    'firewall.mangle.next' => 'Weiter',
    'firewall.mangle.loading' => 'Wird geladen...',
    'firewall.mangle.none' => 'Keine Einträge gefunden',
    'firewall.mangle.failed_to_load' => 'Laden fehlgeschlagen',
    'firewall.mangle.confirm_remove' => 'Ausgewählte Einträge entfernen?',
    'firewall.mangle.confirm_title' => 'Bestätigen',
    'firewall.mangle.enable_success' => 'Aktiviert',
    'firewall.mangle.disable_success' => 'Deaktiviert',
    'firewall.mangle.remove_success' => 'Entfernt',
    'firewall.mangle.action_failed' => 'Aktion fehlgeschlagen: %s',
    'firewall.mangle.action_failed_short' => 'Aktion fehlgeschlagen',
    'firewall.mangle.not_implemented' => 'Noch nicht implementiert',
    'firewall.mangle.badge_disabled' => 'Deaktiviert',
    'firewall.mangle.badge_dynamic' => 'Dynamisch',
    'firewall.mangle.badge_invalid' => 'Ungültig',
    'firewall.mangle.table.select' => 'Auswählen',
    'firewall.mangle.table.number' => '#',
    'firewall.mangle.table.flag' => 'Flagge',
    'firewall.mangle.table.action' => 'Aktion',
    'firewall.mangle.table.chain' => 'Kette',
    'firewall.mangle.table.bytes' => 'Bytes',
    'firewall.mangle.table.packets' => 'Pakete',
    'firewall.mangle.table.src_address' => 'Quelladresse',
    'firewall.mangle.table.dst_address' => 'Zieladresse',
    'firewall.mangle.table.src_address_list' => 'Quell-Adressliste',
    'firewall.mangle.table.dst_address_list' => 'Ziel-Adressliste',
    'firewall.mangle.table.protocol' => 'Protokoll',
    'firewall.mangle.table.src_port' => 'Quellport',
    'firewall.mangle.table.dst_port' => 'Zielport',
    'firewall.mangle.table.in_interface' => 'Eingangs-Interface',
    'firewall.mangle.table.out_interface' => 'Ausgangs-Interface',
    'firewall.raw.desc' => 'Raw-Prerouting-Filter vor der Verbindungsverfolgung anwenden.',
    'firewall.raw.actions' => 'Aktionen',
    'firewall.raw.new' => 'Neu',
    'firewall.raw.edit' => 'Bearbeiten',
    'firewall.raw.enable' => 'Aktivieren',
    'firewall.raw.disable' => 'Deaktivieren',
    'firewall.raw.remove' => 'Entfernen',
    'firewall.raw.sort.by' => 'Sortieren nach',
    'firewall.raw.sort' => 'Sortieren',
    'firewall.raw.prev' => 'Zurück',
    'firewall.raw.next' => 'Weiter',
    'firewall.raw.loading' => 'Wird geladen...',
    'firewall.raw.none' => 'Keine Einträge gefunden',
    'firewall.raw.failed_to_load' => 'Laden fehlgeschlagen',
    'firewall.raw.confirm_remove' => 'Ausgewählte Einträge entfernen?',
    'firewall.raw.confirm_title' => 'Bestätigen',
    'firewall.raw.enable_success' => 'Aktiviert',
    'firewall.raw.disable_success' => 'Deaktiviert',
    'firewall.raw.remove_success' => 'Entfernt',
    'firewall.raw.action_failed' => 'Aktion fehlgeschlagen: %s',
    'firewall.raw.action_failed_short' => 'Aktion fehlgeschlagen',
    'firewall.raw.not_implemented' => 'Noch nicht implementiert',
    'firewall.raw.badge_disabled' => 'Deaktiviert',
    'firewall.raw.badge_dynamic' => 'Dynamisch',
    'firewall.raw.badge_invalid' => 'Ungültig',
    'firewall.raw.table.select' => 'Auswählen',
    'firewall.raw.table.flag' => 'Flagge',
    'firewall.raw.table.action' => 'Aktion',
    'firewall.raw.table.chain' => 'Kette',
    'firewall.raw.table.src_address' => 'Quelladresse',
    'firewall.raw.table.dst_address' => 'Zieladresse',
    'firewall.raw.table.src_address_list' => 'Quell-Adressliste',
    'firewall.raw.table.dst_address_list' => 'Ziel-Adressliste',
    'firewall.raw.table.protocol' => 'Protokoll',
    'firewall.connections.desc' => 'Aktuelle Einträge der Firewall-Verbindungsverfolgung prüfen.',
    'firewall.address.desc' => 'Wiederverwendbare Adresslisten für Regelabgleiche pflegen.',
    'firewall.address.actions' => 'Aktionen',
    'firewall.address.new' => 'Neu',
    'firewall.address.enable' => 'Aktivieren',
    'firewall.address.disable' => 'Deaktivieren',
    'firewall.address.remove' => 'Entfernen',
    'firewall.address.refresh' => 'Aktualisieren',
    'firewall.address.sort.by' => 'Sortieren nach',
    'firewall.address.sort' => 'Sortieren',
    'firewall.address.prev' => 'Zurück',
    'firewall.address.next' => 'Weiter',
    'firewall.address.loading' => 'Wird geladen...',
    'firewall.address.none' => 'Keine Einträge gefunden',
    'firewall.address.failed_to_load' => 'Laden fehlgeschlagen',
    'firewall.address.confirm_remove' => 'Ausgewählte Einträge entfernen?',
    'firewall.address.confirm_title' => 'Bestätigen',
    'firewall.address.enable_success' => 'Aktiviert',
    'firewall.address.disable_success' => 'Deaktiviert',
    'firewall.address.remove_success' => 'Entfernt',
    'firewall.address.action_failed' => 'Aktion fehlgeschlagen: %s',
    'firewall.address.action_failed_short' => 'Aktion fehlgeschlagen',
    'firewall.address.not_implemented' => 'Noch nicht implementiert',
    'firewall.address.table.select' => 'Auswählen',
    'firewall.address.table.list' => 'Liste',
    'firewall.address.table.address' => 'Adresse',
    'firewall.address.table.time' => 'Zeit',
    'firewall.address.table.creation' => 'Erstellung',
    'firewall.address.edit' => 'Bearbeiten',
    'firewall.address.modal.title_new' => 'Adressliste hinzufügen',
    'firewall.address.modal.title_edit' => 'Adressliste bearbeiten',
    'firewall.address.modal.enabled' => 'Aktiviert',
    'firewall.address.modal.list' => 'Liste',
    'firewall.address.modal.list_placeholder' => 'Listennamen eingeben',
    'firewall.address.modal.list_select_placeholder' => 'Vorhandene Adressliste auswählen',
    'firewall.address.modal.address' => 'Adresse',
    'firewall.address.modal.timeout' => 'Timeout',
    'firewall.address.modal.creation' => 'Erstellungszeit',
    'firewall.address.modal.comment' => 'Kommentar',
    'firewall.address.modal.cancel' => 'Abbrechen',
    'firewall.address.modal.create' => 'Erstellen',
    'firewall.address.modal.update' => 'Aktualisieren',
    'firewall.address.modal.list_required' => 'Liste ist erforderlich',
    'firewall.address.modal.address_required' => 'Adresse ist erforderlich',
    'firewall.address.modal.add_success' => 'Adressliste erstellt',
    'firewall.address.modal.update_success' => 'Adressliste aktualisiert',
    'firewall.address.modal.save_failed' => 'Speichern fehlgeschlagen: %s',
    'firewall.address.modal.request_failed' => 'Anfrage fehlgeschlagen',
    'firewall.address.modal.creation_auto' => 'Wird automatisch gesetzt',
    'firewall.layer7.desc' => 'Layer7-Protokollmuster für Deep Packet Inspection verwalten.',
    'firewall.layer7.actions' => 'Aktionen',
    'firewall.layer7.new' => 'Neu',
    'firewall.layer7.edit' => 'Bearbeiten',
    'firewall.layer7.remove' => 'Entfernen',
    'firewall.layer7.sort.by' => 'Sortieren nach',
    'firewall.layer7.sort' => 'Sortieren',
    'firewall.layer7.prev' => 'Zurück',
    'firewall.layer7.next' => 'Weiter',
    'firewall.layer7.loading' => 'Wird geladen...',
    'firewall.layer7.none' => 'Keine Einträge gefunden',
    'firewall.layer7.failed_to_load' => 'Laden fehlgeschlagen',
    'firewall.layer7.confirm_remove' => 'Ausgewählte Einträge entfernen?',
    'firewall.layer7.confirm_title' => 'Bestätigen',
    'firewall.layer7.remove_success' => 'Entfernt',
    'firewall.layer7.remove_failed' => 'Entfernen fehlgeschlagen: %s',
    'firewall.layer7.remove_failed_short' => 'Entfernen fehlgeschlagen',
    'firewall.layer7.not_implemented' => 'Noch nicht implementiert',
    'firewall.layer7.table.select' => 'Auswählen',
    'firewall.layer7.table.name' => 'Name',
    'firewall.layer7.table.regexp' => 'Regexp',
    'firewall.layer7.modal.title_new' => 'Layer7-Protokoll hinzufügen',
    'firewall.layer7.modal.title_edit' => 'Layer7-Protokoll bearbeiten',
    'firewall.layer7.modal.name' => 'Name',
    'firewall.layer7.modal.regexp' => 'Regexp',
    'firewall.layer7.modal.comment' => 'Kommentar',
    'firewall.layer7.modal.cancel' => 'Abbrechen',
    'firewall.layer7.modal.create' => 'Erstellen',
    'firewall.layer7.modal.update' => 'Aktualisieren',
    'firewall.layer7.modal.name_required' => 'Name ist erforderlich',
    'firewall.layer7.modal.regexp_required' => 'Regexp ist erforderlich',
    'firewall.layer7.modal.add_success' => 'Layer7-Protokoll erstellt',
    'firewall.layer7.modal.update_success' => 'Layer7-Protokoll aktualisiert',
    'firewall.layer7.modal.save_failed' => 'Speichern fehlgeschlagen: %s',
    'firewall.layer7.modal.request_failed' => 'Anfrage fehlgeschlagen',
    'firewall.open.filter' => 'Filterregeln öffnen',
    'firewall.open.nat' => 'NAT öffnen',
    'firewall.open.mangle' => 'Mangle öffnen',
    'firewall.open.raw' => 'Raw öffnen',
    'firewall.open.connections' => 'Verbindungen öffnen',
    'firewall.open.address' => 'Adresslisten öffnen',
    'firewall.open.layer7' => 'Layer7-Protokolle öffnen',
    'firewall.back-to-firewall' => 'Zurück zur Firewall',
    'firewall.connections.actions' => 'Aktionen',
    'firewall.connections.remove' => 'Entfernen',
    'firewall.connections.refresh' => 'Aktualisieren',
    'firewall.connections.sort.by' => 'Sortieren nach',
    'firewall.connections.sort' => 'Sortieren',
    'firewall.connections.prev' => 'Zurück',
    'firewall.connections.next' => 'Weiter',
    'firewall.connections.loading' => 'Verbindungen werden geladen...',
    'firewall.connections.none' => 'Keine Verbindungen gefunden',
    'firewall.connections.failed_to_load' => 'Laden fehlgeschlagen',
    'firewall.connections.confirm_remove' => 'Ausgewählte Verbindungen entfernen?',
    'firewall.connections.confirm_title' => 'Bestätigen',
    'firewall.connections.remove_success' => 'Verbindungen entfernt',
    'firewall.connections.remove_failed' => 'Entfernen fehlgeschlagen: %s',
    'firewall.connections.remove_failed_short' => 'Entfernen fehlgeschlagen',
    'firewall.connections.table.select' => 'Auswählen',
    'firewall.connections.table.flags' => 'Flags',
    'firewall.connections.table.protocol' => 'Protokoll',
    'firewall.connections.table.src_address' => 'Quelladresse',
    'firewall.connections.table.src_port' => 'Quellport',
    'firewall.connections.table.dst_address' => 'Zieladresse',
    'firewall.connections.table.dst_port' => 'Zielport',
    'firewall.connections.table.conn_mark' => 'Verbindungsmarkierung',
    ...
    'hotspot.users.badge_disabled' => 'Deaktiviert',
    ...
    'hotspot.modal.form.qty.help'=> 'Anzahl der Gutscheine/Token-Codes, die erstellt werden.',
    'hotspot.modal.form.username'=> 'Benutzername',
    'hotspot.modal.form.password'=> 'Passwort',
    'hotspot.modal.form.user-type'=> 'Benutzertyp',
    'hotspot.modal.form.user-type.help'=> 'Benutzername & Passwort - Erstellt einen zufälligen Benutzernamen und ein anderes Passwort (ermöglicht regulären Benutzer-Login).<br/>Benutzername = Passwort - Erstellt einen zufälligen Benutzernamen, bei dem das Passwort dem Benutzernamen entspricht (für Voucher).',
    ...
    'hotspot.modal.form.time-limit.help'=> 'Akzeptierte Formate:<br/>m - Minuten<br/>h - Stunden<br/>d - Tage<br/><br/>Der Benutzer wird deaktiviert, wenn das Zeitlimit erreicht ist.<br/><br/>Hinweise:<br/>1. Wenn sowohl Zeitlimit als auch Datenlimit gesetzt sind, wird der Benutzer deaktiviert, wenn eines der Limits erreicht ist.<br/>2. Wenn keines der Limits gesetzt ist, bleibt der Benutzer aktiv, bis er manuell deaktiviert oder entfernt wird.<br/>3. Zeit- und Datenlimit können zusammen verwendet werden, um Sitzungen besser zu steuern.<br/>4. Stellen Sie sicher, dass das Format korrekt ist, um Fehler bei der Erstellung des Benutzers zu vermeiden.<br/>5. Beispiele: 30m (30 Minuten), 2h (2 Stunden), 1d (1 Tag).',
    'hotspot.modal.form.data-limit'=>  'Datenlimit',
    'hotspot.modal.form.data-limit.help'=> 'Akzeptierte Formate:<br/>M - Megabit<br/>G - Gigabit<br/><br/>Der Benutzer wird deaktiviert, wenn das Datenlimit erreicht ist.<br/><br/>Hinweise:<br/>1. Wenn sowohl Zeitlimit als auch Datenlimit gesetzt sind, wird der Benutzer deaktiviert, wenn eines der Limits erreicht ist.<br/>2. Wenn keines der Limits gesetzt ist, bleibt der Benutzer aktiv, bis er manuell deaktiviert oder entfernt wird.<br/>3. Zeit- und Datenlimit können zusammen verwendet werden, um Sitzungen besser zu steuern.<br/>4. Stellen Sie sicher, dass das Format korrekt ist, um Fehler bei der Erstellung des Benutzers zu vermeiden.<br/>5. Beispiele: 500M (500 Megabit), 2G (2 Gigabit).',
    ...
    'hotspot.user.profiles.form.expiry-mode_help'=> 'Wählen Sie, wie mit dem Ablauf von Benutzern für dieses Profil verfahren werden soll.<br/><br/>Optionen:<br/>Keine - Keine Ablaufzeit.<br/>Entfernen - Benutzer bei Ablauf automatisch entfernen.<br/>Benachrichtigen - Benutzer bei Ablauf benachrichtigen, aber nicht entfernen.<br/>Entfernen und protokollieren - Benutzer entfernen und das Ereignis protokollieren.<br/>Benachrichtigen und entfernen - Benutzer benachrichtigen und dann bei Ablauf entfernen.',
    ...
    'hotspot.export.user.button-move-up'=> 'Nach oben',
    'hotspot.export.user.button-move-down'=> 'Nach unten',
    'hotspot.export.user.column-order-desc'=> 'Wählen Sie ein Feld und verwenden Sie die Schaltflächen "Nach oben"/"Nach unten", um die Spaltenreihenfolge zu ändern.',
    ...
    //'settings.open.identity'=> 'Identität öffnen',
    //'settings.open.ntp'=> 'NTP öffnen',
    ...
    //'settings.open.reset'=> 'Zurücksetzen',
    //'settings.open.reboot'=> 'Neustart',
    //'settings.open.shutdown'=> 'Herunterfahren',
    ...
    'queues.simple'=> 'Einfach',
    'queues.tree'=> 'Baum',
    'queues.types'=> 'Typen',
    'queues.simple-queue'=> 'Einfache Warteschlangen',
    'queues.queue-tree'=> 'Warteschlangenbäume',
    'queues.queue-types'=> 'Warteschlangentypen',
    ...
    'queues.modal.form.pkt-marks'=> 'Paketmarkierungen',
    ...
    'ppp.profiles.tab.limits'=> 'Grenzen',
    'ppp.profiles.tab.queue'=> 'Warteschlange',
    ...
    'ip.dhcp.server.dhcp.leases'=> 'Lease-Einträge',
