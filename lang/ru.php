...
return [
    ...
    'login.form.connection_type_yes'=> 'Безопасный API',
    'login.form.connection_type_no'=> 'Стандартный API',
    ...
    // firewall.php
    'firewall.title' => 'Фаервол',
    'firewall.desc' => 'Управляйте правилами фаервола, NAT, mangle и инструментами инспекции трафика.',
    'firewall.filter' => 'Правила фильтрации',
    'firewall.nat' => 'NAT',
    'firewall.mangle' => 'Mangle',
    'firewall.raw' => 'Raw',
    'firewall.connections' => 'Соединения',
    'firewall.address' => 'Списки адресов',
    'firewall.layer7' => 'Протоколы Layer7',
    'firewall.filter.desc' => 'Создавайте и упорядочивайте правила фильтрации пакетов для контроля трафика.',
    'firewall.filter.actions' => 'Действия',
    'firewall.filter.new' => 'Создать',
    'firewall.filter.edit' => 'Редактировать',
    'firewall.filter.enable' => 'Включить',
    'firewall.filter.disable' => 'Отключить',
    'firewall.filter.remove' => 'Удалить',
    'firewall.filter.sort.by' => 'Сортировать по',
    'firewall.filter.sort' => 'Сортировать',
    'firewall.filter.prev' => 'Назад',
    'firewall.filter.next' => 'Вперед',
    'firewall.filter.loading' => 'Загрузка...',
    'firewall.filter.none' => 'Записей нет',
    'firewall.filter.failed_to_load' => 'Не удалось загрузить',
    'firewall.filter.confirm_remove' => 'Удалить выбранные элементы?',
    'firewall.filter.confirm_title' => 'Подтвердить',
    'firewall.filter.enable_success' => 'Включено',
    'firewall.filter.disable_success' => 'Отключено',
    'firewall.filter.remove_success' => 'Удалено',
    'firewall.filter.action_failed' => 'Действие не удалось: %s',
    'firewall.filter.action_failed_short' => 'Действие не удалось',
    'firewall.filter.not_implemented' => 'Еще не реализовано',
    'firewall.filter.badge_disabled' => 'Отключено',
    'firewall.filter.badge_dynamic' => 'Динамическое',
    'firewall.filter.badge_invalid' => 'Недействительно',
    'firewall.filter.table.select' => 'Выбрать',
    'firewall.filter.table.number' => '#',
    'firewall.filter.table.flag' => 'Флаг',
    'firewall.filter.table.action' => 'Действие',
    'firewall.filter.table.chain' => 'Цепочка',
    'firewall.filter.table.src_address' => 'Адрес источника',
    'firewall.filter.table.dst_address' => 'Адрес назначения',
    'firewall.filter.table.protocol' => 'Протокол',
    'firewall.filter.table.src_port' => 'Порт источника',
    'firewall.filter.table.dst_port' => 'Порт назначения',
    'firewall.filter.table.in_interface' => 'Входной интерфейс',
    'firewall.filter.table.out_interface' => 'Выходной интерфейс',
    'firewall.filter.table.src_address_list' => 'Список адресов источника',
    'firewall.filter.table.dst_address_list' => 'Список адресов назначения',
    'firewall.filter.table.bytes' => 'Байты',
    'firewall.filter.table.packets' => 'Пакеты',
    'firewall.nat.desc' => 'Настройте политики NAT источника и назначения для вашей сети.',
    'firewall.nat.actions' => 'Действия',
    'firewall.nat.new' => 'Создать',
    'firewall.nat.edit' => 'Редактировать',
    'firewall.nat.enable' => 'Включить',
    'firewall.nat.disable' => 'Отключить',
    'firewall.nat.remove' => 'Удалить',
    'firewall.nat.sort.by' => 'Сортировать по',
    'firewall.nat.sort' => 'Сортировать',
    'firewall.nat.prev' => 'Назад',
    'firewall.nat.next' => 'Вперед',
    'firewall.nat.loading' => 'Загрузка...',
    'firewall.nat.none' => 'Записей нет',
    'firewall.nat.failed_to_load' => 'Не удалось загрузить',
    'firewall.nat.confirm_remove' => 'Удалить выбранные элементы?',
    'firewall.nat.confirm_title' => 'Подтвердить',
    'firewall.nat.enable_success' => 'Включено',
    'firewall.nat.disable_success' => 'Отключено',
    'firewall.nat.remove_success' => 'Удалено',
    'firewall.nat.action_failed' => 'Действие не удалось: %s',
    'firewall.nat.action_failed_short' => 'Действие не удалось',
    'firewall.nat.not_implemented' => 'Еще не реализовано',
    'firewall.nat.badge_disabled' => 'Отключено',
    'firewall.nat.badge_dynamic' => 'Динамическое',
    'firewall.nat.badge_invalid' => 'Недействительно',
    'firewall.nat.table.select' => 'Выбрать',
    'firewall.nat.table.number' => '#',
    'firewall.nat.table.flag' => 'Флаг',
    'firewall.nat.table.action' => 'Действие',
    'firewall.nat.table.chain' => 'Цепочка',
    'firewall.nat.table.src_address' => 'Источник',
    'firewall.nat.table.dst_address' => 'Назначение',
    'firewall.nat.table.protocol' => 'Протокол',
    'firewall.nat.table.src_port' => 'Порт источника',
    'firewall.nat.table.dst_port' => 'Порт назначения',
    'firewall.nat.table.in_interface' => 'Входной интерфейс',
    'firewall.nat.table.out_interface' => 'Выходной интерфейс',
    'firewall.nat.table.bytes' => 'Байты',
    'firewall.nat.table.packets' => 'Пакеты',
    'firewall.mangle.desc' => 'Маркируйте пакеты и соединения для продвинутой маршрутизации и QoS.',
    'firewall.mangle.actions' => 'Действия',
    'firewall.mangle.new' => 'Создать',
    'firewall.mangle.edit' => 'Редактировать',
    'firewall.mangle.enable' => 'Включить',
    'firewall.mangle.disable' => 'Отключить',
    'firewall.mangle.remove' => 'Удалить',
    'firewall.mangle.sort.by' => 'Сортировать по',
    'firewall.mangle.sort' => 'Сортировать',
    'firewall.mangle.prev' => 'Назад',
    'firewall.mangle.next' => 'Вперед',
    'firewall.mangle.loading' => 'Загрузка...',
    'firewall.mangle.none' => 'Записей нет',
    'firewall.mangle.failed_to_load' => 'Не удалось загрузить',
    'firewall.mangle.confirm_remove' => 'Удалить выбранные элементы?',
    'firewall.mangle.confirm_title' => 'Подтвердить',
    'firewall.mangle.enable_success' => 'Включено',
    'firewall.mangle.disable_success' => 'Отключено',
    'firewall.mangle.remove_success' => 'Удалено',
    'firewall.mangle.action_failed' => 'Действие не удалось: %s',
    'firewall.mangle.action_failed_short' => 'Действие не удалось',
    'firewall.mangle.not_implemented' => 'Еще не реализовано',
    'firewall.mangle.badge_disabled' => 'Отключено',
    'firewall.mangle.badge_dynamic' => 'Динамическое',
    'firewall.mangle.badge_invalid' => 'Недействительно',
    'firewall.mangle.table.select' => 'Выбрать',
    'firewall.mangle.table.number' => '#',
    'firewall.mangle.table.flag' => 'Флаг',
    'firewall.mangle.table.action' => 'Действие',
    'firewall.mangle.table.chain' => 'Цепочка',
    'firewall.mangle.table.bytes' => 'Байты',
    'firewall.mangle.table.packets' => 'Пакеты',
    'firewall.mangle.table.src_address' => 'Адрес источника',
    'firewall.mangle.table.dst_address' => 'Адрес назначения',
    'firewall.mangle.table.src_address_list' => 'Список адресов источника',
    'firewall.mangle.table.dst_address_list' => 'Список адресов назначения',
    'firewall.mangle.table.protocol' => 'Протокол',
    'firewall.mangle.table.src_port' => 'Порт источника',
    'firewall.mangle.table.dst_port' => 'Порт назначения',
    'firewall.mangle.table.in_interface' => 'Входной интерфейс',
    'firewall.mangle.table.out_interface' => 'Выходной интерфейс',
    'firewall.raw.desc' => 'Применяйте raw-фильтры prerouting до отслеживания соединений.',
    'firewall.raw.actions' => 'Действия',
    'firewall.raw.new' => 'Создать',
    'firewall.raw.edit' => 'Редактировать',
    'firewall.raw.enable' => 'Включить',
    'firewall.raw.disable' => 'Отключить',
    'firewall.raw.remove' => 'Удалить',
    'firewall.raw.sort.by' => 'Сортировать по',
    'firewall.raw.sort' => 'Сортировать',
    'firewall.raw.prev' => 'Назад',
    'firewall.raw.next' => 'Вперед',
    'firewall.raw.loading' => 'Загрузка...',
    'firewall.raw.none' => 'Записей нет',
    'firewall.raw.failed_to_load' => 'Не удалось загрузить',
    'firewall.raw.confirm_remove' => 'Удалить выбранные элементы?',
    'firewall.raw.confirm_title' => 'Подтвердить',
    'firewall.raw.enable_success' => 'Включено',
    'firewall.raw.disable_success' => 'Отключено',
    'firewall.raw.remove_success' => 'Удалено',
    'firewall.raw.action_failed' => 'Действие не удалось: %s',
    'firewall.raw.action_failed_short' => 'Действие не удалось',
    'firewall.raw.not_implemented' => 'Еще не реализовано',
    'firewall.raw.badge_disabled' => 'Отключено',
    'firewall.raw.badge_dynamic' => 'Динамическое',
    'firewall.raw.badge_invalid' => 'Недействительно',
    'firewall.raw.table.select' => 'Выбрать',
    'firewall.raw.table.flag' => 'Флаг',
    'firewall.raw.table.action' => 'Действие',
    'firewall.raw.table.chain' => 'Цепочка',
    'firewall.raw.table.src_address' => 'Адрес источника',
    'firewall.raw.table.dst_address' => 'Адрес назначения',
    'firewall.raw.table.src_address_list' => 'Список адресов источника',
    'firewall.raw.table.dst_address_list' => 'Список адресов назначения',
    'firewall.raw.table.protocol' => 'Протокол',
    'firewall.connections.desc' => 'Проверьте текущие записи отслеживания соединений фаервола.',
    'firewall.address.desc' => 'Поддерживайте списки адресов для сопоставления правил.',
    'firewall.address.actions' => 'Действия',
    'firewall.address.new' => 'Создать',
    'firewall.address.enable' => 'Включить',
    'firewall.address.disable' => 'Отключить',
    'firewall.address.remove' => 'Удалить',
    'firewall.address.refresh' => 'Обновить',
    'firewall.address.sort.by' => 'Сортировать по',
    'firewall.address.sort' => 'Сортировать',
    'firewall.address.prev' => 'Назад',
    'firewall.address.next' => 'Вперед',
    'firewall.address.loading' => 'Загрузка...',
    'firewall.address.none' => 'Записей нет',
    'firewall.address.failed_to_load' => 'Не удалось загрузить',
    'firewall.address.confirm_remove' => 'Удалить выбранные элементы?',
    'firewall.address.confirm_title' => 'Подтвердить',
    'firewall.address.enable_success' => 'Включено',
    'firewall.address.disable_success' => 'Отключено',
    'firewall.address.remove_success' => 'Удалено',
    'firewall.address.action_failed' => 'Действие не удалось: %s',
    'firewall.address.action_failed_short' => 'Действие не удалось',
    'firewall.address.not_implemented' => 'Еще не реализовано',
    'firewall.address.table.select' => 'Выбрать',
    'firewall.address.table.list' => 'Список',
    'firewall.address.table.address' => 'Адрес',
    'firewall.address.table.time' => 'Время',
    'firewall.address.table.creation' => 'Создание',
    'firewall.address.edit' => 'Редактировать',
    'firewall.address.modal.title_new' => 'Добавить список адресов',
    'firewall.address.modal.title_edit' => 'Редактировать список адресов',
    'firewall.address.modal.enabled' => 'Включено',
    'firewall.address.modal.list' => 'Список',
    'firewall.address.modal.list_placeholder' => 'Введите название списка',
    'firewall.address.modal.list_select_placeholder' => 'Выберите существующий список адресов',
    'firewall.address.modal.address' => 'Адрес',
    'firewall.address.modal.timeout' => 'Таймаут',
    'firewall.address.modal.creation' => 'Время создания',
    'firewall.address.modal.comment' => 'Комментарий',
    'firewall.address.modal.cancel' => 'Отмена',
    'firewall.address.modal.create' => 'Создать',
    'firewall.address.modal.update' => 'Обновить',
    'firewall.address.modal.list_required' => 'Список обязателен',
    'firewall.address.modal.address_required' => 'Адрес обязателен',
    'firewall.address.modal.add_success' => 'Список адресов создан',
    'firewall.address.modal.update_success' => 'Список адресов обновлен',
    'firewall.address.modal.save_failed' => 'Не удалось сохранить: %s',
    'firewall.address.modal.request_failed' => 'Запрос не выполнен',
    'firewall.address.modal.creation_auto' => 'Будет установлено автоматически',
    'firewall.layer7.desc' => 'Управляйте шаблонами протоколов Layer7 для глубокой инспекции пакетов.',
    'firewall.layer7.actions' => 'Действия',
    'firewall.layer7.new' => 'Создать',
    'firewall.layer7.edit' => 'Редактировать',
    'firewall.layer7.remove' => 'Удалить',
    'firewall.layer7.sort.by' => 'Сортировать по',
    'firewall.layer7.sort' => 'Сортировать',
    'firewall.layer7.prev' => 'Назад',
    'firewall.layer7.next' => 'Вперед',
    'firewall.layer7.loading' => 'Загрузка...',
    'firewall.layer7.none' => 'Записей нет',
    'firewall.layer7.failed_to_load' => 'Не удалось загрузить',
    'firewall.layer7.confirm_remove' => 'Удалить выбранные элементы?',
    'firewall.layer7.confirm_title' => 'Подтвердить',
    'firewall.layer7.remove_success' => 'Удалено',
    'firewall.layer7.remove_failed' => 'Не удалось удалить: %s',
    'firewall.layer7.remove_failed_short' => 'Не удалось удалить',
    'firewall.layer7.not_implemented' => 'Еще не реализовано',
    'firewall.layer7.table.select' => 'Выбрать',
    'firewall.layer7.table.name' => 'Название',
    'firewall.layer7.table.regexp' => 'Regexp',
    'firewall.layer7.modal.title_new' => 'Добавить протокол Layer7',
    'firewall.layer7.modal.title_edit' => 'Редактировать протокол Layer7',
    'firewall.layer7.modal.name' => 'Название',
    'firewall.layer7.modal.regexp' => 'Regexp',
    'firewall.layer7.modal.comment' => 'Комментарий',
    'firewall.layer7.modal.cancel' => 'Отмена',
    'firewall.layer7.modal.create' => 'Создать',
    'firewall.layer7.modal.update' => 'Обновить',
    'firewall.layer7.modal.name_required' => 'Название обязательно',
    'firewall.layer7.modal.regexp_required' => 'Regexp обязателен',
    'firewall.layer7.modal.add_success' => 'Протокол Layer7 создан',
    'firewall.layer7.modal.update_success' => 'Протокол Layer7 обновлен',
    'firewall.layer7.modal.save_failed' => 'Не удалось сохранить: %s',
    'firewall.layer7.modal.request_failed' => 'Запрос не выполнен',
    'firewall.open.filter' => 'Открыть правила фильтрации',
    'firewall.open.nat' => 'Открыть NAT',
    'firewall.open.mangle' => 'Открыть Mangle',
    'firewall.open.raw' => 'Открыть Raw',
    'firewall.open.connections' => 'Открыть соединения',
    'firewall.open.address' => 'Открыть списки адресов',
    'firewall.open.layer7' => 'Открыть протоколы Layer7',
    'firewall.back-to-firewall' => 'Назад к фаерволу',
    'firewall.connections.actions' => 'Действия',
    'firewall.connections.remove' => 'Удалить',
    'firewall.connections.refresh' => 'Обновить',
    'firewall.connections.sort.by' => 'Сортировать по',
    'firewall.connections.sort' => 'Сортировать',
    'firewall.connections.prev' => 'Назад',
    'firewall.connections.next' => 'Вперед',
    'firewall.connections.loading' => 'Загрузка соединений...',
    'firewall.connections.none' => 'Соединений нет',
    'firewall.connections.failed_to_load' => 'Не удалось загрузить',
    'firewall.connections.confirm_remove' => 'Удалить выбранные соединения?',
    'firewall.connections.confirm_title' => 'Подтвердить',
    'firewall.connections.remove_success' => 'Соединения удалены',
    'firewall.connections.remove_failed' => 'Не удалось удалить: %s',
    'firewall.connections.remove_failed_short' => 'Не удалось удалить',
    'firewall.connections.table.select' => 'Выбрать',
    'firewall.connections.table.flags' => 'Флаги',
    'firewall.connections.table.protocol' => 'Протокол',
    'firewall.connections.table.src_address' => 'Адрес источника',
    'firewall.connections.table.src_port' => 'Порт источника',
    'firewall.connections.table.dst_address' => 'Адрес назначения',
    'firewall.connections.table.dst_port' => 'Порт назначения',
    'firewall.connections.table.conn_mark' => 'Метка соединения',
    'firewall.connections.table.state' => 'Состояние',
    ...
    //'settings.open.identity'=> 'Открыть идентификатор',
    //'settings.open.ntp'=> 'Открыть NTP',
    ...
    //'settings.open.reset'=> 'Сброс',
    //'settings.open.reboot'=> 'Перезагрузка',
    //'settings.open.shutdown'=> 'Выключение',
    ...
    'settings.ntp.mode-broadcast'=> 'Широковещание',
    'settings.ntp.mode-manycast'=> 'Многоадресная рассылка',
    ...
    'ppp.table.th.caller-id'=> 'ID вызывающего',
    ...
    'ppp.modal.form.max-mtu'=> 'Макс. MTU',
    'ppp.modal.form.max-mru'=> 'Макс. MRU',
    ...
    'ip.settings.modal.form.ip-tcp-timestamps'=> 'Временные метки TCP',
