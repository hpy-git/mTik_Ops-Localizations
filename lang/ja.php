...
return [
    ...
    'footer.copyright' => '著作権 &copy; mTikOps {year}',
 ...
 // Login Page Messages
    ...
    'firewall.desc' => 'ファイアウォールのルール、NAT、Mangle、トラフィック検査ツールを管理します。',
    'firewall.filter' => 'フィルタールール',
    'firewall.nat' => 'NAT',
    'firewall.mangle' => 'Mangle',
    'firewall.raw' => 'Raw',
    'firewall.connections' => '接続',
    'firewall.address' => 'アドレスリスト',
    'firewall.layer7' => 'Layer7プロトコル',
    'firewall.filter.desc' => 'トラフィック制御のためのパケットフィルタールールを作成・整理します。',
    'firewall.filter.actions' => '操作',
    'firewall.filter.new' => '新規',
    'firewall.filter.edit' => '編集',
    'firewall.filter.enable' => '有効',
    'firewall.filter.disable' => '無効',
    'firewall.filter.remove' => '削除',
    'firewall.filter.sort.by' => '並べ替え基準',
    'firewall.filter.sort' => '並べ替え',
    'firewall.filter.prev' => '前',
    'firewall.filter.next' => '次',
    'firewall.filter.loading' => '読み込み中...',
    'firewall.filter.none' => 'エントリがありません',
    'firewall.filter.failed_to_load' => '読み込みに失敗しました',
    'firewall.filter.confirm_remove' => '選択した項目を削除しますか？',
    'firewall.filter.confirm_title' => '確認',
    'firewall.filter.enable_success' => '有効化しました',
    'firewall.filter.disable_success' => '無効化しました',
    'firewall.filter.remove_success' => '削除しました',
    'firewall.filter.action_failed' => '操作に失敗しました: %s',
    'firewall.filter.action_failed_short' => '操作に失敗しました',
    'firewall.filter.not_implemented' => 'まだ実装されていません',
    'firewall.filter.badge_disabled' => '無効',
    'firewall.filter.badge_dynamic' => '動的',
    'firewall.filter.badge_invalid' => '無効',
    'firewall.filter.table.select' => '選択',
    'firewall.filter.table.number' => '#',
    'firewall.filter.table.flag' => 'フラグ',
    'firewall.filter.table.action' => '操作',
    'firewall.filter.table.chain' => 'チェーン',
    'firewall.filter.table.src_address' => '送信元アドレス',
    'firewall.filter.table.dst_address' => '宛先アドレス',
    'firewall.filter.table.protocol' => 'プロトコル',
    'firewall.filter.table.src_port' => '送信元ポート',
    'firewall.filter.table.dst_port' => '宛先ポート',
    'firewall.filter.table.in_interface' => '入力インターフェース',
    'firewall.filter.table.out_interface' => '出力インターフェース',
    'firewall.filter.table.src_address_list' => '送信元アドレスリスト',
    'firewall.filter.table.dst_address_list' => '宛先アドレスリスト',
    'firewall.filter.table.bytes' => 'バイト',
    'firewall.filter.table.packets' => 'パケット',
    'firewall.nat.desc' => 'ネットワークの送信元・宛先NATポリシーを設定します。',
    'firewall.nat.actions' => '操作',
    'firewall.nat.new' => '新規',
    'firewall.nat.edit' => '編集',
    'firewall.nat.enable' => '有効',
    'firewall.nat.disable' => '無効',
    'firewall.nat.remove' => '削除',
    'firewall.nat.sort.by' => '並べ替え基準',
    'firewall.nat.sort' => '並べ替え',
    'firewall.nat.prev' => '前',
    'firewall.nat.next' => '次',
    'firewall.nat.loading' => '読み込み中...',
    'firewall.nat.none' => 'エントリがありません',
    'firewall.nat.failed_to_load' => '読み込みに失敗しました',
    'firewall.nat.confirm_remove' => '選択した項目を削除しますか？',
    'firewall.nat.confirm_title' => '確認',
    'firewall.nat.enable_success' => '有効化しました',
    'firewall.nat.disable_success' => '無効化しました',
    'firewall.nat.remove_success' => '削除しました',
    'firewall.nat.action_failed' => '操作に失敗しました: %s',
    'firewall.nat.action_failed_short' => '操作に失敗しました',
    'firewall.nat.not_implemented' => 'まだ実装されていません',
    'firewall.nat.badge_disabled' => '無効',
    'firewall.nat.badge_dynamic' => '動的',
    'firewall.nat.badge_invalid' => '無効',
    'firewall.nat.table.select' => '選択',
    'firewall.nat.table.number' => '#',
    'firewall.nat.table.flag' => 'フラグ',
    'firewall.nat.table.action' => '操作',
    'firewall.nat.table.chain' => 'チェーン',
    'firewall.nat.table.src_address' => '送信元',
    'firewall.nat.table.dst_address' => '宛先',
    'firewall.nat.table.protocol' => 'プロトコル',
    'firewall.nat.table.src_port' => '送信元ポート',
    'firewall.nat.table.dst_port' => '宛先ポート',
    'firewall.nat.table.in_interface' => '入力インターフェース',
    'firewall.nat.table.out_interface' => '出力インターフェース',
    'firewall.nat.table.bytes' => 'バイト',
    'firewall.nat.table.packets' => 'パケット',
    'firewall.mangle.desc' => '高度なルーティングとQoSのためにパケットと接続にマークします。',
    'firewall.mangle.actions' => '操作',
    'firewall.mangle.new' => '新規',
    'firewall.mangle.edit' => '編集',
    'firewall.mangle.enable' => '有効',
    'firewall.mangle.disable' => '無効',
    'firewall.mangle.remove' => '削除',
    'firewall.mangle.sort.by' => '並べ替え基準',
    'firewall.mangle.sort' => '並べ替え',
    'firewall.mangle.prev' => '前',
    'firewall.mangle.next' => '次',
    'firewall.mangle.loading' => '読み込み中...',
    'firewall.mangle.none' => 'エントリがありません',
    'firewall.mangle.failed_to_load' => '読み込みに失敗しました',
    'firewall.mangle.confirm_remove' => '選択した項目を削除しますか？',
    'firewall.mangle.confirm_title' => '確認',
    'firewall.mangle.enable_success' => '有効化しました',
    'firewall.mangle.disable_success' => '無効化しました',
    'firewall.mangle.remove_success' => '削除しました',
    'firewall.mangle.action_failed' => '操作に失敗しました: %s',
    'firewall.mangle.action_failed_short' => '操作に失敗しました',
    'firewall.mangle.not_implemented' => 'まだ実装されていません',
    'firewall.mangle.badge_disabled' => '無効',
    'firewall.mangle.badge_dynamic' => '動的',
    'firewall.mangle.badge_invalid' => '無効',
    'firewall.mangle.table.select' => '選択',
    'firewall.mangle.table.number' => '#',
    'firewall.mangle.table.flag' => 'フラグ',
    'firewall.mangle.table.action' => '操作',
    'firewall.mangle.table.chain' => 'チェーン',
    'firewall.mangle.table.bytes' => 'バイト',
    'firewall.mangle.table.packets' => 'パケット',
    'firewall.mangle.table.src_address' => '送信元アドレス',
    'firewall.mangle.table.dst_address' => '宛先アドレス',
    'firewall.mangle.table.src_address_list' => '送信元アドレスリスト',
    'firewall.mangle.table.dst_address_list' => '宛先アドレスリスト',
    'firewall.mangle.table.protocol' => 'プロトコル',
    'firewall.mangle.table.src_port' => '送信元ポート',
    'firewall.mangle.table.dst_port' => '宛先ポート',
    'firewall.mangle.table.in_interface' => '入力インターフェース',
    'firewall.mangle.table.out_interface' => '出力インターフェース',
    'firewall.raw.desc' => '接続追跡の前にrawのプレルーティングフィルタを適用します。',
    'firewall.raw.actions' => '操作',
    'firewall.raw.new' => '新規',
    'firewall.raw.edit' => '編集',
    'firewall.raw.enable' => '有効',
    'firewall.raw.disable' => '無効',
    'firewall.raw.remove' => '削除',
    'firewall.raw.sort.by' => '並べ替え基準',
    'firewall.raw.sort' => '並べ替え',
    'firewall.raw.prev' => '前',
    'firewall.raw.next' => '次',
    'firewall.raw.loading' => '読み込み中...',
    'firewall.raw.none' => 'エントリがありません',
    'firewall.raw.failed_to_load' => '読み込みに失敗しました',
    'firewall.raw.confirm_remove' => '選択した項目を削除しますか？',
    'firewall.raw.confirm_title' => '確認',
    'firewall.raw.enable_success' => '有効化しました',
    'firewall.raw.disable_success' => '無効化しました',
    'firewall.raw.remove_success' => '削除しました',
    'firewall.raw.action_failed' => '操作に失敗しました: %s',
    'firewall.raw.action_failed_short' => '操作に失敗しました',
    'firewall.raw.not_implemented' => 'まだ実装されていません',
    'firewall.raw.badge_disabled' => '無効',
    'firewall.raw.badge_dynamic' => '動的',
    'firewall.raw.badge_invalid' => '無効',
    'firewall.raw.table.select' => '選択',
    'firewall.raw.table.flag' => 'フラグ',
    'firewall.raw.table.action' => '操作',
    'firewall.raw.table.chain' => 'チェーン',
    'firewall.raw.table.src_address' => '送信元アドレス',
    'firewall.raw.table.dst_address' => '宛先アドレス',
    'firewall.raw.table.src_address_list' => '送信元アドレスリスト',
    'firewall.raw.table.dst_address_list' => '宛先アドレスリスト',
    'firewall.raw.table.protocol' => 'プロトコル',
    'firewall.connections.desc' => '現在のファイアウォール接続追跡エントリを確認します。',
    'firewall.address.desc' => 'ルール照合に再利用できるアドレスリストを管理します。',
    'firewall.address.actions' => '操作',
    'firewall.address.new' => '新規',
    'firewall.address.enable' => '有効',
    'firewall.address.disable' => '無効',
    'firewall.address.remove' => '削除',
    'firewall.address.refresh' => '更新',
    'firewall.address.sort.by' => '並べ替え基準',
    'firewall.address.sort' => '並べ替え',
    'firewall.address.prev' => '前',
    'firewall.address.next' => '次',
    'firewall.address.loading' => '読み込み中...',
    'firewall.address.none' => 'エントリがありません',
    'firewall.address.failed_to_load' => '読み込みに失敗しました',
    'firewall.address.confirm_remove' => '選択した項目を削除しますか？',
    'firewall.address.confirm_title' => '確認',
    'firewall.address.enable_success' => '有効化しました',
    'firewall.address.disable_success' => '無効化しました',
    'firewall.address.remove_success' => '削除しました',
    'firewall.address.action_failed' => '操作に失敗しました: %s',
    'firewall.address.action_failed_short' => '操作に失敗しました',
    'firewall.address.not_implemented' => 'まだ実装されていません',
    'firewall.address.table.select' => '選択',
    'firewall.address.table.list' => 'リスト',
    'firewall.address.table.address' => 'アドレス',
    'firewall.address.table.time' => '時間',
    'firewall.address.table.creation' => '作成',
    'firewall.address.edit' => '編集',
    'firewall.address.modal.title_new' => 'アドレスリストを追加',
    'firewall.address.modal.title_edit' => 'アドレスリストを編集',
    'firewall.address.modal.enabled' => '有効',
    'firewall.address.modal.list' => 'リスト',
    'firewall.address.modal.list_placeholder' => 'リスト名を入力',
    'firewall.address.modal.list_select_placeholder' => '既存のアドレスリストを選択',
    'firewall.address.modal.address' => 'アドレス',
    'firewall.address.modal.timeout' => 'タイムアウト',
    'firewall.address.modal.creation' => '作成時刻',
    'firewall.address.modal.comment' => 'コメント',
    'firewall.address.modal.cancel' => 'キャンセル',
    'firewall.address.modal.create' => '作成',
    'firewall.address.modal.update' => '更新',
    'firewall.address.modal.list_required' => 'リストは必須です',
    'firewall.address.modal.address_required' => 'アドレスは必須です',
    'firewall.address.modal.add_success' => 'アドレスリストを作成しました',
    'firewall.address.modal.update_success' => 'アドレスリストを更新しました',
    'firewall.address.modal.save_failed' => '保存に失敗しました: %s',
    'firewall.address.modal.request_failed' => 'リクエストに失敗しました',
    'firewall.address.modal.creation_auto' => '自動的に設定されます',
    'firewall.layer7.desc' => 'ディープパケット検査のためのLayer7プロトコルパターンを管理します。',
    'firewall.layer7.actions' => '操作',
    'firewall.layer7.new' => '新規',
    'firewall.layer7.edit' => '編集',
    'firewall.layer7.remove' => '削除',
    'firewall.layer7.sort.by' => '並べ替え基準',
    'firewall.layer7.sort' => '並べ替え',
    'firewall.layer7.prev' => '前',
    'firewall.layer7.next' => '次',
    'firewall.layer7.loading' => '読み込み中...',
    'firewall.layer7.none' => 'エントリがありません',
    'firewall.layer7.failed_to_load' => '読み込みに失敗しました',
    'firewall.layer7.confirm_remove' => '選択した項目を削除しますか？',
    'firewall.layer7.confirm_title' => '確認',
    'firewall.layer7.remove_success' => '削除しました',
    'firewall.layer7.remove_failed' => '削除に失敗しました: %s',
    'firewall.layer7.remove_failed_short' => '削除に失敗しました',
    'firewall.layer7.not_implemented' => 'まだ実装されていません',
    'firewall.layer7.table.select' => '選択',
    'firewall.layer7.table.name' => '名前',
    'firewall.layer7.table.regexp' => '正規表現',
    'firewall.layer7.modal.title_new' => 'Layer7プロトコルを追加',
    'firewall.layer7.modal.title_edit' => 'Layer7プロトコルを編集',
    'firewall.layer7.modal.name' => '名前',
    'firewall.layer7.modal.regexp' => '正規表現',
    'firewall.layer7.modal.comment' => 'コメント',
    'firewall.layer7.modal.cancel' => 'キャンセル',
    'firewall.layer7.modal.create' => '作成',
    'firewall.layer7.modal.update' => '更新',
    'firewall.layer7.modal.name_required' => '名前は必須です',
    'firewall.layer7.modal.regexp_required' => '正規表現は必須です',
    'firewall.layer7.modal.add_success' => 'Layer7プロトコルを作成しました',
    'firewall.layer7.modal.update_success' => 'Layer7プロトコルを更新しました',
    'firewall.layer7.modal.save_failed' => '保存に失敗しました: %s',
    'firewall.layer7.modal.request_failed' => 'リクエストに失敗しました',
    'firewall.open.filter' => 'フィルタールールを開く',
    'firewall.open.nat' => 'NATを開く',
    'firewall.open.mangle' => 'Mangleを開く',
    'firewall.open.raw' => 'Rawを開く',
    'firewall.open.connections' => '接続を開く',
    'firewall.open.address' => 'アドレスリストを開く',
    'firewall.open.layer7' => 'Layer7プロトコルを開く',
    'firewall.back-to-firewall' => 'ファイアウォールに戻る',
    'firewall.connections.actions' => '操作',
    'firewall.connections.remove' => '削除',
    'firewall.connections.refresh' => '更新',
    'firewall.connections.sort.by' => '並べ替え基準',
    'firewall.connections.sort' => '並べ替え',
    'firewall.connections.prev' => '前',
    'firewall.connections.next' => '次',
    'firewall.connections.loading' => '接続を読み込み中...',
    'firewall.connections.none' => '接続がありません',
    'firewall.connections.failed_to_load' => '読み込みに失敗しました',
    'firewall.connections.confirm_remove' => '選択した接続を削除しますか？',
    'firewall.connections.confirm_title' => '確認',
    'firewall.connections.remove_success' => '接続を削除しました',
    'firewall.connections.remove_failed' => '削除に失敗しました: %s',
    'firewall.connections.remove_failed_short' => '削除に失敗しました',
    'firewall.connections.table.select' => '選択',
    'firewall.connections.table.flags' => 'フラグ',
    'firewall.connections.table.protocol' => 'プロトコル',
    'firewall.connections.table.src_address' => '送信元アドレス',
    'firewall.connections.table.src_port' => '送信元ポート',
    'firewall.connections.table.dst_address' => '宛先アドレス',
    'firewall.connections.table.dst_port' => '宛先ポート',
    'firewall.connections.table.conn_mark' => '接続マーク',
    'firewall.connections.table.state' => '状態',
    ...
    //'settings.open.identity'=> '識別情報を開く',
    //'settings.open.ntp'=> 'NTP を開く',
    'settings.open.files'=> 'ファイルを開く',
    'settings.open.users'=> 'ユーザーを管理',
    'settings.open.scheduler'=> 'スケジューラを開く',
    'settings.open.scripts'=> 'スクリプトを開く',
    //'settings.open.reset'=> 'リセット',
    //'settings.open.reboot'=> '再起動',
    //'settings.open.shutdown'=> 'シャットダウン',
