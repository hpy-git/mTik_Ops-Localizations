...
return [
    ...
    'footer.copyright' => 'Katungod sa Pagpanag-iya &copy; mTikOps {year}',
    ...
    'login.form.host'=> 'Host (Server)',
    'login.form.username'=> 'Ngalan sa Tiggamit',
    'login.form.password'=> 'Kontrasena',
    'login.form.connection_type'=> 'Tipo sa Koneksyon',
    'login.form.connection_type_yes'=> 'Luwas nga API',
    'login.form.connection_type_no'=> 'Standard nga API',
    ...
    'login.form.port'=> 'Numero sa Port',
 ...
 // Login Page Messages
    ...
    'about-us.faqs'=> 'Kasagarang Pangutana',
    ...
    // About Us - FAQs Page
    'about-us.faqs-page.title'=> 'Kasagarang Pangutana',
    ...
    'our-team.leadership-page.title'=> 'Pamunoan',
    'our-team.leadership-page.desc'=> 'Himamaton ang mga nag-unang maintainer ug lider sa proyekto sa luyo sa mTikOps.',
    ...
    'our-team.contributors-page.desc'=> 'Pag-ila sa mga kontribyutor sa komunidad ug unsaon pag-apil.',

    // Our Team - Advisors Page
    'our-team.advisors-page.title'=> 'Mga Tigabay',
    'our-team.advisors-page.desc'=> 'Mga tigabay ug eksperto nga naghatag og giya sa proyekto.',

    // Our Team - Join Us Page
    'our-team.join-us-page.title'=> 'Apil Kanamo',
    'our-team.join-us-page.desc'=> 'Susiha ang bukas nga mga papel ug unsaon pag-amot sa mTikOps.',  

    // Our Team - Contact Page
    'our-team.contact-page.title'=> 'Kontak',
    'our-team.contact-page.desc'=> 'Mga paagi sa pagkontak sa mTik_Ops team para sa kolaborasyon o suporta.',
    ...
    'device.serial' => 'Numero sa Serial',
    'device.architecture' => 'Arkitektura',
    'device.cpu_label' => 'CPU',
    'device.cores' => 'Cores',
    'device.build' => 'Bersyon sa Build',
    ...
    'dashboard.uptime' => 'Oras sa Pagdagan',
    ...
    'firewall.desc' => 'Dumala ang mga firewall rule, NAT, mangle, ug mga himan sa inspeksyon sa trapiko.',
    'firewall.filter' => 'Mga Rule sa Filter',
    'firewall.nat' => 'NAT',
    'firewall.mangle' => 'Mangle',
    'firewall.raw' => 'Raw',
    'firewall.connections' => 'Mga Koneksyon',
    'firewall.address' => 'Mga Lista sa Address',
    'firewall.layer7' => 'Mga Protokol sa Layer7',
    'firewall.filter.desc' => 'Paghimo ug i-organisar ang mga packet filtering rule para sa kontrol sa trapiko.',
    'firewall.filter.actions' => 'Mga Aksyon',
    'firewall.filter.new' => 'Bag-o',
    'firewall.filter.edit' => 'I-edit',
    'firewall.filter.enable' => 'I-enable',
    'firewall.filter.disable' => 'I-disable',
    'firewall.filter.remove' => 'Kuhaa',
    'firewall.filter.sort.by' => 'Isort pinaagi sa',
    'firewall.filter.sort' => 'Isort',
    'firewall.filter.prev' => 'Miuna',
    'firewall.filter.next' => 'Sunod',
    'firewall.filter.loading' => 'Nag-load...',
    'firewall.filter.none' => 'Walay nakit-an nga entry',
    'firewall.filter.failed_to_load' => 'Napakyas sa pag-load',
    'firewall.filter.confirm_remove' => 'Kuhaa ang napiling mga item?',
    'firewall.filter.confirm_title' => 'Kumpirma',
    'firewall.filter.enable_success' => 'Gi-enable',
    'firewall.filter.disable_success' => 'Gi-disable',
    'firewall.filter.remove_success' => 'Gikuha',
    'firewall.filter.action_failed' => 'Napakyas ang aksyon: %s',
    'firewall.filter.action_failed_short' => 'Napakyas ang aksyon',
    'firewall.filter.not_implemented' => 'Wala pa na-implementar',
    'firewall.filter.badge_disabled' => 'Gi-disable',
    'firewall.filter.badge_dynamic' => 'Dinamik',
    'firewall.filter.badge_invalid' => 'Dili balido',
    'firewall.filter.table.select' => 'Pili-a',
    'firewall.filter.table.number' => '#',
    'firewall.filter.table.flag' => 'Bandila',
    'firewall.filter.table.action' => 'Aksyon',
    'firewall.filter.table.chain' => 'Kadena',
    'firewall.filter.table.src_address' => 'Gikan nga Address',
    'firewall.filter.table.dst_address' => 'Padulngan nga Address',
    'firewall.filter.table.protocol' => 'Protokol',
    'firewall.filter.table.src_port' => 'Gikan nga Port',
    'firewall.filter.table.dst_port' => 'Padulngan nga Port',
    'firewall.filter.table.in_interface' => 'Sulod nga Interface',
    'firewall.filter.table.out_interface' => 'Gawas nga Interface',
    'firewall.filter.table.src_address_list' => 'Lista sa Gikan nga Address',
    'firewall.filter.table.dst_address_list' => 'Lista sa Padulngan nga Address',
    'firewall.filter.table.bytes' => 'Mga Byte',
    'firewall.filter.table.packets' => 'Mga Packet',
    'firewall.nat.desc' => 'I-configure ang source ug destination NAT policies para sa imong network.',
    'firewall.nat.actions' => 'Mga Aksyon',
    'firewall.nat.new' => 'Bag-o',
    'firewall.nat.edit' => 'I-edit',
    'firewall.nat.enable' => 'I-enable',
    'firewall.nat.disable' => 'I-disable',
    'firewall.nat.remove' => 'Kuhaa',
    'firewall.nat.sort.by' => 'Isort pinaagi sa',
    'firewall.nat.sort' => 'Isort',
    'firewall.nat.prev' => 'Miuna',
    'firewall.nat.next' => 'Sunod',
    'firewall.nat.loading' => 'Nag-load...',
    'firewall.nat.none' => 'Walay nakit-an nga entry',
    'firewall.nat.failed_to_load' => 'Napakyas sa pag-load',
    'firewall.nat.confirm_remove' => 'Kuhaa ang napiling mga item?',
    'firewall.nat.confirm_title' => 'Kumpirma',
    'firewall.nat.enable_success' => 'Gi-enable',
    'firewall.nat.disable_success' => 'Gi-disable',
    'firewall.nat.remove_success' => 'Gikuha',
    'firewall.nat.action_failed' => 'Napakyas ang aksyon: %s',
    'firewall.nat.action_failed_short' => 'Napakyas ang aksyon',
    'firewall.nat.not_implemented' => 'Wala pa na-implementar',
    'firewall.nat.badge_disabled' => 'Gi-disable',
    'firewall.nat.badge_dynamic' => 'Dinamik',
    'firewall.nat.badge_invalid' => 'Dili balido',
    'firewall.nat.table.select' => 'Pili-a',
    'firewall.nat.table.number' => '#',
    'firewall.nat.table.flag' => 'Bandila',
    'firewall.nat.table.action' => 'Aksyon',
    'firewall.nat.table.chain' => 'Kadena',
    'firewall.nat.table.src_address' => 'Gikan nga Address',
    'firewall.nat.table.dst_address' => 'Padulngan nga Address',
    'firewall.nat.table.protocol' => 'Protokol',
    'firewall.nat.table.src_port' => 'Gikan nga Port',
    'firewall.nat.table.dst_port' => 'Padulngan nga Port',
    'firewall.nat.table.in_interface' => 'Sulod nga Interface',
    'firewall.nat.table.out_interface' => 'Gawas nga Interface',
    'firewall.nat.table.bytes' => 'Mga Byte',
    'firewall.nat.table.packets' => 'Mga Packet',
    'firewall.mangle.desc' => 'Markahan ang mga packet ug koneksyon para sa advanced routing ug QoS.',
    'firewall.mangle.actions' => 'Mga Aksyon',
    'firewall.mangle.new' => 'Bag-o',
    'firewall.mangle.edit' => 'I-edit',
    'firewall.mangle.enable' => 'I-enable',
    'firewall.mangle.disable' => 'I-disable',
    'firewall.mangle.remove' => 'Kuhaa',
    'firewall.mangle.sort.by' => 'Isort pinaagi sa',
    'firewall.mangle.sort' => 'Isort',
    'firewall.mangle.prev' => 'Miuna',
    'firewall.mangle.next' => 'Sunod',
    'firewall.mangle.loading' => 'Nag-load...',
    'firewall.mangle.none' => 'Walay nakit-an nga entry',
    'firewall.mangle.failed_to_load' => 'Napakyas sa pag-load',
    'firewall.mangle.confirm_remove' => 'Kuhaa ang napiling mga item?',
    'firewall.mangle.confirm_title' => 'Kumpirma',
    'firewall.mangle.enable_success' => 'Gi-enable',
    'firewall.mangle.disable_success' => 'Gi-disable',
    'firewall.mangle.remove_success' => 'Gikuha',
    'firewall.mangle.action_failed' => 'Napakyas ang aksyon: %s',
    'firewall.mangle.action_failed_short' => 'Napakyas ang aksyon',
    'firewall.mangle.not_implemented' => 'Wala pa na-implementar',
    'firewall.mangle.badge_disabled' => 'Gi-disable',
    'firewall.mangle.badge_dynamic' => 'Dinamik',
    'firewall.mangle.badge_invalid' => 'Dili balido',
    'firewall.mangle.table.select' => 'Pili-a',
    'firewall.mangle.table.number' => '#',
    'firewall.mangle.table.flag' => 'Bandila',
    'firewall.mangle.table.action' => 'Aksyon',
    'firewall.mangle.table.chain' => 'Kadena',
    'firewall.mangle.table.bytes' => 'Mga Byte',
    'firewall.mangle.table.packets' => 'Mga Packet',
    'firewall.mangle.table.src_address' => 'Gikan nga Address',
    'firewall.mangle.table.dst_address' => 'Padulngan nga Address',
    'firewall.mangle.table.src_address_list' => 'Lista sa Gikan nga Address',
    'firewall.mangle.table.dst_address_list' => 'Lista sa Padulngan nga Address',
    'firewall.mangle.table.protocol' => 'Protokol',
    'firewall.mangle.table.src_port' => 'Gikan nga Port',
    'firewall.mangle.table.dst_port' => 'Padulngan nga Port',
    'firewall.mangle.table.in_interface' => 'Sulod nga Interface',
    'firewall.mangle.table.out_interface' => 'Gawas nga Interface',
    'firewall.raw.desc' => 'I-apply ang raw prerouting filters sa wala pa connection tracking.',
    'firewall.raw.actions' => 'Mga Aksyon',
    'firewall.raw.new' => 'Bag-o',
    'firewall.raw.edit' => 'I-edit',
    'firewall.raw.enable' => 'I-enable',
    'firewall.raw.disable' => 'I-disable',
    'firewall.raw.remove' => 'Kuhaa',
    'firewall.raw.sort.by' => 'Isort pinaagi sa',
    'firewall.raw.sort' => 'Isort',
    'firewall.raw.prev' => 'Miuna',
    'firewall.raw.next' => 'Sunod',
    'firewall.raw.loading' => 'Nag-load...',
    'firewall.raw.none' => 'Walay nakit-an nga entry',
    'firewall.raw.failed_to_load' => 'Napakyas sa pag-load',
    'firewall.raw.confirm_remove' => 'Kuhaa ang napiling mga item?',
    'firewall.raw.confirm_title' => 'Kumpirma',
    'firewall.raw.enable_success' => 'Gi-enable',
    'firewall.raw.disable_success' => 'Gi-disable',
    'firewall.raw.remove_success' => 'Gikuha',
    'firewall.raw.action_failed' => 'Napakyas ang aksyon: %s',
    'firewall.raw.action_failed_short' => 'Napakyas ang aksyon',
    'firewall.raw.not_implemented' => 'Wala pa na-implementar',
    'firewall.raw.badge_disabled' => 'Gi-disable',
    'firewall.raw.badge_dynamic' => 'Dinamik',
    'firewall.raw.badge_invalid' => 'Dili balido',
    'firewall.raw.table.select' => 'Pili-a',
    'firewall.raw.table.flag' => 'Bandila',
    'firewall.raw.table.action' => 'Aksyon',
    'firewall.raw.table.chain' => 'Kadena',
    'firewall.raw.table.src_address' => 'Gikan nga Address',
    'firewall.raw.table.dst_address' => 'Padulngan nga Address',
    'firewall.raw.table.src_address_list' => 'Lista sa Gikan nga Address',
    'firewall.raw.table.dst_address_list' => 'Lista sa Padulngan nga Address',
    'firewall.raw.table.protocol' => 'Protokol',
    'firewall.connections.desc' => 'Susiha ang kasamtangang firewall connection tracking entries.',
    'firewall.address.desc' => 'Ipadayon ang magamit pag-usab nga mga lista sa address para sa rule matching.',
    'firewall.address.actions' => 'Mga Aksyon',
    'firewall.address.new' => 'Bag-o',
    'firewall.address.enable' => 'I-enable',
    'firewall.address.disable' => 'I-disable',
    'firewall.address.remove' => 'Kuhaa',
    'firewall.address.refresh' => 'I-refresh',
    'firewall.address.sort.by' => 'Isort pinaagi sa',
    'firewall.address.sort' => 'Isort',
    'firewall.address.prev' => 'Miuna',
    'firewall.address.next' => 'Sunod',
    'firewall.address.loading' => 'Nag-load...',
    'firewall.address.none' => 'Walay nakit-an nga entry',
    'firewall.address.failed_to_load' => 'Napakyas sa pag-load',
    'firewall.address.confirm_remove' => 'Kuhaa ang napiling mga item?',
    'firewall.address.confirm_title' => 'Kumpirma',
    'firewall.address.enable_success' => 'Gi-enable',
    'firewall.address.disable_success' => 'Gi-disable',
    'firewall.address.remove_success' => 'Gikuha',
    'firewall.address.action_failed' => 'Napakyas ang aksyon: %s',
    'firewall.address.action_failed_short' => 'Napakyas ang aksyon',
    'firewall.address.not_implemented' => 'Wala pa na-implementar',
    'firewall.address.table.select' => 'Pili-a',
    'firewall.address.table.list' => 'Lista',
    'firewall.address.table.address' => 'Adres',
    'firewall.address.table.time' => 'Oras',
    'firewall.address.table.creation' => 'Pagmugna',
    'firewall.address.edit' => 'I-edit',
    'firewall.address.modal.title_new' => 'Dugang Lista sa Address',
    'firewall.address.modal.title_edit' => 'I-edit ang Lista sa Address',
    'firewall.address.modal.enabled' => 'Gi-enable',
    'firewall.address.modal.list' => 'Lista',
    'firewall.address.modal.list_placeholder' => 'Isulod ang ngalan sa lista',
    'firewall.address.modal.list_select_placeholder' => 'Pili-a ang naa nang lista sa address',
    'firewall.address.modal.address' => 'Adres',
    'firewall.address.modal.timeout' => 'Panahon sa Timeout',
    'firewall.address.modal.creation' => 'Oras sa Pagmugna',
    'firewall.address.modal.comment' => 'Komento',
    'firewall.address.modal.cancel' => 'Kanselahon',
    'firewall.address.modal.create' => 'Paghimo',
    'firewall.address.modal.update' => 'I-update',
    'firewall.address.modal.list_required' => 'Kinahanglan ang lista',
    'firewall.address.modal.address_required' => 'Kinahanglan ang address',
    'firewall.address.modal.add_success' => 'Nahimo ang lista sa address',
    'firewall.address.modal.update_success' => 'Na-update ang lista sa address',
    'firewall.address.modal.save_failed' => 'Napakyas ang pag-save: %s',
    'firewall.address.modal.request_failed' => 'Napakyas ang hangyo',
    'firewall.address.modal.creation_auto' => 'I-set awtomatiko',
    'firewall.layer7.desc' => 'Dumala ang mga Layer7 protocol pattern para sa deep packet inspection.',
    'firewall.layer7.actions' => 'Mga Aksyon',
    'firewall.layer7.new' => 'Bag-o',
    'firewall.layer7.edit' => 'I-edit',
    'firewall.layer7.remove' => 'Kuhaa',
    'firewall.layer7.sort.by' => 'Isort pinaagi sa',
    'firewall.layer7.sort' => 'Isort',
    'firewall.layer7.prev' => 'Miuna',
    'firewall.layer7.next' => 'Sunod',
    'firewall.layer7.loading' => 'Nag-load...',
    'firewall.layer7.none' => 'Walay nakit-an nga entry',
    'firewall.layer7.failed_to_load' => 'Napakyas sa pag-load',
    'firewall.layer7.confirm_remove' => 'Kuhaa ang napiling mga item?',
    'firewall.layer7.confirm_title' => 'Kumpirma',
    'firewall.layer7.remove_success' => 'Gikuha',
    'firewall.layer7.remove_failed' => 'Napakyas ang pagtangtang: %s',
    'firewall.layer7.remove_failed_short' => 'Napakyas ang pagtangtang',
    'firewall.layer7.not_implemented' => 'Wala pa na-implementar',
    'firewall.layer7.table.select' => 'Pili-a',
    'firewall.layer7.table.name' => 'Ngalan',
    'firewall.layer7.table.regexp' => 'Regexp',
    'firewall.layer7.modal.title_new' => 'Dugang Layer7 Protocol',
    'firewall.layer7.modal.title_edit' => 'I-edit ang Layer7 Protocol',
    'firewall.layer7.modal.name' => 'Ngalan',
    'firewall.layer7.modal.regexp' => 'Regexp',
    'firewall.layer7.modal.comment' => 'Komento',
    'firewall.layer7.modal.cancel' => 'Kanselahon',
    'firewall.layer7.modal.create' => 'Paghimo',
    'firewall.layer7.modal.update' => 'I-update',
    'firewall.layer7.modal.name_required' => 'Kinahanglan ang ngalan',
    'firewall.layer7.modal.regexp_required' => 'Kinahanglan ang regexp',
    'firewall.layer7.modal.add_success' => 'Nahimo ang Layer7 protocol',
    'firewall.layer7.modal.update_success' => 'Na-update ang Layer7 protocol',
    'firewall.layer7.modal.save_failed' => 'Napakyas ang pag-save: %s',
    'firewall.layer7.modal.request_failed' => 'Napakyas ang hangyo',
    'firewall.open.filter' => 'Ablihi ang Mga Rule sa Filter',
    'firewall.open.nat' => 'Ablihi ang NAT',
    'firewall.open.mangle' => 'Ablihi ang Mangle',
    'firewall.open.raw' => 'Ablihi ang Raw',
    'firewall.open.connections' => 'Ablihi ang Mga Koneksyon',
    'firewall.open.address' => 'Ablihi ang Mga Lista sa Address',
    'firewall.open.layer7' => 'Ablihi ang Mga Protokol sa Layer7',
    'firewall.back-to-firewall' => 'Balik sa Firewall',
    'firewall.connections.actions' => 'Mga Aksyon',
    'firewall.connections.remove' => 'Kuhaa',
    'firewall.connections.refresh' => 'I-refresh',
    'firewall.connections.sort.by' => 'Isort pinaagi sa',
    'firewall.connections.sort' => 'Isort',
    'firewall.connections.prev' => 'Miuna',
    'firewall.connections.next' => 'Sunod',
    'firewall.connections.loading' => 'Nag-load sa mga koneksyon...',
    'firewall.connections.none' => 'Walay nakit-an nga koneksyon',
    'firewall.connections.failed_to_load' => 'Napakyas sa pag-load',
    'firewall.connections.confirm_remove' => 'Kuhaa ang napiling koneksyon?',
    'firewall.connections.confirm_title' => 'Kumpirma',
    'firewall.connections.remove_success' => 'Gikuha ang mga koneksyon',
    'firewall.connections.remove_failed' => 'Napakyas ang pagtangtang: %s',
    'firewall.connections.remove_failed_short' => 'Napakyas ang pagtangtang',
    'firewall.connections.table.select' => 'Pili-a',
    'firewall.connections.table.flags' => 'Bandila',
    'firewall.connections.table.protocol' => 'Protokol',
    'firewall.connections.table.src_address' => 'Gikan nga Address',
    'firewall.connections.table.src_port' => 'Gikan nga Port',
    'firewall.connections.table.dst_address' => 'Padulngan nga Address',
    'firewall.connections.table.dst_port' => 'Padulngan nga Port',
    'firewall.connections.table.conn_mark' => 'Marka sa Koneksyon',
    ...
    'hotspot.table.th.address'=> 'Adres',
    'hotspot.table.th.mac'=> 'Adres sa MAC',
    'hotspot.table.th.profile'=> 'Profil',
    'hotspot.table.th.uptime'=> 'Oras sa Pagdagan',
    ...
    'admin.title' => 'Panel sa Admin',
    'admin.desc' => 'Sentro sa Kontrol sa Misyon',
    'admin.maintenance' => 'Pagmintinar',
    ...
    'admin.logs.title' => 'Mga Log sa Access sa Admin',
    'admin.save' => 'I-save',
    'admin.saved' => 'Nasulod',
    ...
    'maintenance.toast' => 'Mode sa Pagmintinar' . '<br/><br/>' . 'Ang mga function limitado samtang naka-enable ang maintenance mode.',
    ...
    'hotspot.users.badge_disabled' => 'Gi-disable',
    ...
    'hotspot.modal.form.server'=> 'Server sa Hotspot',
    ...
    'hotspot.modal.form.password'=> 'Kontrasena',
    ...
    'hotspot.modal.form.user-profile'=> 'Profile sa Tiggamit',
    'hotspot.modal.form.comment'=> 'Komento',
    'hotspot.modal.form.optional-comment'=> 'Opsyonal nga Komento',
    'hotspot.modal.form.mac-address'=>  'Adres sa MAC',
    ...
    'hotspot.modal.form.stats.uptime'=> 'Oras sa Pagdagan',
    ...
    'hotspot.modal.form.stats.user-code'=> 'Code sa Tiggamit',
    ...
    'hotspot.user.profiles.th.rate-limit'=> 'Limit sa Rate',
    'hotspot.user.profiles.th.idle-timeout'=> 'Timeout sa Idle',
    'hotspot.user.profiles.th.keepalive-timeout'=> 'Timeout sa Keepalive',
    ...
    'hotspot.user.profiles.form.rate-limit-rx'=> 'Limit sa Rate (RX)',
    'hotspot.user.profiles.form.rate-limit-tx'=> 'Limit sa Rate (TX)',
    ...
    'hotspot.user.profiles.form.parent-queue'=> 'Ginikanan nga Queue',
    ...
    'hotspot.export.user.password'=> 'Kontrasena',
    ...
    'settings.identity'=> 'Pag-ila',
    'settings.ntp'=> 'NTP',
    'settings.files'=> 'Mga File',
    'settings.users'=> 'Mga Tiggamit',
    'settings.scheduler'=> 'Iskedyul',
    'settings.scripts'=> 'Mga Script',
    'settings.reset'=> 'Pag-reset',
    'settings.reboot'=> 'Pag-reboot',
    'settings.shutdown'=> 'Pag-shutdown',

    // Settings Page Buttons
    //'settings.open.identity'=> 'Ablihi ang Pag-ila',
    //'settings.open.ntp'=> 'Ablihi ang NTP',
    'settings.open.files'=> 'Ablihi ang Mga File',
    'settings.open.users'=> 'Dumala ang Mga Tiggamit',
    'settings.open.scheduler'=> 'Ablihi ang Iskedyul',
    'settings.open.scripts'=> 'Ablihi ang Mga Script',
    //'settings.open.reset'=> 'Pag-reset',
    //'settings.open.reboot'=> 'Pag-reboot',
    //'settings.open.shutdown'=> 'Pag-shutdown',
    ...
    'settings.identity.save'=> 'I-save ang Pag-ila',
    ...
    'settings.ntp.server'=> 'Mga NTP Server',
    ...
    'settings.ntp.status'=> 'Kahimtang',
    'settings.ntp.freq.drift'=> 'Pag-usab sa Frequency',
    'settings.ntp.synced.server'=> 'Naka-sync nga Server',
    'settings.ntp.synced.stratum'=> 'Naka-sync nga Stratum',
    'settings.ntp.system.offset'=> 'Offset sa Sistema',
    ...
    'settings.scheduler.title'=> 'Iskedyul',
    ...
    'queues.desc'=> 'Dumala ang yano nga queues, queue tree ug mga tipo sa queue.',

    'queues.simple'=> 'Yano',
    'queues.tree'=> 'Punoan',
    'queues.types'=> 'Mga Tipo',
    'queues.simple-queue'=> 'Yano nga Queue',
    'queues.queue-tree'=> 'Punoan nga Queue',
    'queues.queue-types'=> 'Mga Tipo sa Queue',
    ...
    // Queues Page Buttons
    'queues.open.simple'=> 'Ablihi ang Yano nga Queue',
    'queues.open.tree'=> 'Ablihi ang Punoan nga Queue',
    'queues.open.types'=> 'Ablihi ang Mga Tipo sa Queue',
    ...
    'queues.table.th.target'=> 'Tinutokan',
    'queues.table.th.upload-limit'=> 'Limit sa Upload',
    'queues.table.th.download-limit'=> 'Limit sa Download',
    'queues.table.th.download-avg-rate'=> 'Average nga Rate sa Download',
    'queues.table.th.max-limit'=> 'Pinakataas nga Limit',
    'queues.table.th.queue-type'=> 'Mga Tipo sa Queue',
    'queues.table.th.limit-at'=> 'Limit Sa',
    'queues.table.th.bytes'=> 'Mga Byte',
    'queues.table.th.avg.rate'=> 'Average nga Rate',
    'queues.table.th.kind'=> 'Klase',

    // Queues Modal Form - Tabs
    'queues.tab.main'=> 'Panguna',
    'queues.tab.advanced'=> 'Abante',
    ...
    'queues.modal.form.target'=> 'Tinutokan',
    'queues.modal.form.target-select-iface'=> 'Pili-a ang Interface',
    'queues.modal.form.dst'=> 'Padulngan',
    ...
    'queues.modal.form.target.upload'=> 'Target sa Upload',
    'queues.modal.form.max-limit'=> 'Pinakataas nga Limit',
    'queues.modal.form.target.download'=> 'Target sa Download',
    'queues.modal.form.pkt-marks'=> 'Mga Marka sa Packet',
    'queues.modal.form.limit-at'=> 'Limit Sa',
    'queues.modal.form.burst-limit'=> 'Limit sa Burst',
    'queues.modal.form.burst-threshold'=> 'Threshold sa Burst',
    'queues.modal.form.burst-time'=> 'Oras sa Burst',
    'queues.modal.form.priority'=> 'Prayoridad',
    'queues.modal.form.bucket-size'=> 'Gidak-on sa Bucket',
    'queues.modal.form.parent-queue'=> 'Ginikanan nga Queue',
    ...
    'queue.tree.tab.rate-limit'=> 'Limit sa Rate',
    ...
    'ppp.table.th.iface'=> 'Interfas',
    'ppp.table.th.keepalive'=> 'Timeout sa Keepalive',
    'ppp.table.th.profile'=> 'Profil',
    'ppp.table.th.one-session-host'=> 'Usa ka Sesyon sa Host',
    'ppp.table.th.authentication'=> 'Pagpamatuod',
    'ppp.table.th.name'=> 'Ngalan',
    'ppp.table.th.password'=> 'Kontrasena',
    'ppp.table.th.service'=> 'Serbisyo',
    'ppp.table.th.address'=> 'Adres',
    'ppp.table.th.caller-id'=> 'ID sa Tawag',
    ...
    'ppp.table.th.last-called-id'=> 'Katapusan nga Called ID',
    'ppp.table.th.rate-limit'=> 'Limit sa Rate',
    'ppp.table.th.only-one'=> 'Usa Lang',
    'ppp.table.th.uptime'=> 'Oras sa Pagdagan',
    ...
    'ppp.modal.form.one-session-per-host'=> 'Usa ka Sesyon kada Host',
    'ppp.modal.form.accept-empty-services'=> 'Dawata ang Walay Serbisyo',
    'ppp.modal.form.accept-untagged'=> 'Dawata ang Walay Tag',
    'ppp.modal.form.service-name'=> 'Ngalan sa Serbisyo',
    'ppp.modal.form.service-name_placeholder'=> 'Ngalan sa PPPoE',
    'ppp.modal.form.interface'=> 'Interfas',
    'ppp.modal.form.placeholder'=> 'Default nga Setting',
    'ppp.modal.form.max-mtu'=> 'Max MTU',
    'ppp.modal.form.max-mru'=> 'Max MRU',
    'ppp.modal.form.mrru'=> 'MRRU',
    'ppp.modal.form.keepalive-timeout'=> 'Timeout sa Keepalive',
    'ppp.modal.form.profile'=> 'Profil',
    'ppp.modal.form.max-sessions'=> 'Pinakataas nga Sesyon',
    'ppp.modal.form.auth-methods'=> 'Mga Pamaagi sa Pagpamatuod',
    ...
    'ppp.modal.form.secret.password'=> 'Kontrasena',
    ...
    'ppp.profiles.tab.protocols'=> 'Mga Protokol',
    ...
    'ppp.modal.form.profile.sess-timeout'=> 'Timeout sa Sesyon',
    'ppp.modal.form.profile.idle-timeout'=> 'Timeout sa Idle',
    'ppp.modal.form.profile.rate-limit'=> 'Limit sa Rate',
    'ppp.modal.form.profile.only-one'=> 'Usa Lang',
    'ppp.modal.form.profile.parent-queue'=> 'Ginikanan nga Queue',
    'ppp.modal.form.profile.queue-type-rx'=> 'Klase sa Queue (Pag-download)',
    'ppp.modal.form.profile.queue-type-tx'=> 'Klase sa Queue (Pag-upload)',
    'ppp.modal.form.profile.script-onup'=> 'Sa Pag-activate',
    'ppp.modal.form.profile.script-ondown'=> 'Sa Pag-disconnect',
    ...
    'ip.arp'=> 'ARP',
    'ip.addresses'=> 'Mga Adres',
    'ip.cloud'=> 'Ulap',
    'ip.dhcp.client'=> 'Kliyente sa DHCP',
    'ip.dhcp.server'=> 'Server sa DHCP',
    'ip.dns'=> 'DNS',
    'ip.pool'=> 'Pundok',
    ...
    'ip.open.addresses'=> 'Ablihi ang Mga Adres',
    'ip.open.cloud'=> 'Ablihi ang Ulap',
    'ip.open.dhcp.client'=> 'Ablihi ang Kliyente sa DHCP',
    'ip.open.dhcp.server'=> 'Ablihi ang Server sa DHCP',
    ...
    // IP Table Headers
    'ip.table.th.address'=> 'Adres',
    'ip.table.th.network'=> 'Networka',
    'ip.table.th.iface'=> 'Interfas',
    ...
    'ip.modal.form.ip.address-mask'=> 'Adres IP / Mask',
    'ip.modal.form.ip.network'=> 'Networka',
    'ip.modal.form.iface'=> 'Interfas',
    ...
    'ip.cloud.public.ipv4'=> 'Publiko nga IPv4',
    'ip.cloud.public.ipv6'=> 'Publiko nga IPv6',
    ...
    // dhcp-client.php
    // IP DHCP Client Page
    'ip.dhcp.client.options'=> 'Kliyente sa DHCP',
    'ip.dhcp.client.modal.form.interface'=> 'Interfas',
    ...
    'ip.dns.form.dynamic-servers'=> 'Dynamic nga Server',
    'ip.dns.form.use.doh.servers'=> 'Gamiton ang DoH Servers',
    'ip.dns.form.doh.max.server.conn'=> 'DoH Max nga Koneksyon sa Server',
    'ip.dns.form.doh.max.concurrent.queries'=> 'DoH Max nga Dungan nga Query',
    ...
    'ip.dns.form.max.concurrent.queries'=> 'Max nga Dungan nga Query',
    'ip.dns.form.max.concurrent.tcp'=> 'Max nga Dungan nga TCP Connection',
    ...
    // IP DNS - Static DNS
    'ip.dns.static'=> 'Static nga DNS',
    'ip.dns.static.desc'=> 'Dumala ang mga static DNS entry nga mopuli sa dynamic DNS resolution.',
    ...
    'ip.pool.modal.form.ranges'=> 'Mga Sakop sa Adres',
    ...
    'ip.services.table.th.port'=> 'Numero sa Port',
    'ip.services.table.th.available-from'=> 'Magamit Gikan Sa',
    'ip.services.table.th.max-sessions'=> 'Pinakataas nga Sesyon',
    'ip.services.table.th.protocol'=> 'Protokol',
    'ip.services.table.th.remote'=> 'Layo',
    ...
    'ip.settings.modal.form.ip-tcp-timestamps'=> 'Timestamp sa TCP',
    'ip.settings.modal.form.ip-max-neighbors'=> 'Pinakataas nga Silingan',
    'ip.settings.modal.form.ip-icmp-rate-limit'=> 'Limit sa ICMP Rate',
