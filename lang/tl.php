...
return [
    ...
    'login.form.requirements_check' => 'May problema sa pag-login? Tingnan ang %s.',
    'login.form.requirements_link_text' => 'ang mga kinakailangan',
 ...
 // Login Page Messages
    ...
    'firewall.desc' => 'Pamahalaan ang mga panuntunan ng firewall, NAT, mangle, at mga kasangkapan sa inspeksyon ng trapiko.',
    'firewall.filter' => 'Mga Panuntunan sa Pag-filter',
    'firewall.nat' => 'NAT',
    'firewall.mangle' => 'Mangle',
    'firewall.raw' => 'Raw',
    'firewall.connections' => 'Mga Koneksyon',
    'firewall.address' => 'Mga Listahan ng Address',
    'firewall.layer7' => 'Mga Protokol ng Layer7',
    'firewall.filter.desc' => 'Gumawa at ayusin ang mga panuntunan sa pag-filter ng packet para sa kontrol ng trapiko.',
    'firewall.filter.actions' => 'Mga Aksyon',
    'firewall.filter.new' => 'Bago',
    'firewall.filter.edit' => 'I-edit',
    'firewall.filter.enable' => 'Paganahin',
    'firewall.filter.disable' => 'Huwag paganahin',
    'firewall.filter.remove' => 'Alisin',
    'firewall.filter.sort.by' => 'Ayusin ayon sa',
    'firewall.filter.sort' => 'Ayusin',
    'firewall.filter.prev' => 'Nakaraan',
    'firewall.filter.next' => 'Susunod',
    'firewall.filter.loading' => 'Naglo-load...',
    'firewall.filter.none' => 'Walang nahanap na entry',
    'firewall.filter.failed_to_load' => 'Nabigong mag-load',
    'firewall.filter.confirm_remove' => 'Alisin ang mga napiling item?',
    'firewall.filter.confirm_title' => 'Kumpirmahin',
    'firewall.filter.enable_success' => 'Pinagana',
    'firewall.filter.disable_success' => 'Hindi pinagana',
    'firewall.filter.remove_success' => 'Inalis',
    'firewall.filter.action_failed' => 'Nabigo ang aksyon: %s',
    'firewall.filter.action_failed_short' => 'Nabigo ang aksyon',
    'firewall.filter.not_implemented' => 'Hindi pa naipapatupad',
    'firewall.filter.badge_disabled' => 'Hindi pinagana',
    'firewall.filter.badge_dynamic' => 'Dinamik',
    'firewall.filter.badge_invalid' => 'Hindi wasto',
    'firewall.filter.table.select' => 'Piliin',
    ...
    'firewall.filter.table.src_address' => 'Address ng Pinagmulan',
    'firewall.filter.table.dst_address' => 'Address ng Patutunguhan',
    'firewall.filter.table.protocol' => 'Protokol',
    'firewall.filter.table.src_port' => 'Port ng Pinagmulan',
    'firewall.filter.table.dst_port' => 'Port ng Patutunguhan',
    'firewall.filter.table.in_interface' => 'Interface ng Papasok',
    'firewall.filter.table.out_interface' => 'Interface ng Palabas',
    'firewall.filter.table.src_address_list' => 'Listahan ng Address ng Pinagmulan',
    'firewall.filter.table.dst_address_list' => 'Listahan ng Address ng Patutunguhan',
    'firewall.filter.table.bytes' => 'Bytes',
    'firewall.filter.table.packets' => 'Packets',
    'firewall.nat.desc' => 'I-configure ang mga patakaran ng NAT para sa pinagmulan at patutunguhan ng iyong network.',
    'firewall.nat.actions' => 'Mga Aksyon',
    'firewall.nat.new' => 'Bago',
    'firewall.nat.edit' => 'I-edit',
    'firewall.nat.enable' => 'Paganahin',
    'firewall.nat.disable' => 'Huwag paganahin',
    'firewall.nat.remove' => 'Alisin',
    'firewall.nat.sort.by' => 'Ayusin ayon sa',
    'firewall.nat.sort' => 'Ayusin',
    'firewall.nat.prev' => 'Nakaraan',
    'firewall.nat.next' => 'Susunod',
    'firewall.nat.loading' => 'Naglo-load...',
    'firewall.nat.none' => 'Walang nahanap na entry',
    'firewall.nat.failed_to_load' => 'Nabigong mag-load',
    'firewall.nat.confirm_remove' => 'Alisin ang mga napiling item?',
    'firewall.nat.confirm_title' => 'Kumpirmahin',
    'firewall.nat.enable_success' => 'Pinagana',
    'firewall.nat.disable_success' => 'Hindi pinagana',
    'firewall.nat.remove_success' => 'Inalis',
    'firewall.nat.action_failed' => 'Nabigo ang aksyon: %s',
    'firewall.nat.action_failed_short' => 'Nabigo ang aksyon',
    'firewall.nat.not_implemented' => 'Hindi pa naipapatupad',
    'firewall.nat.badge_disabled' => 'Hindi pinagana',
    'firewall.nat.badge_dynamic' => 'Dinamik',
    'firewall.nat.badge_invalid' => 'Hindi wasto',
    'firewall.nat.table.select' => 'Piliin',
    'firewall.nat.table.number' => '#',
    'firewall.nat.table.flag' => 'Flag',
    'firewall.nat.table.action' => 'Aksyon',
    'firewall.nat.table.chain' => 'Chain',
    'firewall.nat.table.src_address' => 'Address ng Pinagmulan',
    'firewall.nat.table.dst_address' => 'Address ng Patutunguhan',
    'firewall.nat.table.protocol' => 'Protokol',
    'firewall.nat.table.src_port' => 'Port ng Pinagmulan',
    'firewall.nat.table.dst_port' => 'Port ng Patutunguhan',
    'firewall.nat.table.in_interface' => 'Interface ng Papasok',
    'firewall.nat.table.out_interface' => 'Interface ng Palabas',
    'firewall.nat.table.bytes' => 'Bytes',
    'firewall.nat.table.packets' => 'Packets',
    'firewall.mangle.desc' => 'Markahan ang mga packet at koneksyon para sa advanced routing at QoS.',
    'firewall.mangle.actions' => 'Mga Aksyon',
    'firewall.mangle.new' => 'Bago',
    'firewall.mangle.edit' => 'I-edit',
    'firewall.mangle.enable' => 'Paganahin',
    'firewall.mangle.disable' => 'Huwag paganahin',
    'firewall.mangle.remove' => 'Alisin',
    'firewall.mangle.sort.by' => 'Ayusin ayon sa',
    'firewall.mangle.sort' => 'Ayusin',
    'firewall.mangle.prev' => 'Nakaraan',
    'firewall.mangle.next' => 'Susunod',
    'firewall.mangle.loading' => 'Naglo-load...',
    'firewall.mangle.none' => 'Walang nahanap na entry',
    'firewall.mangle.failed_to_load' => 'Nabigong mag-load',
    'firewall.mangle.confirm_remove' => 'Alisin ang mga napiling item?',
    'firewall.mangle.confirm_title' => 'Kumpirmahin',
    'firewall.mangle.enable_success' => 'Pinagana',
    'firewall.mangle.disable_success' => 'Hindi pinagana',
    'firewall.mangle.remove_success' => 'Inalis',
    'firewall.mangle.action_failed' => 'Nabigo ang aksyon: %s',
    'firewall.mangle.action_failed_short' => 'Nabigo ang aksyon',
    'firewall.mangle.not_implemented' => 'Hindi pa naipapatupad',
    'firewall.mangle.badge_disabled' => 'Hindi pinagana',
    'firewall.mangle.badge_dynamic' => 'Dinamik',
    'firewall.mangle.badge_invalid' => 'Hindi wasto',
    'firewall.mangle.table.select' => 'Piliin',
    ...
    'firewall.mangle.table.src_address' => 'Address ng Pinagmulan',
    'firewall.mangle.table.dst_address' => 'Address ng Patutunguhan',
    'firewall.mangle.table.src_address_list' => 'Listahan ng Address ng Pinagmulan',
    'firewall.mangle.table.dst_address_list' => 'Listahan ng Address ng Patutunguhan',
    'firewall.mangle.table.protocol' => 'Protokol',
    'firewall.mangle.table.src_port' => 'Port ng Pinagmulan',
    'firewall.mangle.table.dst_port' => 'Port ng Patutunguhan',
    'firewall.mangle.table.in_interface' => 'Interface ng Papasok',
    'firewall.mangle.table.out_interface' => 'Interface ng Palabas',
    'firewall.raw.desc' => 'Ilapat ang raw prerouting filters bago ang connection tracking.',
    'firewall.raw.actions' => 'Mga Aksyon',
    'firewall.raw.new' => 'Bago',
    'firewall.raw.edit' => 'I-edit',
    'firewall.raw.enable' => 'Paganahin',
    'firewall.raw.disable' => 'Huwag paganahin',
    'firewall.raw.remove' => 'Alisin',
    'firewall.raw.sort.by' => 'Ayusin ayon sa',
    'firewall.raw.sort' => 'Ayusin',
    'firewall.raw.prev' => 'Nakaraan',
    'firewall.raw.next' => 'Susunod',
    'firewall.raw.loading' => 'Naglo-load...',
    'firewall.raw.none' => 'Walang nahanap na entry',
    'firewall.raw.failed_to_load' => 'Nabigong mag-load',
    'firewall.raw.confirm_remove' => 'Alisin ang mga napiling item?',
    'firewall.raw.confirm_title' => 'Kumpirmahin',
    'firewall.raw.enable_success' => 'Pinagana',
    'firewall.raw.disable_success' => 'Hindi pinagana',
    'firewall.raw.remove_success' => 'Inalis',
    'firewall.raw.action_failed' => 'Nabigo ang aksyon: %s',
    'firewall.raw.action_failed_short' => 'Nabigo ang aksyon',
    'firewall.raw.not_implemented' => 'Hindi pa naipapatupad',
    'firewall.raw.badge_disabled' => 'Hindi pinagana',
    'firewall.raw.badge_dynamic' => 'Dinamik',
    'firewall.raw.badge_invalid' => 'Hindi wasto',
    'firewall.raw.table.select' => 'Piliin',
    'firewall.raw.table.flag' => 'Flag',
    'firewall.raw.table.action' => 'Aksyon',
    'firewall.raw.table.chain' => 'Chain',
    'firewall.raw.table.src_address' => 'Address ng Pinagmulan',
    'firewall.raw.table.dst_address' => 'Address ng Patutunguhan',
    'firewall.raw.table.src_address_list' => 'Listahan ng Address ng Pinagmulan',
    'firewall.raw.table.dst_address_list' => 'Listahan ng Address ng Patutunguhan',
    'firewall.raw.table.protocol' => 'Protokol',
    'firewall.connections.desc' => 'Siyasatin ang kasalukuyang firewall connection tracking entries.',
    'firewall.address.desc' => 'Panatilihin ang mga listahan ng address na maaaring gamitin muli para sa pagtutugma ng mga rule.',
    'firewall.address.actions' => 'Mga Aksyon',
    'firewall.address.new' => 'Bago',
    'firewall.address.enable' => 'Paganahin',
    'firewall.address.disable' => 'Huwag paganahin',
    'firewall.address.remove' => 'Alisin',
    'firewall.address.refresh' => 'I-refresh',
    'firewall.address.sort.by' => 'Ayusin ayon sa',
    'firewall.address.sort' => 'Ayusin',
    'firewall.address.prev' => 'Nakaraan',
    'firewall.address.next' => 'Susunod',
    'firewall.address.loading' => 'Naglo-load...',
    'firewall.address.none' => 'Walang nahanap na entry',
    'firewall.address.failed_to_load' => 'Nabigong mag-load',
    'firewall.address.confirm_remove' => 'Alisin ang mga napiling item?',
    'firewall.address.confirm_title' => 'Kumpirmahin',
    'firewall.address.enable_success' => 'Pinagana',
    'firewall.address.disable_success' => 'Hindi pinagana',
    'firewall.address.remove_success' => 'Inalis',
    'firewall.address.action_failed' => 'Nabigo ang aksyon: %s',
    'firewall.address.action_failed_short' => 'Nabigo ang aksyon',
    'firewall.address.not_implemented' => 'Hindi pa naipapatupad',
    'firewall.address.table.select' => 'Piliin',
    'firewall.address.table.list' => 'Listahan',
    'firewall.address.table.address' => 'Address',
    'firewall.address.table.time' => 'Oras',
    'firewall.address.table.creation' => 'Paglikha',
    'firewall.address.edit' => 'I-edit',
    'firewall.address.modal.title_new' => 'Magdagdag ng Listahan ng Address',
    'firewall.address.modal.title_edit' => 'I-edit ang Listahan ng Address',
    'firewall.address.modal.enabled' => 'Pinagana',
    'firewall.address.modal.list' => 'Listahan',
    'firewall.address.modal.list_placeholder' => 'Ilagay ang pangalan ng listahan',
    'firewall.address.modal.list_select_placeholder' => 'Pumili ng umiiral na listahan ng address',
    'firewall.address.modal.address' => 'Address',
    'firewall.address.modal.timeout' => 'Timeout',
    'firewall.address.modal.creation' => 'Oras ng Paglikha',
    'firewall.address.modal.comment' => 'Komento',
    'firewall.address.modal.cancel' => 'Kanselahin',
    'firewall.address.modal.create' => 'Gumawa',
    'firewall.address.modal.update' => 'I-update',
    'firewall.address.modal.list_required' => 'Kinakailangan ang listahan',
    'firewall.address.modal.address_required' => 'Kinakailangan ang address',
    'firewall.address.modal.add_success' => 'Nagawa ang listahan ng address',
    'firewall.address.modal.update_success' => 'Na-update ang listahan ng address',
    'firewall.address.modal.save_failed' => 'Nabigong i-save: %s',
    'firewall.address.modal.request_failed' => 'Nabigo ang kahilingan',
    'firewall.address.modal.creation_auto' => 'Awtomatikong itatakda',
    'firewall.layer7.desc' => 'Pamahalaan ang mga pattern ng Layer7 protocol para sa deep packet inspection.',
    'firewall.layer7.actions' => 'Mga Aksyon',
    'firewall.layer7.new' => 'Bago',
    'firewall.layer7.edit' => 'I-edit',
    'firewall.layer7.remove' => 'Alisin',
    'firewall.layer7.sort.by' => 'Ayusin ayon sa',
    'firewall.layer7.sort' => 'Ayusin',
    'firewall.layer7.prev' => 'Nakaraan',
    'firewall.layer7.next' => 'Susunod',
    'firewall.layer7.loading' => 'Naglo-load...',
    'firewall.layer7.none' => 'Walang nahanap na entry',
    'firewall.layer7.failed_to_load' => 'Nabigong mag-load',
    'firewall.layer7.confirm_remove' => 'Alisin ang mga napiling item?',
    'firewall.layer7.confirm_title' => 'Kumpirmahin',
    'firewall.layer7.remove_success' => 'Inalis',
    'firewall.layer7.remove_failed' => 'Nabigong alisin: %s',
    'firewall.layer7.remove_failed_short' => 'Nabigong alisin',
    'firewall.layer7.not_implemented' => 'Hindi pa naipapatupad',
    'firewall.layer7.table.select' => 'Piliin',
    'firewall.layer7.table.name' => 'Pangalan',
    'firewall.layer7.table.regexp' => 'Regexp',
    'firewall.layer7.modal.title_new' => 'Magdagdag ng Layer7 Protocol',
    'firewall.layer7.modal.title_edit' => 'I-edit ang Layer7 Protocol',
    'firewall.layer7.modal.name' => 'Pangalan',
    'firewall.layer7.modal.regexp' => 'Regexp',
    'firewall.layer7.modal.comment' => 'Komento',
    'firewall.layer7.modal.cancel' => 'Kanselahin',
    'firewall.layer7.modal.create' => 'Gumawa',
    'firewall.layer7.modal.update' => 'I-update',
    'firewall.layer7.modal.name_required' => 'Kinakailangan ang pangalan',
    'firewall.layer7.modal.regexp_required' => 'Kinakailangan ang regexp',
    'firewall.layer7.modal.add_success' => 'Nagawa ang Layer7 protocol',
    'firewall.layer7.modal.update_success' => 'Na-update ang Layer7 protocol',
    'firewall.layer7.modal.save_failed' => 'Nabigong i-save: %s',
    'firewall.layer7.modal.request_failed' => 'Nabigo ang kahilingan',
    'firewall.open.filter' => 'Buksan ang Mga Panuntunan sa Pag-filter',
    'firewall.open.nat' => 'Buksan ang NAT',
    'firewall.open.mangle' => 'Buksan ang Mangle',
    'firewall.open.raw' => 'Buksan ang Raw',
    'firewall.open.connections' => 'Buksan ang Mga Koneksyon',
    'firewall.open.address' => 'Buksan ang Mga Listahan ng Address',
    'firewall.open.layer7' => 'Buksan ang Mga Protokol ng Layer7',
    'firewall.back-to-firewall' => 'Bumalik sa Firewall',
    'firewall.connections.actions' => 'Mga Aksyon',
    'firewall.connections.remove' => 'Alisin',
    'firewall.connections.refresh' => 'I-refresh',
    'firewall.connections.sort.by' => 'Ayusin ayon sa',
    'firewall.connections.sort' => 'Ayusin',
    'firewall.connections.prev' => 'Nakaraan',
    'firewall.connections.next' => 'Susunod',
    'firewall.connections.loading' => 'Naglo-load ng mga koneksyon...',
    'firewall.connections.none' => 'Walang nahanap na koneksyon',
    'firewall.connections.failed_to_load' => 'Nabigong mag-load',
    'firewall.connections.confirm_remove' => 'Alisin ang mga napiling koneksyon?',
    'firewall.connections.confirm_title' => 'Kumpirmahin',
    'firewall.connections.remove_success' => 'Inalis ang mga koneksyon',
    'firewall.connections.remove_failed' => 'Nabigong alisin: %s',
    'firewall.connections.remove_failed_short' => 'Nabigong alisin',
    'firewall.connections.table.select' => 'Piliin',
    'firewall.connections.table.flags' => 'Mga Flag',
    'firewall.connections.table.protocol' => 'Protokol',
    'firewall.connections.table.src_address' => 'Address ng Pinagmulan',
    'firewall.connections.table.src_port' => 'Port ng Pinagmulan',
    'firewall.connections.table.dst_address' => 'Address ng Patutunguhan',
    'firewall.connections.table.dst_port' => 'Port ng Patutunguhan',
    'firewall.connections.table.conn_mark' => 'Marka ng Koneksyon',
