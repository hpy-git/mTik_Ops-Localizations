<?php
////////////////////////////////////////////////////////////////////////
// Indonesian language translations for mTik_Ops                           
// Author: HPY™                                                         
...
return [
    ...
    'about.title' => 'Dibuat untuk MikroTik',
    'about.desc' => 'mTikOps adalah platform berbasis browser untuk mengelola router dan hotspot MikroTik. Ini mencakup akses jarak jauh, manajemen hotspot - pencetakan, PPPoE, dan lainnya. Semua dalam satu sistem yang cepat.',
    ...
    'features.remote.desc' => 'Pantau dan kelola router jarak jauh, lihat status antarmuka, lakukan reboot, dan terapkan perubahan konfigurasi secara aman di seluruh armada Anda dari satu konsol.',
    'features.hotspot.title' => 'Manajemen Hotspot',
    'features.hotspot.desc' => 'Buat dan kelola server hotspot serta profil pengguna, keluarkan voucher, pantau pengguna dan sesi aktif, serta lakukan akuntansi dan pelaporan.',
    'features.troubleshoot.title' => 'Pemecahan Masalah dan Konfigurasi',
    'features.troubleshoot.desc' => 'Dorong dan audit perubahan konfigurasi, jalankan diagnostik, lihat log secara real-time, dan pecahkan masalah konektivitas dengan alat dan log terintegrasi.',
    // Index Page - Signup Section
    'signup.title' => 'Mulai dengan mTikOps',
    'signup.desc' => 'Buat akun untuk mengelola router, hotspot, dan menjalankan diagnostik di seluruh jaringan Anda dari satu dasbor.',
    'signup.cta' => 'Daftar',
    ...
    // Login Page
    'login.title' => 'Masuk ke mTik_Ops',
    'login.desc' => 'Akses akun mTik_Ops Anda untuk mengelola router dan hotspot MikroTik dari dasbor terpusat.',
    'login.form.title' => 'Masuk ke Akun Anda',
    'login.form.host'=> 'Host',
    'login.form.username'=> 'Nama Pengguna',
    'login.form.password'=> 'Kata Sandi',
    'login.form.connection_type'=> 'Tipe Koneksi',
    ...
    'about-us.overview.desc'=> 'Dapatkan pengenalan singkat tentang mTikOps dan kemampuan utamanya.',
    'about-us.vision.desc'=> 'Pelajari tentang misi kami dan tujuan jangka panjang untuk proyek ini.',
    ...
    'about-us.faqs.desc'=> 'Pertanyaan umum dan jawaban tentang mTikOps.',
    ...
    'about-us.overview-page.desc'=> 'mTikOps adalah platform web ringan untuk mengelola router MikroTik dan layanan hotspot dari browser.',

    // About Us - Vision Page
    'about-us.vision-page.title'=> 'Visi',
    'about-us.vision-page.desc'=> 'Kami bertujuan untuk menyederhanakan operasi jaringan bagi pengguna MikroTik dengan antarmuka manajemen yang intuitif dan alat otomatisasi.',

    // About Us - Features Page
    'about-us.features-page.title'=> 'Fitur',
    'about-us.features-page.desc'=> 'Jelajahi fitur utama mTikOps.',
    // About Us - Tutorials Page
    'about-us.tutorials-page.title'=> 'Tutorial',
    'about-us.tutorials-page.desc'=> 'Panduan dan cara untuk tugas umum.',
    ...
    'about-us.requirements-page.title'=> 'Persyaratan',
    ...
    'our-team.leadership'=> 'Kepemimpinan',
    'our-team.developers'=> 'Pengembang',
    'our-team.contributors'=> 'Kontributor',
    'our-team.advisors'=> 'Penasihat',
    'our-team.careers'=> 'Bergabunglah dengan Kami',
    'our-team.contact'=> 'Kontak',

    // Our Team Page Descriptions
    'our-team.leadership.desc'=> 'Para pengelola inti dan pemimpin proyek yang mendorong mTikOps ke depan.',
    'our-team.developers.desc'=> 'Insinyur dan kontributor yang membangun fitur dan perbaikan.',
    'our-team.contributors.desc'=> 'Kontributor komunitas yang membantu dengan dokumentasi, pengujian, dan kode.',
    'our-team.advisors.desc'=> 'Penasihat dan ahli materi yang mendukung proyek.',
    'our-team.careers.desc'=> 'Peran terbuka dan cara bergabung dengan tim.',
    'our-team.contact.desc'=> 'Hubungi tim untuk pertanyaan atau kolaborasi.',  

    // Our Team Page Buttons
    'our-team.open.leadership'=> 'Lihat Kepemimpinan',
    ...
    'our-team.open.careers'=> 'Bergabunglah dengan Kami',
    ...
    'our-team.leadership-page.desc'=> 'Temui para pengelola inti dan pemimpin proyek di balik mTikOps.',
    // Our Team - Developers Page
    'our-team.developers-page.title'=> 'Pengembang',
    'our-team.developers-page.desc'=> 'Profil dan tanggung jawab para pengembang yang berkontribusi pada mTikOps.',

    // Our Team - Contributors Page
    'our-team.contributors-page.title'=> 'Kontributor',
    'our-team.contributors-page.desc'=> 'Mengakui kontributor komunitas dan cara untuk terlibat.',

    // Our Team - Advisors Page
    'our-team.advisors-page.title'=> 'Penasihat',
    'our-team.advisors-page.desc'=> 'Penasihat dan ahli materi yang mendukung proyek.',

    // Our Team - Join Us Page
    'our-team.join-us-page.title'=> 'Bergabunglah dengan Kami',
    'our-team.join-us-page.desc'=> 'Jelajahi peran terbuka dan cara berkontribusi pada mTikOps.',  
    ...
    'dashboard.monitoring.desc'=> 'Pemantauan waktu nyata kinerja jaringan, waktu aktif, dan status perangkat di seluruh infrastruktur MikroTik Anda.',
    'dashboard.ltmg.title'=> 'Grafik Pemantauan Lalu Lintas Langsung',
    ...
    'dashboard.logging.desc'=> 'Pencatatan dan pemberitahuan terpusat untuk kejadian sistem, kesalahan',
    ...
    'generate.generating' => 'Menghasilkan...',
    'generate.print_fetch_failed' => 'Gagal mengambil cetak: %s',
    'generate.network_not_ok' => 'Respon jaringan tidak oke: %s',
    'generate.generation_failed' => 'Gagal menghasilkan: %s',
    ...
    'generate.failed_clear_cached' => 'Gagal menghapus batch cache',
    'generate.preview_failed' => 'Pratinjau gagal',
    'generate.preview' => 'Pratinjau',
    'generate.unexpected_error' => 'Kesalahan tak terduga: %s',
    'generate.generated' => '%s pengguna dihasilkan',
    'generate.request_failed' => 'Permintaan gagal saat menghasilkan voucher.',
    'generate.generate' => 'Hasilkan',
    ...
    'dashboard.unable_load_active' => 'Tidak dapat memuat sesi aktif',
    'dashboard.unable_load_ppp' => 'Tidak dapat memuat sesi PPP aktif',
    ...
    'hotspot.users.desc'=> 'Buat, edit, dan kelola akun pengguna hotspot individual.',
    ...
    'hotspot.action.button'=> 'Tindakan',
    ...
    'hotspot.table.th.to-address'=> 'Ke Alamat',
    ...
    'hotspot.profiles.no_queues' => '(tidak ada antrean)',
    ...
    'hotspot.modals.create_update_failed' => 'Gagal membuat/memperbarui',
    'hotspot.modals.create_request_failed' => 'Gagal permintaan pembuatan',

    // Users list
    'hotspot.users.no_users' => 'Tidak ada pengguna',
    'hotspot.users.loading' => 'Memuat...',
    'hotspot.users.empty_response' => 'Respons kosong',
    'hotspot.users.failed_to_contact_api' => 'Gagal menghubungi API',
    'hotspot.users.select_one_or_more' => 'Pilih satu atau lebih pengguna.',
    'hotspot.users.remove_confirm' => 'Hapus pengguna yang dipilih? Ini tidak dapat dibatalkan.',
    ...
    'hotspot.modal.form.hotspot-template'=> 'Templat',
    ...
    'hotspot.modal.form.stats.bytes_in'=> 'Bytes Masuk',
    'hotspot.modal.form.stats.bytes_out'=> 'Bytes Keluar',
    'hotspot.modal.form.stats.limit-uptime'=> 'Batas Waktu Aktif',
    'hotspot.modal.form.stats.limit-bytes_total'=> 'Batas Total Bytes',
    'hotspot.modal.form.stats.user-code'=> 'Kode Pengguna',
    'hotspot.modal.form.stats.expire-date'=> 'Tanggal Kadaluarsa',

    // Hotspot Modal Form Misc
    'hotspot.modal.form.loading' => 'Memuat data...',
    // Hotspot Modal Form Buttons
    'hotspot.modal.form.button.generate-print'=> 'Hasilkan & Cetak',
    'hotspot.modal.form.button.generate'=> 'Hasilkan Saja',
    'hotspot.modal.form.button.clear-cached-batch'=> 'Hapus Batch Cache',
    ...
    'hotspot.user.profiles.desc'=> 'Kelola bandwidth, sesi, dan profil batas kecepatan untuk pengguna.',
    ...
    'hotspot.user.profiles.th.rate-limit'=> 'Batas Kecepatan',
    'hotspot.user.profiles.th.idle-timeout'=> 'Waktu Habis Idle',
    'hotspot.user.profiles.th.keepalive-timeout'=> 'Waktu Habis Keepalive',
    ...
    'hotspot.user.profiles.form.expiry-mode_remove_notice'=> 'Hapus dan Pemberitahuan',
    ...
    'hotspot.user.profiles.form.on-login-script'=> 'Script Saat Login',
    'hotspot.user.profiles.form.on-login-script_placeholder'=> 'Optional script to run on login',
    'hotspot.user.profiles.form.on-logout-script'=> 'Script Saat Logout',
    ...
    'hotspot.user.profile.select.profile.desc'=> 'Pilih profil untuk disunting. Setelah pemilihan, editor lengkap akan terbuka.',
    ...
    'hotspot.export.user.desc'=> 'Pilih bidang mana yang akan disertakan dalam ekspor. Hanya pengguna yang terpilih yang akan diekspor.',
    ...
    'hotspot.export.user.column-up'=> 'Naik',
    'hotspot.export.user.column-down'=> 'Turun',
    'hotspot.export.user.column-desc'=> 'Pilih bidang dan gunakan Naik/Turun untuk mengubah urutan kolom.',
    ...
    'hotspot.print.preview.desc'=> 'Pratinjau pengguna yang dipilih sebelum mencetak.',
    ...
    'settings.identity.desc'=> 'Lihat dan edit identitas perangkat serta informasi sistem dasar.',
    'settings.ntp.desc'=> 'Konfigurasikan pengaturan protokol waktu jaringan (NTP) untuk ketepatan waktu.',
    'settings.files.desc'=> 'Kelola berkas dan skrip yang diunggah yang disimpan di perangkat.',
    ...
    'settings.scripts.desc'=> 'Kelola dan jalankan skrip kustom di perangkat.',
    'settings.reset.desc'=> 'Reset konfigurasi ke default. Gunakan dengan hati-hati.',
    'settings.reboot.desc'=> 'Mulai ulang perangkat dari jarak jauh. Pastikan semua perubahan disimpan sebelum reboot.',
    'settings.shutdown.desc'=> 'Matikan perangkat dari jarak jauh dengan aman. Gunakan dengan hati-hati.',

   
    // Settings Page - Identity
    'settings.identity.placeholder'=> 'Masukkan identitas sistem',
    'settings.identity.caption'=> 'Ini adalah nama yang ditampilkan dalam log dan identifikasi jaringan.',
    ...
    'settings.ntp.freq.drift'=> 'Perubahan Frekuensi',
    'settings.ntp.synced.server'=> 'Server Sinkron',
    ...
    'settings.reset.config'=> 'Reset Konfigurasi (pertahankan berkas pengguna)',
    'settings.reset.all'=> 'Reset Pabrik (hapus semua, muat ulang default)',
    'settings.reset.delay'=> 'Penundaan (detik)',
    'settings.reset.delay.desc'=> 'Atur ke 0 untuk melakukan segera saat menggunakan tombol Jadwalkan, atau klik "Reset Sekarang" untuk menjalankan segera.',
    ...
    // Reboot Modal
    'settings.reboot.delay'=> 'Penundaan (detik)',
    'settings.reboot.delay.desc'=> 'Atur ke 0 untuk melakukan reboot segera saat menggunakan tombol Jadwalkan, atau klik "Reboot Sekarang" untuk memaksa reboot segera.',
    ...
    // Shutdown Modal
    'settings.shutdown.delay'=> 'Penundaan (detik)',
    'settings.shutdown.delay.desc'=> 'Atur ke 0 untuk melakukan shutdown segera saat menggunakan tombol Jadwalkan, atau klik "Shutdown Sekarang" untuk memaksa shutdown segera.',
    ...
    'queues.desc'=> 'Kelola Simple queues, Tree queues dan Queue Types.',
    ...
    'queues.simple.desc'=> 'Buat dan kelola konfigurasi sederhana per-host/per-target queues.',
    'queues.tree.desc'=> 'Kelola queue tree hierarkis untuk shaping lalu lintas tingkat lanjut.',
    'queues.types.desc'=> 'Definisikan dan kelola tipe queue serta pengklasifikasi paket.',

    // Queues Page Buttons
    'queues.open.simple'=> 'Buka Simple Queue',
    'queues.open.tree'=> 'Buka Queue Tree',
    'queues.open.types'=> 'Buka Queue Types',

    // Queues Page - Back Button
    'queues.back-to-queues'=> 'Kembali ke Manajer Queues',
    ...
    'queues.status.loading'=> 'Memuat Queues...',
    // simple.php
    // Simple Queues Page
    ...
    'queues.simple.actions.desc'=> 'Lakukan aksi pada queues yang dipilih.',
    ...
    'queues.table.th.download-avg-rate'=> 'Rata-rata Unduh',
    'queues.table.th.max-limit'=> 'Batas Maksimum',
    'queues.table.th.queue-type'=> 'Tipe Queue',
    'queues.table.th.limit-at'=> 'Batas Pada',
    'queues.table.th.bytes'=> 'Bytes',
    'queues.table.th.avg.rate'=> 'Rata-rata',
    'queues.table.th.kind'=> 'Jenis',

    // Queues Modal Form - Tabs
    'queues.tab.main'=> 'Utama',
    'queues.tab.advanced'=> 'Lanjutan',
    'queues.tab.queueing'=> 'Pengantrean',

    // Queues Modal Form Tab
    'queues.modal.form.new.simple'=> 'Antrian Sederhana Baru',
    'queue.modal.form.edit.simple'=> 'Edit Antrian Sederhana',
    'queues.modal.form.enabled'=> 'Aktif',
    ...
    'queues.modal.form.target.dst-caption'=> 'Pilih antarmuka atau masukkan target kustom di bawah.',
    'queues.modal.form.placeholder'=> 'atau masukkan IP (misal 192.168.10.0/24 atau 10.0.0.5)',
    'queues.modal.form.target.upload'=> 'Target Unggah',
    'queues.modal.form.max-limit'=> 'Batas Maksimum',
    'queues.modal.form.target.download'=> 'Target Unduh',
    'queues.modal.form.pkt-marks'=> 'Tanda Paket',
    'queues.modal.form.limit-at'=> 'Batas Pada',
    'queues.modal.form.burst-limit'=> 'Batas Ledakan',
    'queues.modal.form.burst-threshold'=> 'Ambang Ledakan',
    'queues.modal.form.burst-time'=> 'Waktu Ledakan',
    'queues.modal.form.priority'=> 'Prioritas',
    'queues.modal.form.bucket-size'=> 'Ukuran Ember',
    ...
    'queues.modal.form.clear-parent'=> 'Hapus induk (hapus hubungan induk-anak)',
    ...
    'queues.tree.action.desc'=> 'Lakukan aksi pada entri pohon antrian yang dipilih.',

    // Queue Tree Modal Form - Tabs
    'queues.tree.create.title'=> 'Buat Entri Pohon Antrian',
    'queue.tree.tab.general'=> 'Umum',
    'queue.tree.tab.rate-limit'=> 'Batas Kecepatan',
    ...
    'ppp.desc'=> 'Kelola PPPoE Servers, Secrets dan Profiles.',
    ...
    'ppp.servers.desc'=> 'Lihat dan kelola instance dan binding server PPPoE.',
    ...
    'ppp.table.th.keepalive'=> 'Batas Waktu Tetap Aktif',
    'ppp.table.th.profile'=> 'Profil',
    'ppp.table.th.one-session-host'=> 'Satu Sesi Host',
    'ppp.table.th.authentication'=> 'Autentikasi',
    ...
    'ppp.table.th.last-disc-reason'=> 'Alasan Terakhir Diskoneksi',
    ...
    'ppp.modal.form.keepalive-timeout'=> 'Batas Waktu Tetap Aktif',
    'ppp.modal.form.profile'=> 'Profil',
    'ppp.modal.form.max-sessions'=> 'Max Sessions',
    'ppp.modal.form.auth-methods'=> 'Metode Autentikasi',
    ...
    // secrets.php
    // Modal Titles
    'ppp.modal.form.add.ppp-secret'=> 'Tambah Rahasia PPPoE',
    ...
    'ppp.modal.form.edit.ppp-profile'=> 'Edit Profil PPPoE',
    ...
    'ppp.modal.form.profile.remote-address'=> 'Alamat Jarak Jauh',
    ...
    'ppp.modal.form.profile.idle-timeout'=> 'Batas Waktu Menganggur',
    ...
    'ppp.modal.form.profile.script-placeholder'=> 'Skrip akan dieksekusi ketika suatu peristiwa dipicu.',
    'ppp.modal.form.migration.confirm'=> 'Konfirmasi Migrasi Profil',
    'ppp.modal.form.migration.caption'=> 'Membersihkan Antrian Induk atau Tipe Antrian untuk profil ini mungkin memerlukan pembuatan ulang profil dan penugasan ulang rahasia PPP terkait. Operasi ini berpotensi mengganggu. Apakah Anda ingin melanjutkan?',

    // ip.php
    // IP Page
    'ip.title'=> 'Manajer IP',
    'ip.desc'=> 'Kelola ARP, Alamat IP, DHCP, DNS, Pool IP, dan layanan IP terkait.',
    ...
    'ip.dhcp.server.desc'=> 'Konfigurasi server DHCP dan sewaannya.',
    'ip.dns.desc'=> 'Kelola pengaturan DNS dan entri statis.',
    'ip.pool.desc'=> 'Kelola pool alamat untuk DHCP dan layanan lainnya.',
    ...
    'ip.settings.desc'=> 'Pengaturan umum subsistem IP.',
    ...
    'ip.addresses.please_select_one_or_more' => 'Silakan pilih satu atau lebih entri',
    'ip.addresses.select_one_to_edit' => 'Pilih tepat satu alamat untuk diedit',
    ...
    'ip.addresses.add_failed' => 'Penambahan gagal: %s',
    'ip.addresses.update_failed' => 'Pembaruan gagal: %s',
    ...
    'ip.arp.please_select_one_or_more' => 'Silakan pilih satu atau lebih entri',
    ...
    'ip.cloud.reverted' => 'Perubahan dibatalkan',
    ...
    'ip.dhcp.client.option_create_failed' => 'Pembuatan opsi gagal: %s',
    ...
    'ip.modal.form.ip.address-mask'=> 'Alamat IP / Masker',
    ...
    'ip.dns.form.doh.max.server.conn'=> 'Koneksi Maksimum Server DoH',
    'ip.dns.form.doh.max.concurrent.queries'=> 'Kueri Maksimum Bersamaan DoH',
    ...
    'ip.dns.form.cache.max-ttl'=> 'TTL Maksimum Cache (detik)',
    'ip.dns.form.cache.min-ttl'=> 'TTL Minimum Cache (detik)',
    'ip.dns.form.max.concurrent.queries'=> 'Kueri Maksimum Bersamaan',
    'ip.dns.form.max.concurrent.tcp'=> 'Koneksi TCP Maksimum Bersamaan',
    'ip.dns.form.query.timeout'=> 'Timeout Kueri (detik)',
    ...
    'ip.dns.static.desc'=> 'Kelola entri DNS statis yang menggantikan resolusi DNS dinamis.',
    ...
    'ip.pool.table.th.used'=> 'Digunakan',
    ...
    'ip.pool.modal.form.used'=> 'Digunakan',
    ...
    'ip.services.table.th.max-sessions'=> 'Sesi Maksimum',
    ...
    'ip.services.modal.form.max-sessions'=> 'Sesi Maksimum',
    ...
    'ip.settings.modal.form.ip-forward'=> 'Penerusan IP Diaktifkan',
    'ip.settings.modal.form.ip-send-redirects'=> 'Pengiriman Redirect Diaktifkan',
    'ip.settings.modal.form.ip-accept-redirects'=> 'Penerimaan Redirect Diaktifkan',
    'ip.settings.modal.form.ip-secure-redirects'=> 'Redirect Aman Diaktifkan',
    'ip.settings.modal.form.ip-accept-source-route'=> 'Penerimaan Source Route Diaktifkan',
    'ip.settings.modal.form.ip-allow-fast-path'=> 'Allow Fast Path Diaktifkan',
    ...
    'ip.settings.modal.form.ip-arp-timeout'=> 'ARP Timeout (detik)',
