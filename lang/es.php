...
return [
    ...
    'footer.copyright' => 'Derechos de autor &copy; mTikOps {year}',
 ...
 // Login Page Messages
     'login.error.invalid_submission'=> 'Envío de formulario no válido. Por favor, inténtalo de nuevo.',
     'login.error.missing_fields'=> 'Se requieren Host, Usuario y Contraseña.',
     'login.error.unable_connect'=> '¡No se puede conectar! — Verifica tus credenciales e inténtalo de nuevo.',
     'login.success.connected'=> 'Conectado al router correctamente.',
     'login.success.remembered'=> 'Detalles de conexión guardados para futuros inicios de sesión.',
     'login.info.session_expired'=> 'Tu sesión ha expirado. Por favor, inicia sesión de nuevo.',
     'login.info.logged_out'=> 'Has cerrado sesión correctamente.',
     'login.info.please_login'=> 'Por favor inicia sesión para continuar.',
     'login.button.forgot_password'=> '¿Olvidaste tu contraseña?',
     'login.try_again'=> '¿Intentar de nuevo?',
    ...
    'about-us.tutorials'=> 'Tutoriales',
    'about-us.faqs'=> 'Preguntas frecuentes',
    'about-us.requirements'=> 'Requisitos',
    ...
    'about-us.open.overview'=> 'Abrir resumen',
    'about-us.open.vision'=> 'Abrir visión',
    'about-us.open.features'=> 'Abrir funciones',
    'about-us.open.tutorials'=> 'Abrir tutoriales',
    'about-us.open.faqs'=> 'Abrir preguntas frecuentes',
    'about-us.open.requirements'=> 'Abrir requisitos',

    // About Us - Back Button
    'about-us.back-to-about'=> 'Volver a Sobre nosotros',
    ...
    'about-us.vision-page.desc'=> 'Nuestro objetivo es simplificar las operaciones de red para usuarios de MikroTik con una interfaz intuitiva y herramientas de automatización.',
    ...
    'about-us.requirements-page.desc'=> 'Requisitos mínimos y notas de compatibilidad.',
    ...
    'our-team.advisors-page.desc'=> 'Asesores y expertos que brindan orientación al proyecto.',
    ...
    'our-team.contact-page.desc'=> 'Formas de contactar al equipo de mTikOps para colaboración o soporte.',
    ...
    'dashboard.logging.desc'=> 'Registro centralizado y alertas para eventos y errores del sistema',
    'dashboard.system.logs'=> 'Registros del sistema',
    'dashboard.critical.logs'=> 'Registros críticos',
    ...
    'dashboard.hotspot.as.title'=> 'Sesiones activas de Hotspot',
    'dashboard.ppp.as.title'=> 'Sesiones activas PPPoE',
    // JS dashboard strings (used by client-side locale export)
    'dashboard.no_active_sessions' => 'No hay sesiones activas',
    'dashboard.no_ppp_active_sessions' => 'No hay sesiones PPP activas',
    ...
    'firewall.desc' => 'Gestiona reglas de firewall, NAT, mangle y herramientas de inspección de tráfico.',
    'firewall.filter' => 'Reglas de filtro',
    'firewall.nat' => 'NAT',
    'firewall.mangle' => 'Mangle',
    'firewall.raw' => 'Raw',
    'firewall.connections' => 'Conexiones',
    'firewall.address' => 'Listas de direcciones',
    'firewall.layer7' => 'Protocolos Layer7',
    'firewall.filter.desc' => 'Crea y organiza reglas de filtrado de paquetes para controlar el tráfico.',
    'firewall.filter.actions' => 'Acciones',
    'firewall.filter.new' => 'Nuevo',
    'firewall.filter.edit' => 'Editar',
    'firewall.filter.enable' => 'Activar',
    'firewall.filter.disable' => 'Desactivar',
    'firewall.filter.remove' => 'Eliminar',
    'firewall.filter.sort.by' => 'Ordenar por',
    'firewall.filter.sort' => 'Ordenar',
    'firewall.filter.prev' => 'Anterior',
    'firewall.filter.next' => 'Siguiente',
    'firewall.filter.loading' => 'Cargando...',
    'firewall.filter.none' => 'No se encontraron entradas',
    'firewall.filter.failed_to_load' => 'Error al cargar',
    'firewall.filter.confirm_remove' => '¿Eliminar los elementos seleccionados?',
    'firewall.filter.confirm_title' => 'Confirmar',
    'firewall.filter.enable_success' => 'Activado',
    'firewall.filter.disable_success' => 'Desactivado',
    'firewall.filter.remove_success' => 'Eliminado',
    'firewall.filter.action_failed' => 'Acción fallida: %s',
    'firewall.filter.action_failed_short' => 'Acción fallida',
    'firewall.filter.not_implemented' => 'Aún no implementado',
    'firewall.filter.badge_disabled' => 'Desactivado',
    'firewall.filter.badge_dynamic' => 'Dinámico',
    'firewall.filter.badge_invalid' => 'No válido',
    'firewall.filter.table.select' => 'Seleccionar',
    'firewall.filter.table.number' => '#',
    'firewall.filter.table.flag' => 'Bandera',
    'firewall.filter.table.action' => 'Acción',
    'firewall.filter.table.chain' => 'Cadena',
    'firewall.filter.table.src_address' => 'Dir. origen',
    'firewall.filter.table.dst_address' => 'Dir. destino',
    'firewall.filter.table.protocol' => 'Protocolo',
    'firewall.filter.table.src_port' => 'Puerto origen',
    'firewall.filter.table.dst_port' => 'Puerto destino',
    'firewall.filter.table.in_interface' => 'Interfaz de entrada',
    'firewall.filter.table.out_interface' => 'Interfaz de salida',
    'firewall.filter.table.src_address_list' => 'Lista de direcciones de origen',
    'firewall.filter.table.dst_address_list' => 'Lista de direcciones de destino',
    'firewall.filter.table.bytes' => 'Bytes',
    'firewall.filter.table.packets' => 'Paquetes',
    'firewall.nat.desc' => 'Configura políticas NAT de origen y destino para tu red.',
    'firewall.nat.actions' => 'Acciones',
    'firewall.nat.new' => 'Nuevo',
    'firewall.nat.edit' => 'Editar',
    'firewall.nat.enable' => 'Activar',
    'firewall.nat.disable' => 'Desactivar',
    'firewall.nat.remove' => 'Eliminar',
    'firewall.nat.sort.by' => 'Ordenar por',
    'firewall.nat.sort' => 'Ordenar',
    'firewall.nat.prev' => 'Anterior',
    'firewall.nat.next' => 'Siguiente',
    'firewall.nat.loading' => 'Cargando...',
    'firewall.nat.none' => 'No se encontraron entradas',
    'firewall.nat.failed_to_load' => 'Error al cargar',
    'firewall.nat.confirm_remove' => '¿Eliminar los elementos seleccionados?',
    'firewall.nat.confirm_title' => 'Confirmar',
    'firewall.nat.enable_success' => 'Activado',
    'firewall.nat.disable_success' => 'Desactivado',
    'firewall.nat.remove_success' => 'Eliminado',
    'firewall.nat.action_failed' => 'Acción fallida: %s',
    'firewall.nat.action_failed_short' => 'Acción fallida',
    'firewall.nat.not_implemented' => 'Aún no implementado',
    'firewall.nat.badge_disabled' => 'Desactivado',
    'firewall.nat.badge_dynamic' => 'Dinámico',
    'firewall.nat.badge_invalid' => 'No válido',
    'firewall.nat.table.select' => 'Seleccionar',
    'firewall.nat.table.number' => '#',
    'firewall.nat.table.flag' => 'Bandera',
    'firewall.nat.table.action' => 'Acción',
    'firewall.nat.table.chain' => 'Cadena',
    'firewall.nat.table.src_address' => 'Dir. origen',
    'firewall.nat.table.dst_address' => 'Dir. destino',
    'firewall.nat.table.protocol' => 'Protocolo',
    'firewall.nat.table.src_port' => 'Puerto origen',
    'firewall.nat.table.dst_port' => 'Puerto destino',
    'firewall.nat.table.in_interface' => 'Interfaz de entrada',
    'firewall.nat.table.out_interface' => 'Interfaz de salida',
    'firewall.nat.table.bytes' => 'Bytes',
    'firewall.nat.table.packets' => 'Paquetes',
    'firewall.mangle.desc' => 'Marca paquetes y conexiones para enrutamiento avanzado y QoS.',
    'firewall.mangle.actions' => 'Acciones',
    'firewall.mangle.new' => 'Nuevo',
    'firewall.mangle.edit' => 'Editar',
    'firewall.mangle.enable' => 'Activar',
    'firewall.mangle.disable' => 'Desactivar',
    'firewall.mangle.remove' => 'Eliminar',
    'firewall.mangle.sort.by' => 'Ordenar por',
    'firewall.mangle.sort' => 'Ordenar',
    'firewall.mangle.prev' => 'Anterior',
    'firewall.mangle.next' => 'Siguiente',
    'firewall.mangle.loading' => 'Cargando...',
    'firewall.mangle.none' => 'No se encontraron entradas',
    'firewall.mangle.failed_to_load' => 'Error al cargar',
    'firewall.mangle.confirm_remove' => '¿Eliminar los elementos seleccionados?',
    'firewall.mangle.confirm_title' => 'Confirmar',
    'firewall.mangle.enable_success' => 'Activado',
    'firewall.mangle.disable_success' => 'Desactivado',
    'firewall.mangle.remove_success' => 'Eliminado',
    'firewall.mangle.action_failed' => 'Acción fallida: %s',
    'firewall.mangle.action_failed_short' => 'Acción fallida',
    'firewall.mangle.not_implemented' => 'Aún no implementado',
    'firewall.mangle.badge_disabled' => 'Desactivado',
    'firewall.mangle.badge_dynamic' => 'Dinámico',
    'firewall.mangle.badge_invalid' => 'No válido',
    'firewall.mangle.table.select' => 'Seleccionar',
    'firewall.mangle.table.number' => '#',
    'firewall.mangle.table.flag' => 'Bandera',
    'firewall.mangle.table.action' => 'Acción',
    'firewall.mangle.table.chain' => 'Cadena',
    'firewall.mangle.table.bytes' => 'Bytes',
    'firewall.mangle.table.packets' => 'Paquetes',
    'firewall.mangle.table.src_address' => 'Dir. origen',
    'firewall.mangle.table.dst_address' => 'Dir. destino',
    'firewall.mangle.table.src_address_list' => 'Lista de direcciones de origen',
    'firewall.mangle.table.dst_address_list' => 'Lista de direcciones de destino',
    'firewall.mangle.table.protocol' => 'Protocolo',
    'firewall.mangle.table.src_port' => 'Puerto origen',
    'firewall.mangle.table.dst_port' => 'Puerto destino',
    'firewall.mangle.table.in_interface' => 'Interfaz de entrada',
    'firewall.mangle.table.out_interface' => 'Interfaz de salida',
    'firewall.raw.desc' => 'Aplica filtros raw de preenrutamiento antes del seguimiento de conexiones.',
    'firewall.raw.actions' => 'Acciones',
    'firewall.raw.new' => 'Nuevo',
    'firewall.raw.edit' => 'Editar',
    'firewall.raw.enable' => 'Activar',
    'firewall.raw.disable' => 'Desactivar',
    'firewall.raw.remove' => 'Eliminar',
    'firewall.raw.sort.by' => 'Ordenar por',
    'firewall.raw.sort' => 'Ordenar',
    'firewall.raw.prev' => 'Anterior',
    'firewall.raw.next' => 'Siguiente',
    'firewall.raw.loading' => 'Cargando...',
    'firewall.raw.none' => 'No se encontraron entradas',
    'firewall.raw.failed_to_load' => 'Error al cargar',
    'firewall.raw.confirm_remove' => '¿Eliminar los elementos seleccionados?',
    'firewall.raw.confirm_title' => 'Confirmar',
    'firewall.raw.enable_success' => 'Activado',
    'firewall.raw.disable_success' => 'Desactivado',
    'firewall.raw.remove_success' => 'Eliminado',
    'firewall.raw.action_failed' => 'Acción fallida: %s',
    'firewall.raw.action_failed_short' => 'Acción fallida',
    'firewall.raw.not_implemented' => 'Aún no implementado',
    'firewall.raw.badge_disabled' => 'Desactivado',
    'firewall.raw.badge_dynamic' => 'Dinámico',
    'firewall.raw.badge_invalid' => 'No válido',
    'firewall.raw.table.select' => 'Seleccionar',
    'firewall.raw.table.number' => '#',
    'firewall.raw.table.flag' => 'Bandera',
    'firewall.raw.table.action' => 'Acción',
    'firewall.raw.table.chain' => 'Cadena',
    'firewall.raw.table.src_address' => 'Dir. origen',
    'firewall.raw.table.dst_address' => 'Dir. destino',
    'firewall.raw.table.src_address_list' => 'Lista de direcciones de origen',
    'firewall.raw.table.dst_address_list' => 'Lista de direcciones de destino',
    'firewall.raw.table.protocol' => 'Protocolo',
    'firewall.connections.desc' => 'Inspecciona las entradas actuales de seguimiento de conexiones del firewall.',
    'firewall.address.desc' => 'Mantén listas de direcciones reutilizables para la coincidencia de reglas.',
    'firewall.address.actions' => 'Acciones',
    'firewall.address.new' => 'Nuevo',
    'firewall.address.enable' => 'Activar',
    'firewall.address.disable' => 'Desactivar',
    'firewall.address.remove' => 'Eliminar',
    'firewall.address.refresh' => 'Actualizar',
    'firewall.address.sort.by' => 'Ordenar por',
    'firewall.address.sort' => 'Ordenar',
    'firewall.address.prev' => 'Anterior',
    'firewall.address.next' => 'Siguiente',
    'firewall.address.loading' => 'Cargando...',
    'firewall.address.none' => 'No se encontraron entradas',
    'firewall.address.failed_to_load' => 'Error al cargar',
    'firewall.address.confirm_remove' => '¿Eliminar los elementos seleccionados?',
    'firewall.address.confirm_title' => 'Confirmar',
    'firewall.address.enable_success' => 'Activado',
    'firewall.address.disable_success' => 'Desactivado',
    'firewall.address.remove_success' => 'Eliminado',
    'firewall.address.action_failed' => 'Acción fallida: %s',
    'firewall.address.action_failed_short' => 'Acción fallida',
    'firewall.address.not_implemented' => 'Aún no implementado',
    'firewall.address.table.select' => 'Seleccionar',
    'firewall.address.table.list' => 'Lista',
    'firewall.address.table.address' => 'Dirección',
    'firewall.address.table.time' => 'Hora',
    'firewall.address.table.creation' => 'Creación',
    'firewall.address.edit' => 'Editar',
    'firewall.address.modal.title_new' => 'Agregar lista de direcciones',
    'firewall.address.modal.title_edit' => 'Editar lista de direcciones',
    'firewall.address.modal.enabled' => 'Activado',
    'firewall.address.modal.list' => 'Lista',
    'firewall.address.modal.list_placeholder' => 'Ingresa el nombre de la lista',
    'firewall.address.modal.list_select_placeholder' => 'Seleccionar lista de direcciones existente',
    'firewall.address.modal.address' => 'Dirección',
    'firewall.address.modal.timeout' => 'Tiempo de espera',
    'firewall.address.modal.creation' => 'Hora de creación',
    'firewall.address.modal.comment' => 'Comentario',
    'firewall.address.modal.cancel' => 'Cancelar',
    'firewall.address.modal.create' => 'Crear',
    'firewall.address.modal.update' => 'Actualizar',
    'firewall.address.modal.list_required' => 'La lista es obligatoria',
    'firewall.address.modal.address_required' => 'La dirección es obligatoria',
    'firewall.address.modal.add_success' => 'Lista de direcciones creada',
    'firewall.address.modal.update_success' => 'Lista de direcciones actualizada',
    'firewall.address.modal.save_failed' => 'Error al guardar: %s',
    'firewall.address.modal.request_failed' => 'Falló la solicitud',
    'firewall.address.modal.creation_auto' => 'Se establecerá automáticamente',
    'firewall.layer7.desc' => 'Gestiona patrones de protocolo Layer7 para inspección profunda de paquetes.',
    'firewall.layer7.actions' => 'Acciones',
    'firewall.layer7.new' => 'Nuevo',
    'firewall.layer7.edit' => 'Editar',
    'firewall.layer7.remove' => 'Eliminar',
    'firewall.layer7.sort.by' => 'Ordenar por',
    'firewall.layer7.sort' => 'Ordenar',
    'firewall.layer7.prev' => 'Anterior',
    'firewall.layer7.next' => 'Siguiente',
    'firewall.layer7.loading' => 'Cargando...',
    'firewall.layer7.none' => 'No se encontraron entradas',
    'firewall.layer7.failed_to_load' => 'Error al cargar',
    'firewall.layer7.confirm_remove' => '¿Eliminar los elementos seleccionados?',
    'firewall.layer7.confirm_title' => 'Confirmar',
    'firewall.layer7.remove_success' => 'Eliminado',
    'firewall.layer7.remove_failed' => 'Error al eliminar: %s',
    'firewall.layer7.remove_failed_short' => 'Error al eliminar',
    'firewall.layer7.not_implemented' => 'Aún no implementado',
    'firewall.layer7.table.select' => 'Seleccionar',
    'firewall.layer7.table.name' => 'Nombre',
    'firewall.layer7.table.regexp' => 'Regexp',
    'firewall.layer7.modal.title_new' => 'Agregar protocolo Layer7',
    'firewall.layer7.modal.title_edit' => 'Editar protocolo Layer7',
    'firewall.layer7.modal.name' => 'Nombre',
    'firewall.layer7.modal.regexp' => 'Regexp',
    'firewall.layer7.modal.comment' => 'Comentario',
    'firewall.layer7.modal.cancel' => 'Cancelar',
    'firewall.layer7.modal.create' => 'Crear',
    'firewall.layer7.modal.update' => 'Actualizar',
    'firewall.layer7.modal.name_required' => 'El nombre es obligatorio',
    'firewall.layer7.modal.regexp_required' => 'El regexp es obligatorio',
    'firewall.layer7.modal.add_success' => 'Protocolo Layer7 creado',
    'firewall.layer7.modal.update_success' => 'Protocolo Layer7 actualizado',
    'firewall.layer7.modal.save_failed' => 'Error al guardar: %s',
    'firewall.layer7.modal.request_failed' => 'Falló la solicitud',
    'firewall.open.filter' => 'Abrir reglas de filtro',
    'firewall.open.nat' => 'Abrir NAT',
    'firewall.open.mangle' => 'Abrir Mangle',
    'firewall.open.raw' => 'Abrir Raw',
    'firewall.open.connections' => 'Abrir conexiones',
    'firewall.open.address' => 'Abrir listas de direcciones',
    'firewall.open.layer7' => 'Abrir protocolos Layer7',
    'firewall.back-to-firewall' => 'Volver al firewall',
    'firewall.connections.actions' => 'Acciones',
    'firewall.connections.remove' => 'Eliminar',
    'firewall.connections.refresh' => 'Actualizar',
    'firewall.connections.sort.by' => 'Ordenar por',
    'firewall.connections.sort' => 'Ordenar',
    'firewall.connections.prev' => 'Anterior',
    'firewall.connections.next' => 'Siguiente',
    'firewall.connections.loading' => 'Cargando conexiones...',
    'firewall.connections.none' => 'No se encontraron conexiones',
    'firewall.connections.failed_to_load' => 'Error al cargar',
    'firewall.connections.confirm_remove' => '¿Eliminar las conexiones seleccionadas?',
    'firewall.connections.confirm_title' => 'Confirmar',
    'firewall.connections.remove_success' => 'Conexiones eliminadas',
    'firewall.connections.remove_failed' => 'Error al eliminar: %s',
    'firewall.connections.remove_failed_short' => 'Error al eliminar',
    'firewall.connections.table.select' => 'Seleccionar',
    'firewall.connections.table.flags' => 'Banderas',
    'firewall.connections.table.protocol' => 'Protocolo',
    'firewall.connections.table.src_address' => 'Dir. origen',
    'firewall.connections.table.src_port' => 'Puerto origen',
    'firewall.connections.table.dst_address' => 'Dir. destino',
    'firewall.connections.table.dst_port' => 'Puerto destino',
    'firewall.connections.table.conn_mark' => 'Marca de conexión',
    'firewall.connections.table.state' => 'Estado',

    // Hotspot - Back Button
    'hotspot.back-to-hotspot'=> 'Volver al gestor de Hotspot',
    ...
    'hotspot.table.th.server'=> 'Nombre del servidor',
    'hotspot.table.th.user'=> 'Usuario',
    'hotspot.table.th.name'=> 'Nombre',
    'hotspot.table.th.address'=> 'Dirección',
    'hotspot.table.th.mac'=> 'Dirección MAC',
    'hotspot.table.th.profile'=> 'Perfil',
    'hotspot.table.th.uptime'=> 'Tiempo activo',
    ...
    'maintenance.update_toast' => 'Modo de actualización del sistema' . '<br/><br/>' . 'Se están realizando actualizaciones del sistema. Algunas funciones pueden no estar disponibles.',
    ...
    'hotspot.users.select_profiles_placeholder' => 'Ordenar perfiles',
    'hotspot.users.select_comments_placeholder' => 'Ordenar comentarios',
    ...
    'hotspot.modal.title.generate'=> 'Generar usuarios / vales',
    'hotspot.modal.general.tab'=> 'General',
    'hotspot.modal.printing.tab'=> 'Impresión',
    'hotspot.modal.stats.tab'=> 'Estadísticas',
    'hotspot.modal.queueing.tab'=> 'Colas',
    'hotspot.modal.scripts.tab'=> 'Guiones',
    ...
    'hotspot.modal.form.comment'=> 'Comentario',
    ...
    'hotspot.modal.form.hotspot-name-placeholder'=> 'Mi Hotspot',
    'hotspot.modal.form.hotspot-dns-placeholder'=> 'hotspot.mtikops.com',
    'hotspot.modal.form.hotspot-price-placeholder'=> 'Precio por vale',

    // Hotspot Modal Form Generate - User-Type
    'hotspot.modal.form.user-type-regular'=> 'Usuario y contraseña',
    'hotspot.modal.form.user-type-voucher'=> 'Usuario = Contraseña',

    // Hotspot Modal Form Generate - Characters
    'hotspot.modal.form.characters-lower'=> 'abcd (minúsculas)',
    'hotspot.modal.form.characters-upper'=> 'ABCD (MAYÚSCULAS)',
    'hotspot.modal.form.characters-mixed'=> 'AbCd (Mixto)',
    'hotspot.modal.form.characters-num'=> '1234 (Números)',
    'hotspot.modal.form.characters-lower-num'=> 'a1b2 (minúsculas y números)',
    'hotspot.modal.form.characters-upper-num'=> 'A1B2 (MAYÚSCULAS y números)',
    'hotspot.modal.form.characters-mixed-num'=> 'aA1bB2 (Mixto y números)',
    ...
    'hotspot.modal.form.loading' => 'Cargando datos...',

    // Hotspot Modal Form Buttons
    'hotspot.modal.form.button.generate-print'=> 'Generar e imprimir',
    'hotspot.modal.form.button.generate'=> 'Solo generar',
    'hotspot.modal.form.button.clear-cached-batch'=> 'Limpiar lote en caché',
    'hotspot.modal.form.button.close'=> 'Cerrar',
    'hotspot.modal.form.button.create'=> 'Crear',
    'hotspot.modal.form.button.cancel'=> 'Cancelar',
    ...
    'hotspot.user.profiles.modal.title.add-profile'=> 'Agregar perfil',
    ...
    'hotspot.user.profiles.form.queue-type'=> 'Tipo de cola',

    // Hotspot User Profiles Form Fields - Scripts Tab
    'hotspot.user.profiles.form.on-login-script'=> 'Script al iniciar sesión',
    'hotspot.user.profiles.form.on-login-script_placeholder'=> 'Script opcional para ejecutar al iniciar sesión',
    'hotspot.user.profiles.form.on-logout-script'=> 'Script al cerrar sesión',
    'hotspot.user.profiles.form.on-logout-script_placeholder'=> 'Script opcional para ejecutar al cerrar sesión',
    ...
    'hotspot.export.user.profile'=> 'Perfil',
    'hotspot.export.user.comment'=> 'Comentario',
    'hotspot.export.user.inc-header'=> 'Incluir encabezados',
    ...
    'settings.scheduler'=> 'Programador',
    'settings.scripts'=> 'Guiones',
    'settings.reset'=> 'Restablecer',
    'settings.reboot'=> 'Reiniciar',
    'settings.shutdown'=> 'Apagar',

    // Settings Page Buttons
    //'settings.open.identity'=> 'Abrir identidad',
    //'settings.open.ntp'=> 'Abrir NTP',
    'settings.open.files'=> 'Abrir archivos',
    'settings.open.users'=> 'Gestionar usuarios',
    'settings.open.scheduler'=> 'Abrir programador',
    'settings.open.scripts'=> 'Abrir scripts',
    //'settings.open.reset'=> 'Restablecer',
    //'settings.open.reboot'=> 'Reiniciar',
    //'settings.open.shutdown'=> 'Apagar',

    // SETTINGS GENERAL BUTTONS
    'settings.buttons.upload'=> 'Subir',
    'settings.buttons.delete'=> 'Eliminar',
    'settings.buttons.refresh'=> 'Actualizar',
    'settings.buttons.save'=> 'Guardar',
    'settings.buttons.cancel'=> 'Cancelar',
    'settings.buttons.close'=> 'Cerrar',
    'settings.buttons.edit'=> 'Editar',
    'settings.buttons.add'=> 'Agregar',
    'settings.buttons.remove'=> 'Eliminar',
    'settings.buttons.prev'=> 'Anterior',
    'settings.buttons.next'=> 'Siguiente',
    ...
    'settings.table.th.last-login'=> 'Último inicio de sesión',
    ...
    'settings.table.th.interval'=> 'Intervalo',
    'settings.table.th.enabled'=> 'Habilitado',
    'settings.table.th.size'=> 'Tamaño',
    ...
    'settings.identity.refresh'=> 'Actualizar',

    // Settings Page - NTP Modal
    'settings.ntp.enabled'=> 'Habilitado',
    'settings.ntp.enabled-yes'=> 'Habilitado',
    'settings.ntp.enabled-no'=> 'Deshabilitado',
    ...
    'settings.ntp.server'=> 'Servidores NTP',
    'settings.ntp.server-add'=> 'Agregar servidor',
    'settings.ntp.server-refresh'=> 'Actualizar',
    'settings.ntp.server-save'=> 'Guardar',

    // Settings Page - NTP Status
    'settings.ntp.status'=> 'Estado',
    'settings.ntp.freq.drift'=> 'Deriva de frecuencia',
    'settings.ntp.synced.server'=> 'Servidor sincronizado',
    ...
    'settings.scripts.title'=> 'Guiones',
    'settings.scripts.desc'=> 'Crear, editar y ejecutar scripts personalizados en el dispositivo.',
    ...
    'settings.reset.button.reset-now'=> 'Restablecer ahora',
    ...
    'settings.reboot.button.reboot-now'=> 'Reiniciar ahora',
    ...
    'settings.shutdown.button.shutdown-now'=> 'Apagar ahora',
    ...
    'queues.open.tree'=> 'Abrir árbol de colas',
    ...
    'queues.button.enable'=> 'Habilitar',
    'queues.button.disable'=> 'Deshabilitar',
    'queues.button.remove'=> 'Eliminar',
    'queues.button.refresh'=> 'Actualizar',
    'queues.button.pause-polling'=> 'Pausar sondeo',
    'queues.sort.by'=> 'Ordenar por',
    'queues.sort'=> 'Ordenar',
    'queues.select.all'=> 'Seleccionar todo',
    'queues.button.prev'=> 'Anterior',
    'queues.button.next'=> 'Siguiente',
    'queues.button.save'=> 'Guardar',
    'queues.button.cancel'=> 'Cancelar',
    'queues.button.create'=> 'Crear',


    // Queues Loading Status
    'queues.status.loading'=> 'Cargando colas...',
    ...
    'queues.tab.advanced'=> 'Avanzado',
    'queues.tab.queueing'=> 'Colas',

    // Queues Modal Form Tab
    'queues.modal.form.new.simple'=> 'Nueva cola simple',
    'queue.modal.form.edit.simple'=> 'Editar cola simple',
    'queues.modal.form.enabled'=> 'Habilitado',
    'queues.modal.form.name'=> 'Nombre',
    'queues.modal.form.target'=> 'Objetivo',
    ...
    'queue.tree.tab.rate-limit'=> 'Límite de velocidad',
    ...
    // PPP General Buttons
    'ppp.buttons.new'=> 'Nuevo',
    'ppp.buttons.edit'=> 'Editar',
    'ppp.buttons.enable'=> 'Habilitar',
    'ppp.buttons.disable'=> 'Deshabilitar',
    'ppp.buttons.remove'=> 'Eliminar',
    ...
    'ppp.buttons.cancel'=> 'Cancelar',
    'ppp.buttons.create'=> 'Crear',
    'ppp.buttons.save'=> 'Guardar',
    'ppp.buttons.proceed'=> 'Continuar',

    // PPP Loading Status
    'ppp.status.loading'=> 'Cargando datos PPPoE...',
    ...
    'ppp.table.th.name'=> 'Nombre',
    'ppp.table.th.password'=> 'Contraseña',
    'ppp.table.th.service'=> 'Servicio',
    'ppp.table.th.address'=> 'Dirección',
    ...
    'ppp.modal.form.title'=> 'Agregar servidor PPPoE',
    ...
    'ppp.modal.form.max-sessions'=> 'Sesiones máximas',
    'ppp.modal.form.auth-methods'=> 'Métodos de autenticación',
    ...
    'ppp.modal.form.secret.name'=> 'Nombre',
    'ppp.modal.form.secret.password'=> 'Contraseña',
    'ppp.modal.form.secret.service-type'=> 'Servicio',
    'ppp.modal.form.secret.local-address'=> 'Dirección local',
    'ppp.modal.form.secret.remote-address'=> 'Dirección remota',

    // secrets.php
    // Modal Titles
    'ppp.modal.form.add.ppp-secret'=> 'Agregar secreto PPPoE',
    'ppp.modal.form.edit.ppp-secret'=> 'Editar secreto PPPoE',

    // PPP Secrets Page Modal Tabs
    'ppp.secrets.tab.general'=> 'General',  
    'ppp.secrets.tab.details'=> 'Detalles',

    // profiles.php
    // PPP Profiles Page

    // PPP Profiles Modal Titles
    'ppp.modal.form.add.ppp-profile'=> 'Agregar perfil PPPoE',
    'ppp.modal.form.edit.ppp-profile'=> 'Editar perfil PPPoE',


    // PPP Profiles Modal Tabs
    'ppp.profiles.tab.general'=> 'General',
    'ppp.profiles.tab.protocols'=> 'Protocolos',
    'ppp.profiles.tab.limits'=> 'Límites',
    'ppp.profiles.tab.queue'=> 'Cola',
    'ppp.profiles.tab.scripts'=> 'Guiones',

    // PPP Profiles Modal Form Fields
    'ppp.modal.form.profile.name'=> 'Nombre',
    'ppp.modal.form.profile.local-address'=> 'Dirección local',
    'ppp.modal.form.profile.remote-address'=> 'Dirección remota',
    'ppp.modal.form.profile.use-ipv6'=> 'Usar IPv6',
    'ppp.modal.form.profile.use-mpls'=> 'Usar MPLS',
    'ppp.modal.form.profile.use-comp'=> 'Usar compresión',
    'ppp.modal.form.profile.use-enc'=> 'Usar cifrado',
    'ppp.modal.form.profile.sess-timeout'=> 'Tiempo de sesión',
    'ppp.modal.form.profile.idle-timeout'=> 'Tiempo de inactividad',
    'ppp.modal.form.profile.rate-limit'=> 'Límite de velocidad',
    'ppp.modal.form.profile.only-one'=> 'Solo uno',
    'ppp.modal.form.profile.parent-queue'=> 'Cola padre',
    'ppp.modal.form.profile.queue-type-rx'=> 'Tipo de cola (Descargas)',
    ...
    'ip.cloud'=> 'Cloud',
    'ip.dhcp.client'=> 'Cliente DHCP',
    'ip.dhcp.server'=> 'Servidor DHCP',
    'ip.dns'=> 'DNS',
    'ip.pool'=> 'Pool',
    'ip.services'=> 'Servicios',
    'ip.upnp'=> 'UPnP',
    'ip.settings'=> 'Ajustes',
    ...
    'ip.open.addresses'=> 'Abrir direcciones',
    'ip.open.cloud'=> 'Abrir Cloud',
    'ip.open.dhcp.client'=> 'Abrir cliente DHCP',
    'ip.open.dhcp.server'=> 'Abrir servidor DHCP',
    'ip.open.dns'=> 'Abrir DNS',
    'ip.open.pool'=> 'Abrir pool',
    'ip.open.services'=> 'Abrir servicios',
    'ip.open.upnp'=> 'Abrir UPnP',
    ...
    'ip.addresses.action_failed' => 'Acción fallida: %s',
    'ip.addresses.request_failed' => 'Solicitud fallida: %s',
    'ip.addresses.address_added' => 'Dirección añadida',
    'ip.addresses.address_updated' => 'Dirección actualizada',
    'ip.addresses.add_failed' => 'Error al añadir: %s',
    ...
    'ip.dhcp.client.created' => 'Cliente DHCP creado',
    'ip.dhcp.client.create_failed' => 'Error al crear: %s',
    'ip.dhcp.client.no_entries_selected' => 'No hay entradas seleccionadas',
    'ip.dhcp.client.enable_completed' => 'Habilitación completada',
    'ip.dhcp.client.enable_failed' => 'Error al habilitar: %s',
    ...
    'ip.dhcp.networks.create_not_implemented' => 'Crear nueva red: no implementado',
    'ip.dhcp.networks.please_select_remove' => 'Por favor seleccione una o más redes para eliminar',
    'ip.dhcp.networks.remove_confirm' => '¿Eliminar las redes seleccionadas?',
    'ip.dhcp.networks.removed' => 'Eliminado',
    ...
    'ip.pool.update_failed' => 'Error al actualizar: %s',
    'ip.pool.remove_confirm' => '¿Eliminar el/los pool(s) seleccionados?',
    'ip.pool.action_completed' => 'Acción %s completada',
    'ip.pool.action_failed' => 'Acción fallida: %s',
    ...
    'ip.loading'=> 'Cargando datos IP...',

    // IP Page Actions
    'ip.actions'=> 'Acciones',

    // IP Page General Buttons
    'ip.buttons.new'=> 'Agregar',
    'ip.buttons.edit'=> 'Editar',
    'ip.buttons.refresh'=> 'Actualizar',
    'ip.buttons.create'=> 'Crear',
    'ip.buttons.save'=> 'Guardar',
    'ip.buttons.cancel'=> 'Cancelar',
    'ip.buttons.enable'=> 'Habilitar',
    'ip.buttons.disable'=> 'Deshabilitar',
    'ip.buttons.remove'=> 'Eliminar',
    'ip.buttons.prev'=> 'Anterior',
    'ip.buttons.next'=> 'Siguiente',
    'ip.sort.by'=> 'Ordenar por',
    'ip.sort'=> 'Ordenar',
    'ip.select.all'=> 'Seleccionar todo',
    ...
    // IP Table Headers
    'ip.table.th.address'=> 'Dirección',
    'ip.table.th.network'=> 'Red',
    'ip.table.th.iface'=> 'Interfaz',
    'ip.table.th.comment'=> 'Comentario',
    'ip.table.th.dhcp.client.name' => 'Nombre',
    'ip.table.th.dhcp.client.code-value' => 'Valor del código',
    'ip.table.th.dhcp.client.client-value' => 'Valor del cliente',
    'ip.table.th.dns.name'=> 'Nombre',
    'ip.table.th.dns.regexp'=> 'Expresión regular',
    'ip.table.th.dns.type'=> 'Tipo',
    'ip.table.th.dns.value'=> 'Valor',
    'ip.table.th.dns.ttl'=> 'TTL',
    'ip.table.th.dns.data'=> 'Datos',

    // IP Address Modal Titles
    'ip.modal.form.add.address'=> 'Agregar dirección IP',
    'ip.modal.form.edit.address'=> 'Editar dirección IP',

    // IP Address Modal Form
    'ip.modal.form.ip.address-mask'=> 'Dirección IP / Máscara',
    'ip.modal.form.ip.network'=> 'Red',
    'ip.modal.form.iface'=> 'Interfaz',
    'ip.modal.form.comment'=> 'Comentario',
    ...
    // IP Cloud Modal Form
    'ip.cloud.enabled'=> 'DDNS habilitado',
    'ip.cloud.ddns.update.interval'=> 'Intervalo de actualización DDNS',
    'ip.cloud.update.time'=> 'Hora de actualización',
    ...
    'ip.dns.form.add.static.name'=> 'Nombre',
    'ip.dns.form.add.static.type'=> 'Tipo',
    'ip.dns.form.add.static.value'=> 'Valor',
    'ip.dns.form.add.static.ttl'=> 'TTL',
    'ip.dns.form.add.static.regexp'=> 'Expresión regular',
    ...
    // IP Pool Modal Form
    'ip.pool.modal.form.create.title'=> 'Crear pool IP',
    'ip.pool.modal.form.edit.title'=> 'Editar pool IP',
    'ip.pool.modal.form.name'=> 'Nombre',
    'ip.pool.modal.form.ranges'=> 'Rangos de direcciones',
    ...
    'ip.services.table.th.name'=> 'Nombre',
    'ip.services.table.th.port'=> 'Puerto',
    'ip.services.table.th.available-from'=> 'Disponible desde',
    'ip.services.table.th.max-sessions'=> 'Sesiones máximas',
    'ip.services.table.th.protocol'=> 'Protocolo',
    'ip.services.table.th.remote'=> 'Remoto',
    'ip.services.table.th.local'=> 'Local',

    // IP Services Modal Form
    'ip.services.modal.form.edit.title'=> 'Editar servicio IP',
    'ip.services.modal.form.name'=> 'Nombre',
    'ip.services.modal.form.port'=> 'Puerto',
    'ip.services.modal.form.available-from'=> 'Disponible desde',
    'ip.services.modal.form.max-sessions'=> 'Sesiones máximas',
    'ip.services.modal.form.protocol'=> 'Protocolo',
    'ip.services.modal.form.remote.address'=> 'Dirección remota',
    'ip.services.modal.form.remote.port'=> 'Puerto remoto',
    'ip.services.modal.form.local.address'=> 'Dirección local',
    ...
    'ip.settings.modal.form.ip-send-redirects'=> 'Envío de redirecciones habilitado',
    'ip.settings.modal.form.ip-accept-redirects'=> 'Aceptación de redirecciones habilitada',
    'ip.settings.modal.form.ip-secure-redirects'=> 'Redirecciones seguras habilitadas',
    'ip.settings.modal.form.ip-accept-source-route'=> 'Aceptación de ruta de origen habilitada',
    'ip.settings.modal.form.ip-allow-fast-path'=> 'Fast Path habilitado',
    'ip.settings.modal.form.ip-tcp-syncookies'=> 'TCP Syncookies habilitado',
    'ip.settings.modal.form.ip-tcp-timestamps'=> 'Marcas de tiempo TCP',
    'ip.settings.modal.form.ip-max-neighbors'=> 'Máximo de vecinos',
    'ip.settings.modal.form.ip-icmp-rate-limit'=> 'Límite de tasa ICMP',
    'ip.settings.modal.form.ip-arp-timeout'=> 'Tiempo de espera ARP (segundos)',
    'ip.settings.modal.form.ip-arp-timeout-help'=> 'Ingrese el formato de tiempo de espera de RouterOS (p. ej., 10m, 1h o 00:10:00). Deje vacío para el valor predeterminado.',
    ...
    'errors.403.title' => 'Prohibido',
    'errors.403.desc' => 'No tienes permiso para acceder a este recurso.',
    'errors.500.title' => 'Error del servidor',
    'errors.500.desc' => 'Ocurrió un error interno del servidor.',
    'errors.back_home' => 'Volver al inicio',
    'errors.more_info' => 'Qué pasó',
    'errors.contact_admin' => 'Si crees que esto es un error, contacta al administrador del sitio.',
